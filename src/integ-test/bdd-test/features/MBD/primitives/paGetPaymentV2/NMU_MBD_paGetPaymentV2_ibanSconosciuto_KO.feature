#Il test verifica che il nodo non accetti una paGetPaymentV2 response con iban sconosciuto

Feature: activatePaymentNoticeV2Res with iban unknown
    ...
    Scenario: activatePaymentNoticeV2
        ...
        And initial XML paGetPaymentV2
            ...
            <fiscalCodePA>#creditor_institution_code#</fiscalCodePA>
            <IBAN>IT45R0760103200000000001016908765432</IBAN>
            ...
            <transferAmount>2.50</transferAmount>
            <fiscalCodePA>#creditor_institution_code#</fiscalCodePA>
            <IBAN>IT45R076010320000444001016</IBAN>
