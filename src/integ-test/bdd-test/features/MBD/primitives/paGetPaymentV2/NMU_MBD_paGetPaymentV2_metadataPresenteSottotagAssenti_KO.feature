#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con metadata ma senza i sottotag

Feature: activatePaymentNoticeV2Request with metadata but without tags
