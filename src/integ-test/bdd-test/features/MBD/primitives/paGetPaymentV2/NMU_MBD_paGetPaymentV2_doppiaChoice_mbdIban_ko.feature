# Il test verifica che il nodo restituisca un KO se la paGetPaymentV2 contiene entrambe le choice MBD e IBAN

Feature: check syntax KO for paGetPaymentV2 with MBD and IBAN as double choice
