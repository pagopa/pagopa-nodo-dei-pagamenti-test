#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con mapEntry ma senza i sottotag

Feature: activatePaymentNoticeV2Request with mapEntry but without tags
