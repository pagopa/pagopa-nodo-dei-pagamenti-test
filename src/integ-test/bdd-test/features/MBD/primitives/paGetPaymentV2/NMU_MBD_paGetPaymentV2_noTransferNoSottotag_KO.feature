# Il test verifica che il nodo restituisca un KO se la paGetPaymentV2Response non contiene transfer e sottotag

Feature: check syntax KO for paGetPaymentV2 without transfer and tags
