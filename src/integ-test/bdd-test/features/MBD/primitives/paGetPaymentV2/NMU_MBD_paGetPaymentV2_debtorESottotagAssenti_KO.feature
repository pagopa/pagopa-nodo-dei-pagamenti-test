#Il test verifica che il nodo non accetti una paGetPaymentV2Response con debtor e sottotag assenti

Feature: paGetPaymentV2Response senza debtor e sottotag
