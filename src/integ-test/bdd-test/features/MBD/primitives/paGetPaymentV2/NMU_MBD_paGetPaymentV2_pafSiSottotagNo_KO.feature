#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 senza i sottotag paf:paGetPaymentV2Response

Feature: activatePaymentNoticeV2Request no tags
