#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con idTransfer di lunghezza superiore a 1

Feature: activatePaymentNoticeV2Request with idTransfer longer than 1 KO
