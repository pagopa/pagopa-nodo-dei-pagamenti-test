#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con paymentAmount <> sommaTransferAmount

Feature: activatePaymentNoticeV2Request with paymentAmount different from sum of TransferAmount KO
    ...
    Scenario: activatePaymentNoticeV2
        ...
        And initial XML paGetPaymentV2
            ...
            <paymentAmount>54.56</paymentAmount>
