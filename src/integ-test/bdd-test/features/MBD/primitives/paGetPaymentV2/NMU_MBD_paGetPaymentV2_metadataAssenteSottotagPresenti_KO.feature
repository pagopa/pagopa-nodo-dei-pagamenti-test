#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 senza metadata ma con i sottotag

Feature: activatePaymentNoticeV2Request without metadata but with tags
