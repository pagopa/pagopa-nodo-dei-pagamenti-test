#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con 11 occorrenze mapEntry alla fine dell'xml

Feature: activatePaymentNoticeV2Request with 11 occurrences of mapEntry at the end of xml
