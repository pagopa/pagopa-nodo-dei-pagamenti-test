Feature: T001_CARRELLO_5_RPT
    ...
    Scenario: Execute nodoInviaCarrelloRPT - [T001_CARRELLO_5_RPT]
        ...
        And generate 2 notice number and iuv with aux digit 3, segregation code 12 and application code NA
        And generate 3 notice number and iuv with aux digit 3, segregation code 12 and application code NA
        And generate 4 notice number and iuv with aux digit 3, segregation code 12 and application code NA
        And generate 5 notice number and iuv with aux digit 3, segregation code 12 and application code NA
