Feature: flow checks for sendPaymentResult
   ...
   Scenario: T_SPR_09 (retry spr)
      ...
      And wait 15 seconds for expiration
      And verify 0 record for the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
   ...
   Scenario: T_SPR_10 (retry spr)
      ...
      When job positionRetrySendPaymentResult triggered after 10 seconds
      And wait 15 seconds for expiration
      And verify 1 record for the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value NotNone of the record at column ID of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value #creditor_institution_code# of the record at column ID_DOMINIO of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value $iuv of the record at column IUV of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value $activateIOPaymentResponse.paymentToken of the record at column CCP of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value 11$iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value $pspTransactionId of the record at column PSP_TRANSACTION_ID of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value #psp# of the record at column PSP_ID of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value #id_station# of the record at column STAZIONE of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value #canale_IMMEDIATO_MULTIBENEFICIARIO# of the record at column CANALE of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value $activateIOPaymentResponse.paymentToken of the record at column ID_SESSIONE_ORIGINALE of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value OK of the record at column OUTCOME of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value 1 of the record at column RETRY of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value NotNone of the record at column INSERTED_TIMESTAMP of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value NotNone of the record at column UPDATED_TIMESTAMP of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value closePayment-v1 of the record at column INSERTED_BY of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
      And checks the value sendPaymentResult-v1 of the record at column UPDATED_BY of the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query payment_status_1 on db nodo_online under macro AppIO
