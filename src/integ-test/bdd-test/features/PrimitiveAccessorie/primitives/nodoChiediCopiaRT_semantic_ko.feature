Feature: Semantic checks for nodoChiediCopiaRT - KO
    ...
    # [CCRTSEM10]
    Scenario: Check semantic errors for nodoChiediCopiaRT primitive
        Given identificativoUnivocoVersamento with unknownIUV in nodoChiediCopiaRT
        And codiceContestoPagamento with unknownCCP in nodoChiediCopiaRT
        When EC sends SOAP nodoChiediCopiaRT to nodo-dei-pagamenti
        Then check faultCode is PPT_RT_SCONOSCIUTA of nodoChiediCopiaRT response
    ...
    Scenario: Check semantic errors for nodoChiediCopiaRT primitive
        ...
        And identificativoUnivocoVersamento with $1iuv in nodoChiediCopiaRT
        And codiceContestoPagamento with $1ccp in nodoChiediCopiaRT
        When EC sends SOAP nodoChiediCopiaRT to nodo-dei-pagamenti
        Then check faultCode is PPT_RT_NONDISPONIBILE of nodoChiediCopiaRT response