Feature: process tests for accessiConCorrenziali [3_ACT_SPO]
    ...
    Scenario: parallel calls and test scenario
        ...
        And check primitive response activatePaymentNotice2Response and primitive response sendPaymentOutcome1Response