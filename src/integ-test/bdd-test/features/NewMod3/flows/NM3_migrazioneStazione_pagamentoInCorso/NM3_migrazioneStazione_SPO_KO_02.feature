Feature: process tests for NM3 with station migration from V1 to V2
    ...
    Scenario: Execution test DB_GR_21
        ...
        And verify 0 record for the table POSITION_RECEIPT_XML retrived by the query position_receipt_xml on db nodo_online under macro NewMod3 #STATI_RPT/SNAPSHOT
