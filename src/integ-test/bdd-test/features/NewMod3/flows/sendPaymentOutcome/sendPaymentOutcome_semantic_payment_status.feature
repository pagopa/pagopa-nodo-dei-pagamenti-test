Feature: Check semantic payment status 1288
...
@runnable
    Scenario: Verify  in POSITION_STATUS table
        ...
        And checks the value PAID_NORPT of the record at column STATUS of the table POSITION_PAYMENT_STATUS retrived by the query payment_status on db nodo_online under macro NewMod3
