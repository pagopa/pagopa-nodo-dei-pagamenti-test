Feature: Check semantic payment status
    ...
    Scenario: Verify  in POSITION_STATUS table
        ...
        And checks the value PAID, PAYING of the record at column STATUS of the table POSITION_STATUS retrived by the query payment_status on db nodo_online under macro NewMod3
        ...
        And checks the value PAID_NORPT, PAYING of the record at column STATUS of the table POSITION_PAYMENT_STATUS retrived by the query payment_status on db nodo_online under macro NewMod3
