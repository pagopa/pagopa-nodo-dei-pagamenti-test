Feature: process tests for retry on a NOTICE_STORED transaction with different token [Activate_blocco_12] 1022
    ...
    Scenario: Execute activatePaymentNotice2 request
        ...
        And checks the value PAYING, PAYING_RPT, FAILED of the record at column STATUS of the table POSITION_PAYMENT_STATUS retrived by the query position_payment_status_1 on db nodo_online under macro NewMod3
        ...
        And checks the value FAILED of the record at column STATUS of the table POSITION_PAYMENT_STATUS_SNAPSHOT retrived by the query position_payment_status_1 on db nodo_online under macro NewMod3
