Feature: semantic check for activatePaymentNotice regarding idempotency 1054
  ...
  #DB check
    And verify datetime plus number of minutes 60000 of the record at column VALID_TO of the table IDEMPOTENCY_CACHE retrived by the query idempotency_cache_act on db nodo_online under macro NewMod3
