Feature: process tests for nodoInviaRPT [PAG-835_KO] 1242
    ...
    Scenario: Execute activatePaymentNotice request
        ...
        And checks the value N of the record at column PAAATTIVARPTERROR of the table RPT_ACTIVATIONS retrived by the query payment_status on db nodo_online under macro NewMod3

        And verify 0 record for the table IDEMPOTENCY_CACHE retrived by the query by_context_num_avv on db nodo_online under macro NewMod3
    ...
    Scenario: Excecute nodoInviaRPT
        ...
        #CHECKDB-RPT_ACTIVATIONS
        And checks the value Y of the record at column PAAATTIVARPTRESP of the table RPT_ACTIVATIONS retrived by the query payment_status on db nodo_online under macro NewMod3
        And checks the value N of the record at column NODOINVIARPTREQ of the table RPT_ACTIVATIONS retrived by the query payment_status on db nodo_online under macro NewMod3
        And checks the value N of the record at column PAAATTIVARPTERROR of the table RPT_ACTIVATIONS retrived by the query payment_status on db nodo_online under macro NewMod3
        And checks the value NotNone of the record at column PAYMENT_TOKEN of the table RPT_ACTIVATIONS retrived by the query payment_status on db nodo_online under macro NewMod3

        #CHECKDB-POSITION_PAYMENT
        ...
        And checks the value None of the record at column TOKEN_VALID_FROM of the table POSITION_ACTIVATE retrived by the query payment_status on db nodo_online under macro NewMod3
        And checks the value None of the record at column TOKEN_VALID_TO of the table POSITION_ACTIVATE retrived by the query payment_status on db nodo_online under macro NewMod3
        ...
        And checks the value 1 of the record at column AMOUNT of the table POSITION_ACTIVATE retrived by the query payment_status on db nodo_online under macro NewMod3
        ...
        #CHECKDB-POSITION_TRANSFER
        And verify 0 record for the table POSITION_TRANSFER retrived by the query payment_status on db nodo_online under macro NewMod3

        #CHECKDB-POSITION_PAYMENT_PLAN
        And verify 0 record for the table POSITION_PAYMENT_PLAN retrived by the query payment_status on db nodo_online under macro NewMod3
    ...
    Scenario: Excecute nodoChiediStatoRPT
        ...
        #DBCHECK-POSITION_PAYMENT_STATUS
        ...
        #DBCHECK-POSITION_PAYMENT_STATUS_SNAPSHOT
        ...
        #DBCHECK-STATI_RPT
        And checks the value RPT_RICEVUTA_NODO, RPT_RIFIUTATA_NODO of the record at column STATO of the table STATI_RPT retrived by the query by_context_payment_token on db nodo_online under macro NewMod3

        #DBCHECK-STATI_RPT_SNAPSHOT
        And verify 0 record for the table STATI_RPT_SNAPSHOT retrived by the query by_context_payment_token on db nodo_online under macro NewMod3
