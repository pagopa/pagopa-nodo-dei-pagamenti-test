Feature: process tests for nodoInviaRPT [Retry_paaInviaRT_01]
    ...
    Scenario: DB check
        ...
        And checks the value RT_ESITO_SCONOSCIUTO_P of the record at column STATO of the table STATI_RPT_SNAPSHOT retrived by the query nodo_invia_rpt_rpt_stati on db nodo_online under macro NewMod3
