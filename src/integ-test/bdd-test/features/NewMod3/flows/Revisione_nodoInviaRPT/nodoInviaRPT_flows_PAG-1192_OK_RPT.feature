Feature: process tests for nodoInviaRPT [PAG-1192_OK_RPT]
    ...
    Scenario: Excecute nodoInviaRPT3
        ...
        #DB_CHECK- STATI_RPT
        And checks the value RPT_RICEVUTA_NODO, RPT_ACCETTATA_NODO, RPT_PARCHEGGIATA_NODO_MOD3, RPT_ANNULLATA_NODO, RT_GENERATA_NODO, RT_INVIATA_PA, RT_ACCETTATA_PA of the record at column STATO of the table STATI_RPT retrived by the query retry_pa_invia_rt on db nodo_online under macro NewMod3

        #DB_CHECK- STATI_RPT_SNAPSHOT
        And checks the value RT_ACCETTATA_PA, RPT_PARCHEGGIATA_NODO_MOD3 of the record at column STATO of the table STATI_RPT_SNAPSHOT retrived by the query retry_pa_invia_rt on db nodo_online under macro NewMod3
