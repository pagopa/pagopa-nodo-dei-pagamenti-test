Feature: process tests for nodoInviaRPT [PAG-1192_OK_RPT] 1236
    ...
    Scenario: Execute nodoInviaRPT3
        ...
        #DB_CHECK- STATI_RPT
        And checks the value RPT_RICEVUTA_NODO, RPT_ACCETTATA_NODO, RPT_PARCHEGGIATA_NODO_MOD3,  RT_GENERATA_NODO, RT_INVIATA_PA, RT_ACCETTATA_PA of the record at column STATO of the table STATI_RPT retrived by the query by_context_payment_token_3 on db nodo_online under macro NewMod3
