Feature: process tests for nodoInviaRPT [PAG-1192_timeout_RPT] 1238
    ...
    Scenario: Excecute nodoInviaRPT3
        ...
        And checks the value None of the record at column FLAG_ACTIVATE_RESP_MISSING of the table POSITION_PAYMENT retrived by the query payment_status_orderby_time on db nodo_online under macro NewMod3
    ...
    Scenario: Excecute nodoChiediCopiaRT
        Given the Excecute nodoInviaRPT3 scenario executed successfully
