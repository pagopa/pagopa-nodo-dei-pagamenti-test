Feature: process tests for nodoInviaRPT [PAG-781_errore_response]
    ...
    Scenario: Excecute nodoInviaRPT
        ...
        And through the query payment_status retrieve param SOMMA_VERSAMENTI at position 0 and save it under the key AMOUNT1
        And checks the value $AMOUNT1 of the record at column SOMMA_VERSAMENTI of the table RPT retrived by the query rt_stati on db nodo_online under macro NewMod3
