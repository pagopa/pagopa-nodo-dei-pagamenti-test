Feature: PAG-1976
  ...
  Scenario: Test 1 posizione ancora pagabile (part 1)
  ...
  Scenario: Test 1 posizione ancora pagabile (part 2)
    Given the Test 1 posizione ancora pagabile (part 1) scenario executed successfully
  ...
  Scenario: Test 2 posizione non più pagabile (part 1)
    Given the activatePaymentNotice request scenario executed successfully
    And expirationTime with 2000 in activatePaymentNotice
    When PSP sends SOAP activatePaymentNotice to nodo-dei-pagamenti
    Then check outcome is OK of activatePaymentNotice response
  ...
  Scenario: Test 2 posizione non più pagabile (part 3)
    Given the Test 2 posizione non più pagabile (part 2) scenario executed successfully
    And the sendPaymentOutcomeV2 request scenario executed successfully
    And outcome with KO in sendPaymentOutcomeV2
