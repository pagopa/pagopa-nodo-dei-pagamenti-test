Feature: process tests for retryAtokenScaduto 1197
  ...
  Scenario: Define RPT
    ...
    And RPT generation
      ...
      <pay_i:datiSpecificiRiscossione>9/0101002TS/abc</pay_i:datiSpecificiRiscossione>
      </pay_i:datiSingoloVersamento>
      </pay_i:datiVersamento>
      </pay_i:RPT>
      """
  ...
  Scenario: Define RPT2
    ...
    And RPT generation
      ...
      <pay_i:tipoVersamento>PO</pay_i:tipoVersamento>
      <pay_i:identificativoUnivocoVersamento>$iuv</pay_i:identificativoUnivocoVersamento>
      <pay_i:codiceContestoPagamento>3334f07c4cb44aecbd8a6e444bc395d3-v2</pay_i:codiceContestoPagamento>
      <pay_i:ibanAddebito>IT96R0123451234512345678904</pay_i:ibanAddebito>
      <pay_i:bicAddebito>ARTIITM1045</pay_i:bicAddebito>
      <pay_i:firmaRicevuta>0</pay_i:firmaRicevuta>
      <pay_i:datiSingoloVersamento>
  ...
  Scenario: Execute nodoInviaRPT2 request
    ...
    And initial XML nodoInviaRPT
      ...
      <identificativoDominio>$activatePaymentNotice.fiscalCode</identificativoDominio>
      <identificativoUnivocoVersamento>$iuv</identificativoUnivocoVersamento>
      <codiceContestoPagamento>3334f07c4cb44aecbd8a6e444bc395d3-v2</codiceContestoPagamento>
      </ppt:intestazionePPT>
      </soapenv:Header>
      <soapenv:Body>
      <ws:nodoInviaRPT>
