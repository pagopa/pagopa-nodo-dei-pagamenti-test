Feature: Process tests for retry a token scaduto 1155
...
# Payment Outcome Phase outcome OK 
  Scenario: Execute sendPaymentOutcome request
    ...
    And checks the value PAYING of the record at column STATUS of the table POSITION_PAYMENT_STATUS_SNAPSHOT retrived by the query position_payment_retry_05_token2 on db nodo_online under macro NewMod3
    And checks the value PAYING,INSERTED,PAYING of the record at column STATUS of the table POSITION_STATUS retrived by the query payment_status_retry_05_token1 on db nodo_online under macro NewMod3
    And checks the value PAYING of the record at column STATUS of the table POSITION_STATUS_SNAPSHOT retrived by the query payment_status_retry_05_token1 on db nodo_online under macro NewMod3
