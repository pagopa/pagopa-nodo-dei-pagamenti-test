Feature: process tests for nodoInviaRPT [PAG-1192_OK_RPT]
    ...
    Scenario: Excecute nodoInviaRPT
        ...
        And checks the value $paymentToken of the record at column PAYMENT_TOKEN of the table RPT retrived by the query rt_stati on db nodo_online under macro NewMod3
