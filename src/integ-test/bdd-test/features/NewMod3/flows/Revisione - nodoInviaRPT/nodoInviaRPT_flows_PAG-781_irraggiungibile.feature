Feature: process tests for nodoInviaRPT [PAG-781_irragiungibile]
    ...
    Background:
        ...
        And initial XML verifyPaymentNotice
            ...
            <noticeNumber>312115748926762026</noticeNumber>
            </qrCode>
            </nod:verifyPaymentNoticeReq>
            </soapenv:Body>
            </soapenv:Envelope>
    ...
    Scenario: Execute activatePaymentNotice request
        ...
        And checks the value Y of the record at column PAAATTIVARPTRESP of the table RPT_ACTIVATIONS retrived by the query by_context_num_avv on db nodo_online under macro NewMod3
        And checks the value N of the record at column NODOINVIARPTREQ of the table RPT_ACTIVATIONS retrived by the query by_context_num_avv on db nodo_online under macro NewMod3
        And checks the value Y of the record at column PAAATTIVARPTERROR of the table RPT_ACTIVATIONS retrived by the query by_context_num_avv on db nodo_online under macro NewMod3
        ...
        And execution query by_context_num_avv to get value on the table RPT_ACTIVATIONS, with the columns PAYMENT_TOKEN under macro NewMod3 with db name nodo_online
        And through the query by_context_num_avv retrieve param paymentToken at position 0 and save it under the key paymentToken
    ...
    Scenario: Excecute nodoInviaRPT
        ...
        And checks the value $PAYMENT_TOKEN of the record at column PAYMENT_TOKEN of the table POSITION_PAYMENT retrived by the query payment_status on db nodo_online under macro NewMod3
        ...
        #And checks the value $verifyPaymentNotice.idChannel of the record at column STATION_ID of the table POSITION_PAYMENT retrived by the query payment_status on db nodo_online under macro NewMod3
    ...
    Scenario: Excecute nodoChiediStatoRPT
        ...
        And initial XML nodoChiediStatoRPT
            ...
            <identificativoDominio>44444444444</identificativoDominio>
            <identificativoUnivocoVersamento>$iuv</identificativoUnivocoVersamento>
            <codiceContestoPagamento>$PAYMENT_TOKEN</codiceContestoPagamento>
            </ws:nodoChiediCopiaRT>
            </soapenv:Body>
            </soapenv:Envelope>
            """
        ...
        Then check esito is RT_GENERATA_NODO of nodoChiediStatoRPT response
