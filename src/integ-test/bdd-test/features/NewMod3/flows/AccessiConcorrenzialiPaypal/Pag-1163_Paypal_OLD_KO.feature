...
Feature: DB checks for nodoInoltraEsitoPagamentoPaypal on old PA
   ...
   Background:
      ...
      And initial XML nodoAttivaRPT
         ...
         <password>pwdpwdpwd</password>
         <codiceContestoPagamento>$ccp</codiceContestoPagamento>
         <identificativoIntermediarioPSPPagamento>#psp_AGID#</identificativoIntermediarioPSPPagamento>
      ...
      And initial XML nodoInviaRPT
         ...
         <soapenv:Header>
         <ppt:intestazionePPT>
         <identificativoIntermediarioPA>#psp#</identificativoIntermediarioPA>
         <identificativoStazioneIntermediarioPA>#canale_ATTIVATO_PRESSO_PSP#</identificativoStazioneIntermediarioPA>
         <identificativoDominio>#psp#</identificativoDominio>
