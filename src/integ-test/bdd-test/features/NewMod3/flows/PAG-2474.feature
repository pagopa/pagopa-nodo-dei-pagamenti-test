Feature: PAG 2474
    ...
    Scenario: Pa new 1.2
        ...
        # POSITION_SERVICE
        And checks the value descrizione of the record at column DESCRIPTION of the table POSITION_SERVICE retrived by the query payment_status on db nodo_online under macro NewMod3
        And checks the value azienda of the record at column COMPANY_NAME of the table POSITION_SERVICE retrived by the query payment_status on db nodo_online under macro NewMod3
        And checks the value ufficio of the record at column OFFICE_NAME of the table POSITION_SERVICE retrived by the query payment_status on db nodo_online under macro NewMod3
    ...
    Scenario: Pa new 2.2
        ...
        # POSITION_SERVICE
        And checks the value descrizione of the record at column DESCRIPTION of the table POSITION_SERVICE retrived by the query select_activatev2 on db nodo_online under macro NewMod1
        And checks the value azienda of the record at column COMPANY_NAME of the table POSITION_SERVICE retrived by the query select_activatev2 on db nodo_online under macro NewMod1
        And checks the value ufficio of the record at column OFFICE_NAME of the table POSITION_SERVICE retrived by the query select_activatev2 on db nodo_online under macro NewMod1
