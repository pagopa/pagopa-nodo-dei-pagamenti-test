...
Feature: process tests for generazioneRicevute
    ...
    Scenario: DB check
        ...
        And checks the value #id_station#,#id_station# of the record at column IDENTIFICATIVO_STAZIONE_INTERMEDIARIO_PA of the table RE retrived by the query select_paSendRT on db re under macro sendPaymentResultV2
