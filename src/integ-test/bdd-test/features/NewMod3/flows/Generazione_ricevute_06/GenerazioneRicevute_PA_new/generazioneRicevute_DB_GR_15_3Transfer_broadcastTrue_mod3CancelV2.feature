# Il test verifica che in caso di 3Transfer, nessuna stazione broadcast nella paGetPaymentResponse e annullo non sia generata alcuna receipt

Feature: 3Transfers - stazioni broadcast - mod3CancelV2 - 0 receipt
