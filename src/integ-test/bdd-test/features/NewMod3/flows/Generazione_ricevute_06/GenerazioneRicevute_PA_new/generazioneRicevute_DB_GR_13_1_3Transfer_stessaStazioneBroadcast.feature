...
Feature: 3Transfers - 1 receipt
    ...
    Scenario: Execute pa_stazione_pa update
        Then updates through the query stationUpdateBroadcastUguale of the table PA_STAZIONE_PA the parameter BROADCAST with Y under macro sendPaymentResultV2 on db nodo_cfg
    ...
    Scenario: DB check
        ...
        And checks the value 66666666666,90000000001,90000000002 of the record at column RECIPIENT_PA_FISCAL_CODE of the table POSITION_RECEIPT_RECIPIENT retrived by the query position_receipt on db nodo_online under macro NewMod3
        ...
        And checks the value 66666666666_01,90000000001_01,90000000001_01 of the record at column RECIPIENT_STATION_ID of the table POSITION_RECEIPT_RECIPIENT retrived by the query position_receipt on db nodo_online under macro NewMod3
        ...
        And checks the value 66666666666_01,66666666666_01,90000000001_01,90000000001_01,90000000001_01,90000000001_01 of the record at column IDENTIFICATIVO_EROGATORE of the table RE retrived by the query select_paSendRT on db re under macro sendPaymentResultV2
        ...
        And checks the value 66666666666,90000000001,90000000002 of the record at column RECIPIENT_PA_FISCAL_CODE of the table POSITION_RECEIPT_XML retrived by the query position_receipt on db nodo_online under macro NewMod3
        ...
        And checks the value 66666666666_01,90000000001_01,90000000001_01 of the record at column RECIPIENT_STATION_ID of the table POSITION_RECEIPT_XML retrived by the query position_receipt on db nodo_online under macro NewMod3

    #DB update 1
    Scenario: Execute pa_stazione_pa update 1
        Given the DB check scenario executed successfully
        Then updates through the query stationUpdateBroadcastUguale of the table PA_STAZIONE_PA the parameter BROADCAST with N under macro sendPaymentResultV2 on db nodo_cfg
