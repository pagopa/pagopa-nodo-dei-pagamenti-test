# Il test verifica che in caso di 1Transfer nella paGetPaymentResponse per paSecondaria e nessuna stazione broadcast, sia generata una receipt + per pa intestataria

Feature: generazioneRicevute spo senza paymentChannel
    ...
    Scenario: Execute activatePaymentNotice request
        ...
        And initial xml paGetPayment
            ...
            <entityUniqueIdentifierValue>90000000001</entityUniqueIdentifierValue>
            </uniqueIdentifier>
    ...
    Scenario: DB check
        ...
        And checks the value NOTIFIED of the record at column STATUS of the table POSITION_RECEIPT_RECIPIENT retrived by the query position_receipt on db nodo_online under macro NewMod3
