# Il test verifica che in caso di 1Transfer nella paGetPaymentResponse e SPO outcome KO, non sia generata alcuna receipt

Feature: generazioneRicevute spo KO - nessuna receipt
    ...
    # Payment Outcome Phase outcome KO - paymentChannel Assente
