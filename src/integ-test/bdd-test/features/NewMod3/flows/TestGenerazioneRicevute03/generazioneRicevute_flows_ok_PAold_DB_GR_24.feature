Feature: process tests for generazioneRicevute [DB_GR_24]
  ...
  Scenario: Execute sendPaymentOutcome request
    ...
    And PSP wait 5 seconds for expiration
    ...
    And through the query position_receipt retrieve param payment_amount at position 7 and save it under the key payment_amount
    And through the query position_receipt retrieve param description at position 8 and save it under the key description
    And through the query position_receipt retrieve param company_name at position 9 and save it under the key company_name
    And through the query position_receipt retrieve param office_name at position 10 and save it under the key office_name
    And through the query position_receipt retrieve param debtor_id at position 11 and save it under the key debtor_id
   # And through the query position_status_n retrieve param psp_id at position 0 and save it under the key psp_id
    ...
    And through the query position_receipt retrieve param channel_id at position 16 and save it under the key channel_id
    And through the query position_receipt retrieve param channel_description at position 17 and save it under the key channel_description
    And through the query position_receipt retrieve param payer_id at position 18 and save it under the key payer_id
    And through the query position_receipt retrieve param payment_method at position 19 and save it under the key payment_method
    ...
    And through the query position_receipt retrieve param application_date at position 22 and save it under the key application_date
    ...
    And through the query position_receipt retrieve param rt_id at position 25 and save it under the key rt_id
