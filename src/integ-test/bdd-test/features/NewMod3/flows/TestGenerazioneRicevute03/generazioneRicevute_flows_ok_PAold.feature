Feature: process tests for generazioneRicevute
  ...
  Scenario: Execution test DB_GR_21
    ...
    And with the query rt check assert beetwen elem SOMMA_VERSAMENTI in posisition 9 and elem AMOUNT with position 0 of the query payment_status
    ...
    And with the query rt_versamenti check assert beetwen elem IMPORTO_RT in posisition 1 and elem AMOUNT with position 0 of the query payment_status
    And checks the value ESEGUITO of the record at column s.ESITO of the table RT_VERSAMENTI retrived by the query rt_versamenti on db nodo_online under macro NewMod3
    ...
    And with the query rt_versamenti check assert beetwen elem COMMISSIONE_APPLICATE in posisition 5 and elem FEE with position 1 of the query payment_status
    ...
    And with the query position_receipt check assert beetwen elem RECEIPT_ID in posisition 0 and elem PAYMENT_TOKEN with position 2 of the query payment_status
    And with the query position_receipt check assert beetwen elem NOTICE_ID in posisition 1 and elem NOTICE_ID with position 3 of the query payment_status
    And with the query position_receipt check assert beetwen elem PA_FISCAL_CODE in posisition 2 and elem PA_FISCAL_CODE with position 4 of the query payment_status
    And with the query position_receipt check assert beetwen elem CREDITOR_REFERENCE_ID in posisition 3 and elem CREDITOR_REFERENCE_ID with position 12 of the query payment_status
    And with the query position_receipt check assert beetwen elem PAYMENT_TOKEN in posisition 4 and elem PAYMENT_TOKEN with position 2 of the query payment_status
    And with the query position_receipt check assert beetwen elem OUTCOME in posisition 5 and elem OUTCOME with position 5 of the query payment_status
    And with the query position_receipt check assert beetwen elem AMOUNT in posisition 6 and elem AMOUNT with position 0 of the query payment_status
    And with the query position_receipt check assert beetwen elem DESCRIPTION in posisition 7 and elem DESCRIPTION with position 0 of the query position_service
    And with the query position_receipt check assert beetwen elem COMPANY_NAME in posisition 8 and elem COMPANY_NAME with position 1 of the query position_service
    And with the query position_receipt check assert beetwen elem OFFICE_NAME in posisition 9 and elem OFFICE_NAME with position 2 of the query position_service
    And with the query position_receipt check assert beetwen elem DEBTOR_ID in posisition 10 and elem DEBTOR_ID with position 3 of the query position_service
    ...
    And with the query position_receipt check assert beetwen elem PSP_COMPANY_NAME in posisition 12 and elem PSP_COMPANY_NAME with position 0 of the query psp
    And with the query position_receipt check assert beetwen elem PSP_FISCAL_CODE in posisition 13 and elem PSP_FISCAL_CODE with position 1 of the query psp
    And with the query position_receipt check assert beetwen elem PSP_VAT_NUMBER in posisition 14 and elem PSP_VAT_NUMBER with position 2 of the query psp
    And with the query position_receipt check assert beetwen elem CHANNEL_ID in posisition 15 and elem CHANNEL_ID with position 6 of the query payment_status
    And with the query position_receipt check assert beetwen elem CHANNEL_DESCRIPTION in posisition 16 and elem PAYMENT_CHANNEL with position 7 of the query payment_status
    And with the query position_receipt check assert beetwen elem PAYER_ID in posisition 17 and elem PAYER_ID with position 8 of the query payment_status
    And with the query position_receipt check assert beetwen elem PAYMENT_METHOD in posisition 18 and elem PAYMENT_METHOD with position 9 of the query payment_status
    And with the query position_receipt check assert beetwen elem FEE in posisition 19 and elem FEE with position 1 of the query payment_status
    ...
    And with the query position_receipt check assert beetwen elem APPLICATION_DATE in posisition 21 and elem APPLICATION_DATE with position 11 of the query payment_status
    ...
    And with the query position_receipt check assert beetwen elem METADATA in posisition 23 and elem METADATA with position 0 of the query position_payment_plan
    And with the query position_receipt check assert beetwen elem RT_ID in posisition 24 and elem METADATA with position 13 of the query rt
    And with the query position_receipt check assert beetwen elem FK_POSITION_PAYMENT in posisition 25 and elem METADATA with position 10 of the query payment_status
    #RT_XML
    ...
    And with the query position_receipt_transfer check assert beetwen elem RECEIPT in posisition 0 and elem ID with position 26 of the query position_receipt
    ...
    And with the query position_receipt_transfer check assert beetwen elem TRANSFER in posisition 1 and elem ID with position 0 of the query position_transfer
    ...
    And with the query position_receipt_xml check assert beetwen elem PA_FISCAL_CODE in posisition 1 and elem PA_FISCAL_CODE with position 4 of the query payment_status
    And with the query position_receipt_xml check assert beetwen elem NOTICE_ID in posisition 2 and elem NOTICE_ID with position 3 of the query payment_status
    And with the query position_receipt_xml check assert beetwen elem CREDITOR_REFERENCE_ID in posisition 3 and elem CREDITOR_REFERENCE_ID with position 12 of the query payment_status
    And with the query position_receipt_xml check assert beetwen elem PAYMENT_TOKEN in posisition 4 and elem PAYMENT_TOKEN with position 2 of the query payment_status
    And with the query position_receipt_xml check assert beetwen elem RECIPIENT_PA_FISCAL_CODE in posisition 5 and elem PA_FISCAL_CODE with position 4 of the query payment_status
    And with the query position_receipt_xml check assert beetwen elem RECIPIENT_BROKER_PA_ID in posisition 6 and elem RECIPIENT_BROKER_PA_ID with position 13 of the query payment_status
    And with the query position_receipt_xml check assert beetwen elem RECIPIENT_STATION_ID in posisition 7 and elem RECIPIENT_STATION_ID with position 14 of the query payment_status
    ...
    And with the query position_receipt_xml check assert beetwen elem FK_POSITION_RECEIPT in posisition 10 and elem ID with position 26 of the query position_receipt
