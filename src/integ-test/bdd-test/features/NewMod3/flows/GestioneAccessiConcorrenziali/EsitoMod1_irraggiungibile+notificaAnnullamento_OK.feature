Feature: process tests for Gestione Accessi Concorrenziali 1093

  Background:
    Given systems up

  Scenario: EsitoMod1_irraggiungibile+notificaAnnullamento_OK (part 1)
  ...
  @runnable
  Scenario: EsitoMod1_irraggiungibile+notificaAnnullamento_OK (part 2)
    Given the EsitoMod1_irraggiungibile+notificaAnnullamento_OK (part 1) scenario executed successfully
