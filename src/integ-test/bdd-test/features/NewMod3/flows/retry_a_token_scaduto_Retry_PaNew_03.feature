...
# Payment Outcome Phase outcome OK 
  Scenario: Execute sendPaymentOutcome request
    ...
    And checks the value NotNone of the record at column ID of the table INSERTED_TIMESTAMP retrived by the query position_subject on db nodo_online under macro NewMod3
