Feature: Syntax checks KO for activatePaymentNoticeReq 1373
  ...
  Scenario Outline: Check PPT_SINTASSI_EXTRAXSD error on invalid body element value
    ...
    Examples:
      ...
      | idempotencyKey               | A1_12445657684                       | SIN_APNR_21 |
      | idempotencyKey               | 700ABCD17E000hj123_124456576         | SIN_APNR_22 |
      | idempotencyKey               | A_1244565768                         | SIN_APNR_21 |
      | idempotencyKey               | 700ABCD17E000hj1234_1244565768       | SIN_APNR_22 |
