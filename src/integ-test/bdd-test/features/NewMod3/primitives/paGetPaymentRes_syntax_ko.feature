Feature: Syntax checks for paGetPaymentRes - KO
   ...
   Scenario Outline: Check PPT_STAZIONE_INT_PA_ERRORE_RESPONSE error on invalid body element value
      ...
      Examples:
         ...
         | paymentCategory             | JmlerpxGsErHDYYfmWLGjwCkDXifIhunjwiOaMAKMzekUkGBNkqAYsDxGtbAKSJZiAJQHiOgfkrHucuHDDYduOYvaGAmZqeXMIJNbtxxftUUcPmeMgCuPmLlQHrsdfCqUaWwRaMlNpzPD                                                                                                                     | SIN_PGPR_37   |
