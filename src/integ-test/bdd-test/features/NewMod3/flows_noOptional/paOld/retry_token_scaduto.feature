Feature: NM3 flows PA Old con retry a token scaduto
    ...
    # spo- arriva dopo la scadenza della sessione ma prima della RPT
    @ALL @NM3 @NM3PAOLD @NM3PAOLDRETRY @NM3PAOLDRETRY_3 @after
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDRETRY @NM3PAOLDRETRY_4 @after
    ...
    # sessione scade dopo RPT ma prima di SPO (RPT in stato RT_ACCETTATA_PA), retry attiva in OK
    @ALL @NM3 @NM3PAOLD @NM3PAOLDRETRY @NM3PAOLDRETRY_5 @after
    ...
    # spo arriva dopo la scadenza della sessione ma prima della RPT
    @ALL @NM3 @NM3PAOLD @NM3PAOLDRETRY @NM3PAOLDRETRY_6 @after
    ...
    # spo arriva dopo la scadenza della sessione ma prima della RPT
    @ALL @NM3 @NM3PAOLD @NM3PAOLDRETRY @NM3PAOLDRETRY_7 @after
    ...
    # spo arriva dopo la scadenza della sessione ma prima della RPT
    @ALL @NM3 @NM3PAOLD @NM3PAOLDRETRY @NM3PAOLDRETRY_8 @after
