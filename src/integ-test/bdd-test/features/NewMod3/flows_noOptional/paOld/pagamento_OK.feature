Feature: NM3 flows PA Old con pagamento OK
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_1 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_2 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_4 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_5
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_6 @after_2
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_7 @after_2
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_9 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_10 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_11 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_12 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_13 @after_3
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_14 @after_1
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_15 @after_1
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_16 @after_1
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_17 @after_3
    Scenario: NM3 flow OK, FLOW con PA Old e PSP vp1: activate -> paaAttivaRPT  spo+ REQ -> lock nodoInviaRPT REQ -> aspetta lock spo+ RESP nodoInviaRPT RESP -> paaInviaRT+ BIZ+ (NM3-105)
        ...
        Given from body with datatable horizontal sendPaymentOutcomeBody_noOptional initial XML sendPaymentOutcome
            | idPSP | idBrokerPSP     | idChannel                    | password   | paymentToken                                | outcome |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | $activatePaymentNoticeResponse.paymentToken | OK      |
        When calling primitive evolution sendPaymentOutcome and nodoInviaRPT with POST and POST in parallel with 100 ms delay
        Then check esito is OK of nodoInviaRPT response
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_18 @after_3
    Scenario: NM3 flow OK, FLOW con PA Old e PSP vp1: activate -> paaAttivaRPT   nodoInviaRPT REQ -> lock spo+ REQ -> aspetta lock nodoInviaRPT RESP spo+ RESP -> paaInviaRT+ BIZ+ (NM3-106)
        ...
        Given from body with datatable horizontal sendPaymentOutcomeBody_noOptional initial XML sendPaymentOutcome
            | idPSP | idBrokerPSP     | idChannel                    | password   | paymentToken                                | outcome |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | $activatePaymentNoticeResponse.paymentToken | OK      |
        When calling primitive evolution nodoInviaRPT and sendPaymentOutcome with POST and POST in parallel with 100 ms delay
        Then check esito is OK of nodoInviaRPT response
        And check outcome is OK of sendPaymentOutcome response
        And wait 5 seconds for expiration
        # RE
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_19
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_20
    Scenario: NM3 flow OK, FLOW con PA Old e PSP vp2: activateV2 -> paaAttivaRPT  spoV2+ (NM3-29)
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | CREDITOR_REFERENCE_ID | 12$iuv                                        |
            | PAYMENT_TOKEN         | $activatePaymentNoticeV2Response.paymentToken |
            | INSERTED_BY           | activatePaymentNoticeV2,sendPaymentOutcomeV2  |
        And checks all values by $dict_fields_values_expected of the record for each columns $list_columns of the table POSITION_PAYMENT_STATUS retrived by the query on db nodo_online with where datatable horizontal
            | where_keys     | where_values                          |
            | NOTICE_ID      | $activatePaymentNoticeV2.noticeNumber |
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_21
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_22 @after_2
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_23
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_24 @after_2
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_25
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_26 @after_2
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_27
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_28 @after_1
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_29 @after_1
    ...
    @ALL @NM3 @NM3PAOLD @NM3PAOLDPAGOK @NM3PAOLDPAGOK_30 @after_1
    Scenario: NM3 flow OK, FLOW con PA Old e PSP POSTE vp1 activate PSP POSTE vp2 spo: verificaBollettino -> paaVerificaRPT activate -> paaAttivaRPT  spoV2+  nodoInviaRPT -> paaInviaRT+ (tramite job paInviaRT) BIZ+ (NM3-57)
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | CREDITOR_REFERENCE_ID | 12$iuv                                                                            |
            | PAYMENT_TOKEN         | $activatePaymentNoticeResponse.paymentToken                                       |
            | INSERTED_BY           | activatePaymentNotice,sendPaymentOutcomeV2,nodoInviaRPT,nodoInviaRPT,nodoInviaRPT |
        And checks all values by $dict_fields_values_expected of the record for each columns $list_columns of the table POSITION_PAYMENT_STATUS retrived by the query on db nodo_online with where datatable horizontal
            | where_keys     | where_values                        |
            | NOTICE_ID      | $activatePaymentNotice.noticeNumber |
            | PA_FISCAL_CODE | $activatePaymentNotice.fiscalCode   |
