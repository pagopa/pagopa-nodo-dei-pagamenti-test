Feature:  semantic check for activatePaymentNoticeReq regarding idempotency - not PPT_ERRORE_IDEMPOTENZA [SEM_APNR_20.1]
  ...
  # Activate Phase 2
  Scenario Outcome: Execute activatePaymentNotice request different from Activate Phase 1 with same idempotencyKey
    ...
    Examples:
      ...
      | noticeNumber         | 311456789012345675       | noticeNumber diverso |
