Feature: revision checks for sendPaymentOutcomeV2
   ...
   Scenario: REV_SPO_03 (part 6)
      ...
      And checks the value 'BPAY' of the record at column PAYMENT_CHANNEL of the table POSITION_PAYMENT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
