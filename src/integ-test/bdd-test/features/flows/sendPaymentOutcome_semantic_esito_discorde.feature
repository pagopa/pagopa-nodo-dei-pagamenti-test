Feature:  semantic checks for sendPaymentOutcomeReq - esito discorde #[SEM_SPO_25]
  ...
  Background:
    ...
    And outcome KO in sendPaymentOutcomeReq
    ...
    And description contains 'Esito discorde:'+ JSON 