Feature:  flow checks for demandPaymentNoticeRequest - paGetPaymentRes 3Transfers - TF_DPNR_05
...
Background:
  ...
  Scenario: Execute demandPaymentNoticeRequest
    ...
    And check POSITION_RECEIPT_TRANSFER table of NODO_ONLINE doesn't contain a record