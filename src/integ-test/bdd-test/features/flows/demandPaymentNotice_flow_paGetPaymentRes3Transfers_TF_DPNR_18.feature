Feature:  flow checks for demandPaymentNoticeRequest - paGetPaymentRes 3Transfers - broadcast = true - TF_DPNR_18
...
Background:
    ...
    #DB update step
    # UPDATE PA_STAZIONE_PA s SET s.BROADCAST = 'Y' WHERE s.FK_PA IN ('','')" - 2 broadcast true for pa secondary
