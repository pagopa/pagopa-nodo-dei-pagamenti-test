Feature:  flow checks for demandPaymentNoticeRequest - paGetPaymentRes 3Transfers - broadcast = true - TF_DPNR_13
...
Background:
    ...
    # And check POSITION_RECEIPT_RECIPIENT table of NODO_ONLINE contains 3 records for noticeId = $demandPaymentNoticeResponse.notice_number (1 for paIntestataria and 2 for paSecondarie)
    ...
    # And check POSITION_RECEIPT_XML of NODO_ONLINE contains 3 records for noticeId = $demandPaymentNoticeResponse.notice_number having recipient_pa_fiscal_code = 1paIntestataria and 2 for paSecondarie
