Feature: revision checks for sendPaymentOutcomeV2
   ...
   Scenario: REV_SPO_03 (part 3)
      ...
      And checks the value 10$iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_PAYMENT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value $activatePaymentNoticeV2.idempotencyKey of the record at column IDEMPOTENCY_KEY of the table POSITION_PAYMENT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      And checks the value $activatePaymentNoticeV2.amount of the record at column AMOUNT of the table POSITION_PAYMENT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value 10$iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_RECEIPT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value $activatePaymentNoticeV2.amount of the record at column AMOUNT of the table POSITION_RECEIPT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value 10$iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_RECEIPT_XML retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value $activatePaymentNoticeV2.fiscalCode of the record at column RECIPIENT_PA_FISCAL_CODE of the table POSITION_RECEIPT_XML retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value 10$iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_RECEIPT_RECIPIENT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
      ...
      And checks the value $activatePaymentNoticeV2.fiscalCode of the record at column RECIPIENT_PA_FISCAL_CODE of the table POSITION_RECEIPT_RECIPIENT retrived by the query noticeid_pa on db nodo_online under macro NewMod1
...
# "NewMod1" : {"noticeid_pa": "SELECT columns FROM table_name WHERE NOTICE_ID = '310$iuv' and ID_DOMINIO = '#creditor_institution_code#' ORDER BY ID ASC",
