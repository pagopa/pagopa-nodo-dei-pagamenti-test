Feature:  flow checks for demandPaymentNoticeRequest - PaymentChannel not present - TF_DPNR_01
...
Background:
  ...
  Scenario: Execute demandPaymentNoticeRequest
    ...
    # sendPaymentOutcome Phase outcome OK - paymentChannel not present
    ...
    And check POSITION_RECEIPT table of NODO_ONLINE contains a row for noticeId = $demandPaymentNoticeResponse.notice_number