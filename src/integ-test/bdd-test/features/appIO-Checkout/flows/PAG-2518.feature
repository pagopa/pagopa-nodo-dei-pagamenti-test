Feature: PAG-2518
    ...
    Scenario: Test 1.1
        ...
        And checks the value $ccp,TPAY,$psp_transaction_id,clientId&deviceId of the record at column VALUE of the table PM_METADATA retrived by the query transactionid on db nodo_online under macro NewMod1
