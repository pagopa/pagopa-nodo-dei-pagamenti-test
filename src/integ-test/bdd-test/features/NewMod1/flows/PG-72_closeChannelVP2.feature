Feature: PG-72 close with channel VP2 2

    Background:
        Given systems up

    Scenario: second activatePaymentNoticeV2 VP2 request
    ...
    Scenario: closePaymentV2 channel VP2 request
        Given the second activatePaymentNoticeV2 VP2 request scenario executed successfully
    ...
    @test
    Scenario: second sendPaymentOutcomeV2 request
        Given the closePaymentV2 channel VP2 request scenario executed successfully
