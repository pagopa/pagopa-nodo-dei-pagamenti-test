Feature: PAG-2258
    ...
    Scenario: Test spov1 (part 1)
        Given the activatePaymentNotice request scenario executed successfully
        When psp sends SOAP activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
    @bug
    Scenario: Test spov1 (part 2)
        Given the Test spov1 (part 1) scenario executed successfully
    ...
    Scenario: Test spov2 (part 1)
        Given the activatePaymentNotice request scenario executed successfully
        When psp sends SOAP activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
    @bug
    Scenario: Test spov2 (part 2)
        Given the Test spov2 (part 1) scenario executed successfully
