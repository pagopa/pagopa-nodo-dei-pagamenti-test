Feature: flow tests for closePaymentV2 935
    ...
    Scenario: activatePaymentNoticeV2 eCommerce request
        Given initial XML activatePaymentNoticeV2
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
            xmlns:nod="http://pagopa-api.pagopa.gov.it/node/nodeForPsp.xsd">
    ...
    Scenario: FLUSSO_NM1_CP_08
        ...
        And the activatePaymentNoticeV2 eCommerce request scenario executed successfully
        ...
        And update through the query param_update_in of the table POSITION_PAYMENT the parameter RICEVUTA_PM with Y, with where condition OBJ_ID and where value $obj_id under macro update_query on db nodo_online
        And checks the value Y of the record at column RICEVUTA_PM of the table POSITION_PAYMENT retrived by the query notice_id_first_activatev2 on db nodo_online under macro NewMod1
