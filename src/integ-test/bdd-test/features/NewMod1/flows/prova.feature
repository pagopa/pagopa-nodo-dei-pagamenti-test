...
#########################################################################################################
    ...
    Scenario: Test spov1 payment unknown (part 1)
        Given the activatePaymentNoticeV2 request scenario executed successfully
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response

    Scenario: Test spov1 payment unknown (part 2)
        Given the Test spov1 payment unknown (part 1) scenario executed successfully
    ...
    @bug
    Scenario: Test spov1 payment unknown (part 3)
        Given the Test spov1 payment unknown (part 2) scenario executed successfully
...
#########################################################################################################
    ...
    Scenario: Test spov1 payment accepted (part 1)
        Given the activatePaymentNoticeV2 request scenario executed successfully
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response

    Scenario: Test spov1 payment accepted (part 2)
        Given the Test spov1 payment accepted (part 1) scenario executed successfully
        And the closePaymentV2 request scenario executed successfully
        When WISP sends rest POST v2/closepayment_json to nodo-dei-pagamenti
        Then verify the HTTP status code of v2/closepayment response is 200
        And check outcome is OK of v2/closepayment response
    @bug
    Scenario: Test spov1 payment accepted (part 3)
        Given the Test spov1 payment accepted (part 2) scenario executed successfully
        And the sendPaymentOutcome request scenario executed successfully
        When psp sends SOAP sendPaymentOutcome to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcome response