Feature: PG-72 close with channel VP1 3

    Background:
        Given systems up

    Scenario: activatePaymentNoticeV2 VP2 request
    ...
    Scenario: closePaymentV2 request
        Given the activatePaymentNoticeV2 VP2 request scenario executed successfully
