...
Scenario: FLUSSO_SPR_11 (part 4)
    ...
    And wait 5 seconds for expiration
    And job positionRetrySendPaymentResult triggered after 65 seconds
    And wait 15 seconds for expiration
    And verify 1 record for the table POSITION_RETRY_SENDPAYMENTRESULT retrived by the query retry_spr on db nodo_online under macro NewMod1
