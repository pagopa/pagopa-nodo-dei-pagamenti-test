Feature: PG-72 close with channel VP1 2

    Background:
        Given systems up

    Scenario: activatePaymentNoticeV2 VP1 request
    ...
    Scenario: closePaymentV2 request
        Given the activatePaymentNoticeV2 VP1 request scenario executed successfully
