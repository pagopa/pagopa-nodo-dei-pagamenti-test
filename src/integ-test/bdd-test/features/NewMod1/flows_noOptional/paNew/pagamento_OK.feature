Feature: NMU flows con PA New pagamento OK
    ...
    Scenario: NMU flow OK, FLOW con PA New vp1 e PSP vp1 con broadcast paPrinc!=paSec standin flag_standin_psp flag_standin_pa flag invioReceiptStandin=true: PA New vp1 standin con broadcast sia vp1 che vp2, Broadcast alcune con flag_standin_pa=Y altre =N, checkPosition, activateV2 -> paGetPayment verso ACA 5 transfer paPrincip != paSecond, closeV2+ -> pspNotify flag standin=true, spo+  -> paSendRT verso stazione principale (quella del nav), paSendRT/V2 verso broadcast PA secondarie tutte le receipt verso broadcast con flag_standin_pa=Y hanno flagStandin = true, BIZ+ e SPRv2+ (NMU-38)
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            | column                   | value                                                                                                                                       |
            | ID                       | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | CREDITOR_REFERENCE_ID    | 47$iuv,47$iuv,47$iuv,47$iuv,47$iuv                                                                                                          |
            | PA_FISCAL_CODE_SECONDARY | 90000000001,90000000002,90000000003,88888888888,88888888888                                                                                 |
            | IBAN                     | IT45R0760103200000000001016,IT45R0760103200000000001016,IT45R0760103200000000001016,IT45R0760103200000000001016,IT45R0760103200000000001016 |
            | AMOUNT                   | 10,10,10,10,10                                                                                                                              |
            | REMITTANCE_INFORMATION   | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | TRANSFER_CATEGORY        | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | TRANSFER_IDENTIFIER      | 1,2,3,4,5                                                                                                                                   |
            | VALID                    | Y,Y,Y,Y,Y                                                                                                                                   |
            | FK_POSITION_PAYMENT      | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | INSERTED_TIMESTAMP       | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | UPDATED_TIMESTAMP        | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | FK_PAYMENT_PLAN          | NotNone,NotNone,NotNone,NotNone,NotNone                                                                                                     |
            | INSERTED_BY              | activatePaymentNoticeV2,activatePaymentNoticeV2,activatePaymentNoticeV2,activatePaymentNoticeV2,activatePaymentNoticeV2                     |
            | UPDATED_BY               | activatePaymentNoticeV2,activatePaymentNoticeV2,activatePaymentNoticeV2,activatePaymentNoticeV2,activatePaymentNoticeV2                     |
        And checks all values by $dict_fields_values_expected of the record for each columns $list_columns of the table POSITION_TRANSFER retrived by the query on db nodo_online with where datatable horizontal
            | where_keys     | where_values                          |
            | NOTICE_ID      | $activatePaymentNoticeV2.noticeNumber |
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
