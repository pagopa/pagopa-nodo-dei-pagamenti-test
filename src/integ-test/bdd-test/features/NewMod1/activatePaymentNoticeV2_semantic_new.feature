Feature: semantic checks new for activatePaymentNoticeV2Request
    ...
    Scenario: semantic check 26
        ...
        # And checks the value NotNone of the record at column POSITION_PAYMENT_PLAN.INSERTED_TIMESTAMP of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        # And checks the value NotNone of the record at column POSITION_PAYMENT_PLAN.UPDATED_TIMESTAMP of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        # And verify 1 record for the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        # And checks the value NotNone of the record at column POSITION_TRANSFER.ID of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        ...
        # And checks the value $paGetPaymentV2.IBAN of the record at column IBAN of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        # And checks the value $paGetPaymentV2.remittanceInformation of the record at column REMITTANCE_INFORMATION of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        # And checks the value $paGetPaymentV2.transferCategory of the record at column TRANSFER_CATEGORY of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        ...
        # And checks the value NotNone of the record at column POSITION_TRANSFER.INSERTED_TIMESTAMP of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        # And checks the value NotNone of the record at column POSITION_TRANSFER.UPDATED_TIMESTAMP of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        ...
        # And verify 1 record for the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment_plan on db nodo_online under macro NewMod1
        ...
        # And checks the value NotNone of the record at column ID of the table POSITION_STATUS_SNAPSHOT JOIN POSITION_SERVICE ON (POSITION_STATUS_SNAPSHOT.FK_POSITION_SERVICE = POSITION_SERVICE.ID) retrived by the query position_status_snapshot on db nodo_online under macro NewMod1
        ...
        And checks the value $activatePaymentNoticeV2.dueDate of the record at column TO_CHAR(DUE_DATE, 'yyyy-mm-dd') of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) retrived by the query position_service on db nodo_online under macro NewMod1
        ...
        And checks the value $activatePaymentNoticeV2.dueDate of the record at column TO_CHAR(DUE_DATE, 'yyyy-mm-dd') of the table POSITION_SERVICE JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT_PLAN.FK_POSITION_SERVICE=POSITION_SERVICE.ID) JOIN POSITION_TRANSFER ON (POSITION_TRANSFER.FK_PAYMENT_PLAN=POSITION_PAYMENT_PLAN.ID) retrived by the query position_service on db nodo_online under macro NewMod1
        ...
        And checks the value NotNone of the record at column POSITION_STATUS_SNAPSHOT.ID of the table POSITION_PAYMENT JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT.FK_PAYMENT_PLAN = POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment on db nodo_online under macro NewMod1
        ...
        And checks the value #stazione_versione_primitive_2# of the record at column STATION of the table POSITION_PAYMENT JOIN POSITION_PAYMENT_PLAN ON (POSITION_PAYMENT.FK_PAYMENT_PLAN = POSITION_PAYMENT_PLAN.ID) retrived by the query position_payment on db nodo_online under macro NewMod1
        ...
        And checks the value NotNone of the record at column ID of the table POSITION_PAYMENT_STATUS_SNAPSHOT JOIN POSITION_PAYMENT ON (POSITION_PAYMENT_STATUS_SNAPSHOT.FK_POSITION_PAYMENT = POSITION_PAYMENT.ID) retrived by the query position_payment_status_snapshot on db nodo_online under macro NewMod1
