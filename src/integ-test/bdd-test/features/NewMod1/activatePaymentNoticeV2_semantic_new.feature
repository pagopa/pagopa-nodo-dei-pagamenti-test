...
@wip
    ...
    Scenario: semantic check 26
        ...
        And checks the value NotNone of the record at column POSITION_TRANSFER.ID of the table POSITION_STATUS retrived by the query select_activatev2 on db nodo_online under macro NewMod1
        ...
        And checks the value NotNone of the record at column POSITION_TRANSFER.INSERTED_TIMESTAMP of the table POSITION_STATUS retrived by the query select_activatev2 on db nodo_online under macro NewMod1
        And verify 1 record for the table POSITION_STATUS retrived by the query position_payment_plan on db nodo_online under macro NewMod1
