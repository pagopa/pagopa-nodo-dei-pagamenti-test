Feature: flux tests for demandPaymentNotice
    ...
    Scenario: F_DPNR_07 (part 2)
        ...
        And check value $XML_DB.payer.uniqueIdentifier.entityUniqueIdentifierType is equal to value $sendPaymentOutcome.entityUniqueIdentifierType
        # da continuare check payer
