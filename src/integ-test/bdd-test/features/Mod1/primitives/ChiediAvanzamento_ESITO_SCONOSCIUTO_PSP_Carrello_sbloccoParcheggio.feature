Feature: process tests for ChiediAvanzamento_ESITO_SCONOSCIUTO_PSP_Carrello_sbloccoParcheggio
    ...
    Scenario: RPT generation
        ...
        <pay_i:dominio>
        <pay_i:identificativoDominio>77777777777</pay_i:identificativoDominio>
        <pay_i:identificativoStazioneRichiedente>77777777777_03</pay_i:identificativoStazioneRichiedente>
        </pay_i:dominio>
    ...
    Scenario: Execute check DB-RPT
        ...
        Then checks the value RPT_RICEVUTA_NODO,RPT_ACCETTATA_NODO,RPT_PARCHEGGIATA_NODO of the record at column STATO of the table STATI_RPT retrived by the query stati_RPT on db nodo_online under macro Mod1
