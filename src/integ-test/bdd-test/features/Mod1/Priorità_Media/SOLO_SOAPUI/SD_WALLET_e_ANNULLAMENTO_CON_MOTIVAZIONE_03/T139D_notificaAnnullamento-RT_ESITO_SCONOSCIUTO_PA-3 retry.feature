  ...
  Background:
    ...
    <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/"
      ...
      <pay_i:datiVersamento>
        ...
        <pay_i:identificativoUnivocoVersamento>esitoSconosciutoPA</pay_i:identificativoUnivocoVersamento>
  ...
  Scenario: Execute nodoInviaRPT request
    ...
    <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
      ...
      <ppt:intestazionePPT>
        ...
        <identificativoUnivocoVersamento>esitoSconosciutoPA</identificativoUnivocoVersamento>
