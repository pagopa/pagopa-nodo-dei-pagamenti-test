Feature: T123_ChiediListePSP_Carr_Bollo
  Background:
    ...
    <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
      ...
      <IUBD>#iubd#</IUBD>
      <OraAcquisto>#timedate#</OraAcquisto>
    ...
    And RT generation
    """
    <pay_i:RT xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
          xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/"
          xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0.xsd ">
      <pay_i:versioneOggetto>6.0</pay_i:versioneOggetto>
      <pay_i:dominio>
        <pay_i:identificativoDominio>#creditor_institution_code#</pay_i:identificativoDominio>
        <pay_i:identificativoStazioneRichiedente>#id_station#</pay_i:identificativoStazioneRichiedente>
      ...
      <pay_i:dataOraMessaggioRicevuta>#dataora#</pay_i:dataOraMessaggioRicevuta>
      ...
      <pay_i:datiPagamento>
        ...
        <pay_i:datiSingoloPagamento>
          ...
          <pay_i:dataEsitoSingoloPagamento>#data#</pay_i:dataEsitoSingoloPagamento>
