Feature: T126_InoltraEsitoPagamentoCarta_RPT_KO
  Background:
    ...
    <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/"
      ...
      <pay_i:datiVersamento>
        ...
        <pay_i:codiceContestoPagamento>16696516032071</pay_i:codiceContestoPagamento>
  ...
  Scenario: Execute nodoInviaRPT request
    ...
    <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
      ...
      <ppt:intestazionePPT>
        ...
        <codiceContestoPagamento>16696516032071</codiceContestoPagamento>
      </ppt:intestazionePPT>
      </soapenv:Header>
      <soapenv:Body>
      <ws:nodoInviaRPT>
  ...
  Scenario: Execute nodoInoltraEsitoPagamentoCarta request
      ...
      <soapenv:Body>
          <ws:pspInviaCarrelloRPTCarteResponse>
              <pspInviaCarrelloRPTResponse>
                  ...
                  <identificativoCarrello>RPTdaRifPsp</identificativoCarrello>
                  <parametriPagamentoImmediato>idBruciatura=RPTdaRifPsp</parametriPagamentoImmediato>
              </pspInviaCarrelloRPTResponse>
          </ws:pspInviaCarrelloRPTCarteResponse>
      </soapenv:Body>
    </soapenv:Envelope>
    ...
    And check error is Risposta negativa del Canale of inoltroEsito/carta response
