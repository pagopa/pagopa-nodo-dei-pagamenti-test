Feature: T126_InoltraEsitoPagamentoCarta_RPT_KO_AUTH
  Background:
    Given systems up
  ...
  Scenario: Execute nodoInviaRPT request
    ...
    And RPT generation
      ...
      <pay_i:identificativoUnivocoVersamento>koAuth</pay_i:identificativoUnivocoVersamento>
    ...
    And RT generation
      ...
      <pay_i:identificativoUnivocoRiscossione>koAuth</pay_i:identificativoUnivocoRiscossione>
    ...
    And initial XML nodoInviaRPT
      ...
      <identificativoUnivocoVersamento>koAuth</identificativoUnivocoVersamento>
