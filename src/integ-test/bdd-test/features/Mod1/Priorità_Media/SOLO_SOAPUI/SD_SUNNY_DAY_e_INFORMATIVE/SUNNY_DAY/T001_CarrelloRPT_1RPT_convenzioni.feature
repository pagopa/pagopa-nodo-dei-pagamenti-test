Feature: T001_CarrelloRPT_1RPT_convenzioni
    ...
    Scenario: Execute nodoInviaCarrelloRPT (Phase 1)
        ...
        And checks the value CONV1 of the record at column CODICE_CONVENZIONE of the table CARRELLO retrived by the query motivo_annullamento on db nodo_online under macro Mod1