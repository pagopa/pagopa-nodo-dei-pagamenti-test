Feature: T198_RichiestaeRispostarevoca_tipoRevoca=0
    ...
    Scenario: Execute nodoChiediStatoRPT1
      Given the Execute nodoInviaRichiestaRevoca scenario executed successfully
      And initial XML nodoChiediStatoRPT
        """
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header />
        ...
        """
      When EC sends SOAP nodoChiediStatoRPT to nodo-dei-pagamenti
      Then checks stato contains RR_ACCETTATA of nodoChiediStatoRPT response
      And checks stato contains RPT_RICEVUTA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_ACCETTATA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_ACCETTATA_PSP of nodoChiediStatoRPT response
      And checks stato contains RT_RICEVUTA_NODO of nodoChiediStatoRPT response
    ...
    Scenario: Execute nodoInviaRichiestaRevoca1
        ...
        And initial XML nodoInviaRichiestaRevoca
            ...
            """
        When EC sends SOAP nodoInviaRichiestaRevoca to nodo-dei-pagamenti
        Then check faultCode is PPT_OPER_NON_REVOCABILE of nodoInviaRichiestaRevoca response

    Scenario: Execute nodoChiediStatoRPT2
      Given the Execute nodoInviaRichiestaRevoca1 scenario executed successfully
      And initial XML nodoChiediStatoRPT
        """
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header />
        ...
        """
      When EC sends SOAP nodoChiediStatoRPT to nodo-dei-pagamenti
      Then checks stato contains RR_RIFIUTATA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_RICEVUTA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_ACCETTATA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_ACCETTATA_PSP of nodoChiediStatoRPT response
      And checks stato contains RT_RICEVUTA_NODO of nodoChiediStatoRPT response
    ...
    Scenario: Execute nodoInviaRichiestaRevoca2
        Given the Execute nodoChiediStatoRPT scenario executed successfully
        And initial XML nodoInviaRichiestaRevoca
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
    ...
    Scenario: Execute nodoChiediStatoRPT3
      Given the Execute nodoInviaRichiestaRevoca2 scenario executed successfully
      And initial XML nodoChiediStatoRPT
        """
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header />
        ...
        """
      When EC sends SOAP nodoChiediStatoRPT to nodo-dei-pagamenti
      Then checks stato contains RT_REVOCATA of nodoChiediStatoRPT response
      And checks stato contains RPT_RICEVUTA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_ACCETTATA_NODO of nodoChiediStatoRPT response
      And checks stato contains RPT_ACCETTATA_PSP of nodoChiediStatoRPT response
      And checks stato contains RT_RICEVUTA_NODO of nodoChiediStatoRPT response
    ...
    Scenario: Execute nodoChiediStatoRPT4
