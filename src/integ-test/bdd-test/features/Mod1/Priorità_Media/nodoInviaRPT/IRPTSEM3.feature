Feature: process tests for nodoInviaRT[IRPTSEM3]
    Background:
        Given systems up
    ...
    Scenario: Execute nodoInviaRPT request
        ...
        And initial XML nodoInviaRPT
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/ciao/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header>
                <ppt:intestazionePPT>
                    <identificativoIntermediarioPA>44444444444</identificativoIntermediarioPA>
                    <identificativoStazioneIntermediarioPA>ciao</identificativoStazioneIntermediarioPA>
            ...
            And check faultCode is PPT_STAZIONE_INT_PA_SCONOSCIUTA of nodoInviaRPT response