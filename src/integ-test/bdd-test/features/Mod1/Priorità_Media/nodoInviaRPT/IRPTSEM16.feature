Feature: process tests for nodoInviaRT[IRPTSEM16]
    Background:
        Given systems up
        ...
        <pay_i:identificativoUnivocoVersamento>irraggiungibile</pay_i:identificativoUnivocoVersamento>
    ...
    Scenario: Execute nodoInviaRPT request
        ...
        And initial XML nodoInviaRPT
            ...
            <identificativoUnivocoVersamento>irraggiungibile</identificativoUnivocoVersamento>
