Feature: process tests for nodoInviaRT[IRPTSEM5]
    Background:
        Given systems up
        ...
        And initial XML nodoInviaRPT
            ...
            <soapenv:Header>
                <ppt:intestazionePPT>
                    ...
                    <identificativoDominio>ciao</identificativoDominio>
            ...
            And check faultCode is PPT_DOMINIO_SCONOSCIUTO of nodoInviaRPT response