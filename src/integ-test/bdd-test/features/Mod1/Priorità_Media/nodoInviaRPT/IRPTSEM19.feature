Feature: process tests for nodoInviaRT[IRPTSEM19]
    Background:
        Given systems up
        ...
        Given RPT generation
            ...
            <pay_i:dominio>
            <pay_i:identificativoDominio>#id_broker#</pay_i:identificativoDominio>
    ...
    Scenario: Execute nodoInviaRPT request
        ...
        And check faultCode is PPT_CANALE_DISABILITATO of nodoInviaRPT response