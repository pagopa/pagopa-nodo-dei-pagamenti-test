Feature: process tests for nodoInviaRT[IRTSEM17]
    Background:
        Given systems up
    ...
    Scenario: Execute nodoInviaRT (Phase 3)
        ...
        And initial XML nodoInviaRT
            ...
            <identificativoCanale>91000000002_03</identificativoCanale>
            <password>pwdpwdpwd</password>
            ...
            And check faultCode is PPT_AUTORIZZAZIONE of nodoInviaRT response
