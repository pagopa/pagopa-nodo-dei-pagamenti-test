Feature: process tests for nodoInviaRT[IRPTSIN6]
    Background:
        Given systems up
    ...
    Scenario: Execute nodoInviaRPT request
        ...
        And initial XML nodoInviaRPT
            ...
            <soapenv:Header>
                <ppt:intestazionePPT>
                    <identificativoIntermediarioPA>ciaoIntermediarioPA</identificativoIntermediarioPA>
            ...
            And check faultCode is PPT_INTERMEDIARIO_SCONOSCIUTO of nodoInviaRPT response
