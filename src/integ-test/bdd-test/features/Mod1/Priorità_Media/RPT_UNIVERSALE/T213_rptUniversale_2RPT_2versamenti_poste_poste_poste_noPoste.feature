Feature: process tests for T213_rptUniversale_2RPT_2versamenti_poste_poste_poste_noPoste
    ...
    Scenario: Execute nodoInviaCarrelloRPT (Phase 1)
        ...
        Given RPT1 generation
            ...
            <pay_i:importoTotaleDaVersare>2.20</pay_i:importoTotaleDaVersare>
        ...
        And RPT2 generation
            ...
            <pay_i:importoTotaleDaVersare>2.20</pay_i:importoTotaleDaVersare>
            <pay_i:tipoVersamento>PO</pay_i:tipoVersamento>
            <pay_i:identificativoUnivocoVersamento>$1iuv+1</pay_i:identificativoUnivocoVersamento>
            <pay_i:codiceContestoPagamento>CCD01</pay_i:codiceContestoPagamento>
            <pay_i:ibanAddebito>IT96R0123454321000000012345</pay_i:ibanAddebito>
            <pay_i:bicAddebito>ARTIITM1045</pay_i:bicAddebito>
            <pay_i:firmaRicevuta>0</pay_i:firmaRicevuta>
        ...
        And initial XML nodoInviaCarrelloRPT
            ...
            <elementoListaRPT>
            <identificativoDominio>#creditor_institution_code#</identificativoDominio>
            <identificativoUnivocoVersamento>$1iuv+1</identificativoUnivocoVersamento>
            <codiceContestoPagamento>CCD01</codiceContestoPagamento>
    ...
    Scenario: execution nodoChiediListaPSP - altro
        ...
        Then verify the HTTP status code of listaPSP response is 500
