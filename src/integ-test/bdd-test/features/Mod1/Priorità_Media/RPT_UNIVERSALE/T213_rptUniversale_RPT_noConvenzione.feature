Feature: process tests for T213_rptUniversale_RPT_noConvenzione
    ...
    Scenario: Execute nodoInviaRPT request
        ...
        And execution query getPspCarte_mod_0_1 to get value on the table ELENCO_SERVIZI_PSP, with the columns COUNT(*) under macro Mod1 with db name nodo_offline
