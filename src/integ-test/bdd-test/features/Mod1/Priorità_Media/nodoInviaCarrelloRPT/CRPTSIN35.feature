Feature: process tests for nodoInviaCarrelloRPT[CRPTSIN35]
    Background:
        Given systems up
            ...
            <soapenv:Body>
                <ws:nodoInviaCarrelloRPT>
                    ...
                    <listaRPT>
                        ...
                        <identificativoUnivocoVersamento>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</identificativoUnivocoVersamento>
