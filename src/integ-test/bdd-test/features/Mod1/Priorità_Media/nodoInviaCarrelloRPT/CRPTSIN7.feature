Feature: process tests for nodoInviaCarrelloRPT[CRPTSIN7]
    Background:
        Given systems up
        ...
        And initial XML nodoInviaCarrelloRPT
            ...
            <soapenv:Header>
                <ppt:intestazioneCarrelloPPT>
                    <identificativoIntermediarioPA>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</identificativoIntermediarioPA>
