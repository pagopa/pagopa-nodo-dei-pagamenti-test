Feature: process tests for nodoInviaCarrelloRPT[CRPTSEM2]
    Background:
        Given systems up
    ...
    Scenario: Execute nodoInviaCarrelloRPT1 request
        ...
        And initial XML nodoInviaCarrelloRPT
            ...
            <soapenv:Header>
                <ppt:intestazioneCarrelloPPT>
                    <identificativoIntermediarioPA>00000000000</identificativoIntermediarioPA>
            ...
            And check faultCode is PPT_INTERMEDIARIO_PA_SCONOSCIUTO of nodoInviaCarrelloRPT response
