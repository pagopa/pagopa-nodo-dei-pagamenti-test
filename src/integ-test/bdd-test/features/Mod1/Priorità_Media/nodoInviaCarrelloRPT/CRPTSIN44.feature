Feature: process tests for nodoInviaCarrelloRPT[CRPTSIN44]
    Background:
        Given systems up
            ...
            <soapenv:Body>
                <ws:nodoInviaCarrelloRPT>
                    ...
                    <listaRPT>
                        ...
                        <rpt><?xml version="1.0" encoding="UTF-8"?>
<pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0_1.xsd ">
 <pay_i:versioneOggetto>6.0</pay_i:versioneOggetto>
	<pay_i:dominio>
		<pay_i:identificativoDominio>80184430587</pay_i:identificativoDominio>
		<pay_i:identificativoStazioneRichiedente>IDStazioneRichiedente</pay_i:identificativoStazioneRichiedente>
	</pay_i:dominio>
	...
	<pay_i:datiVersamento>
		...
		<pay_i:datiSingoloVersamento>
			...
			<!--<pay_i:datiMarcaBolloDigitale>
				<pay_i:tipoBollo></pay_i:tipoBollo>
				<pay_i:hashDocumento></pay_i:hashDocumento>
				<pay_i:provinciaResidenza></pay_i:provinciaResidenza>
            ...
            And check faultCode is soap:Client of nodoInviaCarrelloRPT response
