Feature: PAG-2212
    ...
    Scenario: pspInviaCarrelloRPTCarte irraggiungibile response
    ...
    Scenario: nodoInoltraEsitoCarta request
    ...
    Scenario: nodoInviaRT request
        Given RT generation
            ...
            <pay_i:dominio>
            <pay_i:identificativoDominio>$nodoInviaCarrelloRPT.identificativoDominio</pay_i:identificativoDominio>
            <pay_i:identificativoStazioneRichiedente>#id_station_old#</pay_i:identificativoStazioneRichiedente>
            </pay_i:dominio>
        ...
        And initial XML nodoInviaRT
            ...
            <identificativoDominio>$nodoInviaCarrelloRPT.identificativoDominio</identificativoDominio>
            <identificativoUnivocoVersamento>$iuv</identificativoUnivocoVersamento>
            <codiceContestoPagamento>$ccp</codiceContestoPagamento>
            <tipoFirma></tipoFirma>
    ...
    Scenario: RT generata nodo (part 1)
        ...
        And the pspInviaCarrelloRPTCarte irraggiungibile response scenario executed successfully
        And the nodoInoltraEsitoCarta request scenario executed successfully
    ...
    Scenario: RT generata nodo (part 2)
        ...
        And the nodoInviaRT request scenario executed successfully
        When EC sends SOAP nodoInviaRT to nodo-dei-pagamenti
        Then check esito is KO of nodoInviaRT response
        And check faultCode is PPT_RT_DUPLICATA of nodoInviaRT response
        And check faultString is La RT è già stata generata dal Nodo of nodoInviaRT response

    Scenario: RT generata psp (part 1)
        Given the nodoInviaCarrelloRPT scenario executed successfully
        And the nodoChiediInformazioniPagamento scenario executed successfully
        And the nodoInoltraEsitoCarta request scenario executed successfully
        Then verify the HTTP status code of inoltroEsito/carta response is 200
    ...
    Scenario: RT generata psp (part 2)
        Given the RT generata psp (part 1) scenario executed successfully
        And the nodoInviaRT request scenario executed successfully
        When EC sends SOAP nodoInviaRT to nodo-dei-pagamenti
    ...
    Scenario: RT generata psp (part 3)
        ...
        Then check esito is KO of nodoInviaRT response
        And check faultCode is PPT_RT_DUPLICATA of nodoInviaRT response
        And check faultString is La RT inviata dal PSP è già stata inviata (RT push). of nodoInviaRT response