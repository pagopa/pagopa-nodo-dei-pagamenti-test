Feature: T221_notificaAnnullamento_carrello_2RPT_UNKPSP
   ...
   Scenario: RPT generation
     ...
     Scenario: Execute nodoNotificaAnnullamento
        ...
        When WISP sends rest GET notificaAnnullamento?idPagamento=$sessionToken&motivoAnnullamento=UNKPSP to nodo-dei-pagamenti
    ...
    Scenario: Check DB
        ...
        And checks the value UNKPSP of the record at column MOTIVO_ANNULLAMENTO of the table PM_SESSION_DATA retrived by the query pm_session_old on db nodo_online under macro AppIO
        And checks the value Annullato per esito sconosciuto PSP of the record at column ESITO of the table RT retrived by the query esito_4iuv on db nodo_online under macro Mod1
