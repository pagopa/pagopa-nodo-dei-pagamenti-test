Feature: T124_ChiediListePSP_CC_conIbanAddebito 668
  Background:
    Given systems up
  ...
  Scenario: Execute nodoChiediInfoPag request
    ...
    And through the query getPspConto_no_poste_lingua retrieve param sizeCarte at position 0 and save it under the key sizeConto
