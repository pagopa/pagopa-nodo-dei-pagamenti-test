Feature: T221_notificaAnnullamento_carrello_2RPT_OTHER
   ...
   Scenario: RPT generation
     ...
     Scenario: Execute nodoNotificaAnnullamento
        ...
        When WISP sends rest GET notificaAnnullamento?idPagamento=$sessionToken&motivoAnnullamento=OTHER to nodo-dei-pagamenti
    ...
    Scenario: Check DB
        ...
        And checks the value Annullato da WISP of the record at column ESITO of the table RT retrived by the query esito_4iuv on db nodo_online under macro Mod1
