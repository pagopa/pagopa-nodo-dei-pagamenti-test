Feature: T221_notificaAnnullamento_carrello_2RPT_AUTNEG
   ...
   Scenario: RPT generation
    ...
    Scenario: Check DB
        ...
        And checks the value AUTNEG of the record at column MOTIVO_ANNULLAMENTO of the table PM_SESSION_DATA retrived by the query pm_session_old on db nodo_online under macro AppIO
        And checks the value Autorizzazione negata of the record at column ESITO of the table RT retrived by the query esito_4iuv on db nodo_online under macro Mod1
