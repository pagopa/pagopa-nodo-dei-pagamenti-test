Feature: T221_notificaAnnullamento_carrello_2RPT_ANNUTE 776
    Background:
        Given systems up
   ...
   Scenario: RPT generation
     ...
     Scenario: Execute nodoNotificaAnnullamento
        ...
        When WISP sends rest GET notificaAnnullamento?idPagamento=$sessionToken&motivoAnnullamento=ANNUTE to nodo-dei-pagamenti
    ...
    Scenario: Check DB
        ...
        And replace IUV2 content with avanzaErrResponse$1iuv content
        And replace pa content with #creditor_institution_code# content
        And replace ccp1 content with CCD01 content
        And replace ccp2 content with CCD02 content
        Then checks the value CARRELLO of the record at column TIPO of the table PM_SESSION_DATA retrived by the query pm_session_old on db nodo_online under macro AppIO
        And checks the value ANNUTE of the record at column MOTIVO_ANNULLAMENTO of the table PM_SESSION_DATA retrived by the query pm_session_old on db nodo_online under macro AppIO
        And checks the value Annullato da utente of the record at column ESITO of the table RT retrived by the query esito_4iuv on db nodo_online under macro Mod1
