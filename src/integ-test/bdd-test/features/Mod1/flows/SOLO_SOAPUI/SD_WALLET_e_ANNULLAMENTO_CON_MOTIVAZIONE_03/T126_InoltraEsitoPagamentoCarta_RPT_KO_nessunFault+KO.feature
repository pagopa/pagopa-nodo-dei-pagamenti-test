Feature: T126_InoltraEsitoPagamentoCarta_RPT_KO_nessunFault+KO 687
  Background:
    Given systems up
    ...
    <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/"
      ...
      <pay_i:datiVersamento>
        ...
        <pay_i:codiceContestoPagamento>16514801066631</pay_i:codiceContestoPagamento>
  ...
  Scenario: Execute nodoInviaRPT request
    ...
    <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
      ...
      <ppt:intestazionePPT>
        ...
        <codiceContestoPagamento>16514801066631</codiceContestoPagamento>
      </ppt:intestazionePPT>
      </soapenv:Header>
      <soapenv:Body>
      <ws:nodoInviaRPT>
