Feature: T221_NotificaAnnullamento_RPT_SESSCA 790
...
@runnable
    Scenario: Check DB
        ...
        Then checks the value Annullato per sessione scaduta of the record at column ESITO of the table RT retrived by the query esito on db nodo_online under macro Mod1
        And checks the value SESSCA of the record at column MOTIVO_ANNULLAMENTO of the table PM_SESSION_DATA retrived by the query motivo_annullamento on db nodo_online under macro Mod1
