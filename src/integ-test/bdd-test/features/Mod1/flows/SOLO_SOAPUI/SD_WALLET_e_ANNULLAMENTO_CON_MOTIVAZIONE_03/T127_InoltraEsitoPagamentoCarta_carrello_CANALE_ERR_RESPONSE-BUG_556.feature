Feature: T127_InoltraEsitoPagamentoCarta_carrello_CANALE_ERR_RESPONSE - BUG_556 695
  Background:
    Given systems up
    And generate 1 notice number and iuv with aux digit 0, segregation code NA and application code #cod_segr_old#
    And replace $1iuv content with esitoSconosciutoPsp content
    ...
    <pay_i:RT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/"
      ...
      <pay_i:datiPagamento>
        ...
        <pay_i:datiSingoloPagamento>
          ...
          <pay_i:identificativoUnivocoRiscossione>esitoSconosciutoPsp</pay_i:identificativoUnivocoRiscossione>
  ...
  Scenario: Execute nodoChiediStatoRPT2 request
  ...
  Scenario: Execute nodoInoltraEsitoPagamentoCarta3 request
    Given the Execute nodoChiediStatoRPT2 request scenario executed successfully
    And initial XML pspInviaCarrelloRPTCarte
    """
    <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
        <soapenv:Header/>
...
@runnable  
  Scenario: DB check
    ...
    And checks the value CART_ACCETTATO_PSP of the record at column STATO of the table STATI_CARRELLO_SNAPSHOT retrived by the query codice_convenzione_session on db nodo_online under macro Mod1
