   ...
   Scenario: RPT generation
    ...
    @midRunnable
     Scenario: Execute nodoNotificaAnnullamento
        ...
        Then verify the HTTP status code of notificaAnnullamento response is 422
        And check error is Motivo di annullamento invalido of notificaAnnullamento response
