Feature: T005_nodoInviaRT_esito=2
    ...
    Scenario: RPT generation
        ...
        And RT1 generation
            ...
            <datiPagamento>
            <codiceEsitoPagamento>2</codiceEsitoPagamento>
            <importoTotalePagato>1.00</importoTotalePagato>
            <identificativoUnivocoVersamento>$1IUV</identificativoUnivocoVersamento>
            <CodiceContestoPagamento>CCD01</CodiceContestoPagamento>
            <datiSingoloPagamento>
            <singoloImportoPagato>1.00</singoloImportoPagato>
            <esitoSingoloPagamento>PARTIAL</esitoSingoloPagamento>
