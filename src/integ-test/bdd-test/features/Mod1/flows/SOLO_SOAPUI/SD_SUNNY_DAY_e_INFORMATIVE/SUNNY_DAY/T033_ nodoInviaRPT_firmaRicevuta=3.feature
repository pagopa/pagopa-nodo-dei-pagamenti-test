Feature: T033_ nodoInviaRPT_firmaRicevuta=3 551
    ...
    Scenario: Execute nodoInviaRPT request
        ...
        And check description is Errore validazione XML [RPT/datiVersamento/firmaRicevuta] - cvc-enumeration-valid: il valore "3" non è valido come facet rispetto all'enumerazione "[0]". Deve essere un valore dell'enumerazione. of nodoInviaRPT response
