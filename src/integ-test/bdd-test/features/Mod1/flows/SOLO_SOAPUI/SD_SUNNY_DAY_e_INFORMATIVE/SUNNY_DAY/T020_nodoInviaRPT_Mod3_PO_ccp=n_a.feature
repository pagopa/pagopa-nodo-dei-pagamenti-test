Feature: T020_nodoInviaRPT_Mod3_PO_ccp=n_a 541
    ...
    Scenario: Execute nodoInviaRPT (Phase 1)
        ...
        Then check description is Il tipo di versamento indicato non ammette la valorizzazione del codiceContestoPagamento con valore n/a of nodoInviaRPT response
