Feature: monoRPT_ChiediAvanzamento_ERRORE_INVIO_A_PSP_Carrello_sbloccoParcheggio
    ...
    Scenario: Execution Esito Carta retry
        ...
        And checks the value RPT_ERRORE_INVIO_A_PSP of the record at column STATO of the table STATI_RPT_SNAPSHOT retrived by the query stati_RPT_noOrder on db nodo_online under macro Mod1
