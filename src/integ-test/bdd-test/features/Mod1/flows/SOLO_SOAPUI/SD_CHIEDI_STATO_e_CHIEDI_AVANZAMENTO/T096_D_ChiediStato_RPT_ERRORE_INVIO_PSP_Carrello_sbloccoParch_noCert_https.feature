Feature: T096_D_ChiediStato_RPT_ERRORE_INVIO_PSP_Carrello_sbloccoParcheggio_mancatoCertificato_https
    ...
    Scenario: RPT generation
        ...
        And generate 3 cart with PA #creditor_institution_code# and notice number $1noticeNumber
        And RPT generation
            """
        ...
        And RPT3 generation            
            """
                ...
                <pay_i:tipoVersamento>BBT</pay_i:tipoVersamento>
                <pay_i:identificativoUnivocoVersamento>$1iuv</pay_i:identificativoUnivocoVersamento>
                <pay_i:codiceContestoPagamento>$3carrello</pay_i:codiceContestoPagamento>
                <pay_i:ibanAddebito>IT45R0760103200000000001016</pay_i:ibanAddebito> 
                <pay_i:bicAddebito>ARTIITM1045</pay_i:bicAddebito>
                <pay_i:firmaRicevuta>0</pay_i:firmaRicevuta>
                <pay_i:datiSingoloVersamento>
    ...
    Scenario: execution nodoInoltraPagamentoMod1
        ...
        When WISP sends rest POST inoltroEsito/mod1 to nodo-dei-pagamenti
         """
         {
            ...
            "identificativoPsp": "10000000001",
            "tipoVersamento": "BBT",
            "identificativoIntermediario": "10000000001",
            "identificativoCanale": "TotHttps",
            "tipoOperazione": "web"
         }
         """
    ...
    Scenario: Execute nodoChiediStatoRPT
        ...
        Then checks stato contains RPT_INVIATA_A_PSP of nodoChiediStatoRPT response
    ...
    Scenario: nodoInviaCarrelloRPT duplicato1
        ...
        And initial XML nodoInviaCarrelloRPT
            ...
            <identificativoDominio>#creditor_institution_code_secondary#</identificativoDominio>
            <identificativoUnivocoVersamento>$1iuv</identificativoUnivocoVersamento>
            <codiceContestoPagamento>$3carrello</codiceContestoPagamento>
