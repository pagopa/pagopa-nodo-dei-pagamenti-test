Feature: T101_A_chiediStato_RT_ACCETTATA_PA_Carrello
    ...
    Scenario: execution nodoInviaRT2
        ...
        And checks the value RT_RICEVUTA_NODO,RT_ACCETTATA_NODO,RT_INVIATA_PA,RT_ACCETTATA_PA of the record at column STATUS of the table RE retrived by the query Re on db re under macro Mod1
        And checks the value RT_RICEVUTA_NODO,RT_ACCETTATA_NODO,RT_INVIATA_PA,RT_ACCETTATA_PA of the record at column STATUS of the table RE retrived by the query Re_2 on db re under macro Mod1