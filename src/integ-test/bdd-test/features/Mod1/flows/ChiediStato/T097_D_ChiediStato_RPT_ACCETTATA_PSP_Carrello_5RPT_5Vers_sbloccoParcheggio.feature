Feature: process tests for 5 RPT 5 Versamenti 306
    ...
    Scenario: RPT generation
        ...
        And RPT5 generation
            ...
            <pay_i:importoTotaleDaVersare>7.50</pay_i:importoTotaleDaVersare>
            <pay_i:tipoVersamento>BBT</pay_i:tipoVersamento>
            <pay_i:identificativoUnivocoVersamento>#IUV5#</pay_i:identificativoUnivocoVersamento>
            <pay_i:codiceContestoPagamento>CCD01</pay_i:codiceContestoPagamento>
            <pay_i:ibanAddebito>IT45R0760103200000000001016</pay_i:ibanAddebito>
            <pay_i:bicAddebito>ARTIITM1045</pay_i:bicAddebito>
            <pay_i:firmaRicevuta>0</pay_i:firmaRicevuta>
    ...
    Scenario: Execute fifth nodoChiediStatoRPT request
        ...
        And verify 5 record for the table STATI_RPT retrived by the query stati_RPT on db nodo_online under macro Mod1
        And verify 5 record for the table STATI_RPT retrived by the query stati_RPT_new on db nodo_online under macro Mod1
        ...
        And checks the value nodoInviaCarrelloRPT,nodoInviaCarrelloRPT,nodoInviaCarrelloRPT,pspInviaCarrelloRPT,pspInviaCarrelloRPT of the record at column INSERTED_BY of the table STATI_RPT retrived by the query stati_RPT on db nodo_online under macro Mod1
        And checks the value RPT_RICEVUTA_NODO,RPT_ACCETTATA_NODO,RPT_PARCHEGGIATA_NODO,RPT_INVIATA_A_PSP,RPT_ACCETTATA_PSP of the record at column STATO of the table STATI_RPT retrived by the query stati_RPT on db nodo_online under macro Mod1
