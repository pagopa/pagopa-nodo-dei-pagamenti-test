Feature: process tests for nodoInviaRT[IRPTSEM]
    Background:
        Given systems up
    ...
    Scenario Outline: (phase 1) Execute nodoInviaRPT request
        ...
        Examples:
            ...
            | identificativoIntermediarioPA         | pippo                           | PPT_INTERMEDIARIO_PA_SCONOSCIUTO   | IRPTSEM1    |
    ...
    Scenario: second RPT generation
    ...
    @runnable @prova
    Scenario Outline: Execute second nodoInviaRPT request
        Given the second RPT generation scenario executed successfully
        And <elem> with <value> in RPT
        And RPT generation
            """
            $RPT
            """
        And initial XML nodoInviaRPT
            ...
            """
        And <tag> with <value> in nodoInviaRPT
        When PSP sends SOAP nodoInviaRPT to nodo-dei-pagamenti
        Then check esito is KO of nodoInviaRPT response
        Then check faultCode is <error> of nodoInviaRPT response
        Examples:
            | elem                        | tag                   | value       | error                    | soapUI test |
            | pay_i:identificativoDominio | identificativoDominio | sconosciuto | PPT_DOMINIO_SCONOSCIUTO  | IRPTSEM5    |
            | pay_i:identificativoDominio | identificativoDominio | NOT_ENABLED | PPT_DOMINIO_DISABILITATO | IRPTSEM6    |
    ...
    #IRPTSEM22_noMock
    Scenario: (phase 4) RPT generation
        Given generate 1 notice number and iuv with aux digit 0, segregation code NA and application code 02
        And RPT1 generation
            """
            <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0_1.xsd ">
    ...
    Scenario: (phase 4) Execute nodoInviaRPT1 request
        Given the (phase 4) RPT generation scenario executed successfully
        And initial XML nodoInviaRPT
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header>
    ...
    Scenario: (phase 5) Execute nodoInviaRPT1 request
        Given the (phase 5) RPT generation scenario executed successfully
        And initial XML nodoInviaRPT
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header>
    ...
    Scenario: (phase 5) Execute nodoInviaRPT2 request
        Given the (phase 5) Execute nodoInviaRPT1 request scenario executed successfully
        And initial XML nodoInviaRPT
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header>
    ...
    Scenario: (phase 5) Execute nodoInviaRT request
        Given the (phase 5) Execute nodoInviaRPT2 request scenario executed successfully
