Feature: flow tests for T213_rptUniversale_carrello_noConvenzione_fasciaNessunaConv
    ...
    Scenario: RPT generation
        Given RPT generation
            ...
            <pay_i:importoTotaleDaVersare>28.40</pay_i:importoTotaleDaVersare>
            ...
            <pay_i:importoSingoloVersamento>14.20</pay_i:importoSingoloVersamento>
    ...
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        And replace importoTot content with 28.40 content
        And execution query getPspCarte_no_poste to get value on the table ELENCO_SERVIZI_PSP, with the columns COUNT(*) under macro Mod1 with db name nodo_offline
        And through the query getPspCarte_no_poste retrieve param sizeCarte at position 0 and save it under the key sizeCarte
        And execution query getPspCarte_no_poste to get value on the table ELENCO_SERVIZI_PSP, with the columns ID under macro Mod1 with db name nodo_offline
