Feature: flows tests for T213_rptUniversale_CarrelloRPT - 5 RPT 2 versamenti_Poste_accredito
    ...
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        And execution query getPspAltro_no_poste_lingua_2 to get value on the table ELENCO_SERVIZI_PSP, with the columns COUNT(*) under macro Mod1 with db name nodo_offline
        And through the query getPspAltro_no_poste_lingua_2 retrieve param sizeConto at position 0 and save it under the key sizeAltro
