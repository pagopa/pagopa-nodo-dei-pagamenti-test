Feature: process tests for RPT-RT bollo
   ...
   Scenario: MB generation
      Given MB generation
            ...
            <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
               ...
               <ImprontaDocumento>
                  ...
                  <ns2:DigestValue>' + hash + '</ns2:DigestValue>
               </ImprontaDocumento>
    ...
    Scenario: RPT generation
        ...
        <pay_i:dominio>
        <pay_i:identificativoDominio>'+context.expand('${pa}')+'</pay_i:identificativoDominio>
   ...
   Scenario: RT generation 
      Given RT generation
         ...
         <pay_i:datiPagamento>
            ...
            <pay_i:identificativoUnivocoVersamento>TR0001_20120302-10:37:52.0264-F098</pay_i:identificativoUnivocoVersamento>
            <pay_i:CodiceContestoPagamento>CCD01</pay_i:CodiceContestoPagamento>
            <pay_i:datiSingoloPagamento>
               ...
               <pay_i:identificativoUnivocoRiscossione>idRiscossione</pay_i:identificativoUnivocoRiscossione>
               <pay_i:causaleVersamento>pagamento fotocopie pratica</pay_i:causaleVersamento>
               <pay_i:datiSpecificiRiscossione>1/abc</pay_i:datiSpecificiRiscossione>
