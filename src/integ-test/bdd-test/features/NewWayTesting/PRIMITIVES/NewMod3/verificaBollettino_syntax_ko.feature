Feature: Syntax checks for verificaBollettino - KO 1398
   ...
   Scenario Outline: Check PPT_SINTASSI_EXTRAXSD error on invalid wsdl namespace
      Given from body with datatable horizontal verificaBollettino initial XML verificaBollettino
         ...
         | POSTE3 | BANCOPOSTA  | POSTE3    | #password# | 777777777777 | 302#iuv#     |
      And <attribute> set <value> for <elem> in verificaBollettino
   ...
   @ALL @PRIMITIVE @NM3 @NM3VBLSNTKO @NM3VBLSNTKO_2
   # element value check
