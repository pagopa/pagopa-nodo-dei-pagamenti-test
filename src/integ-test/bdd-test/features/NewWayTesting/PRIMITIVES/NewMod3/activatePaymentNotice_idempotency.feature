Feature: NM3 primitives activatePaymentNotice with idempotency
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_7
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_8
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_9
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_10
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_11
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_12
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_13
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_14
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_15
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_16
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_17
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_28
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_29
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_30
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_31
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_33
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_34
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_35
    ...
    @ALL @PRIMITIVE @NM3 @NM3ACTIVIDMP_37 @after
    Scenario: NM3 flow OK, FLOW: activatePaymentNotice  (OLD_NM3-37B)
        Given update parameter useIdempotency on configuration keys with value true
        And update parameter default_idempotency_key_validity_minutes on configuration keys with value 10
        And waiting after triggered refresh job ALL
        And from body with datatable horizontal activatePaymentNoticeBody_with_expiration_full initial XML activatePaymentNotice
            | idPSP | idBrokerPSP     | idChannel                    | password   | fiscalCode                  | noticeNumber | amount | expirationTime |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  | 1000           |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
            | outcome                     | OK                                |
            | creditorReferenceId         | 02$iuv                            |
            | paymentAmount               | 10.00                             |
        ...
        Given from body with datatable horizontal activatePaymentNoticeBody_with_idempotency_full initial XML activatePaymentNotice
            | idPSP | idBrokerPSP     | idChannel                    | password   | idempotencyKey                        | fiscalCode                  | noticeNumber | expirationTime | amount |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | $activatePaymentNotice.idempotencyKey | #creditor_institution_code# | 302$iuv      | 1000           | 10.00  |
        When psp sends SOAP activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is KO of activatePaymentNotice response
        And check faultCode is PPT_PAGAMENTO_IN_CORSO of activatePaymentNotice response
        # IDEMPOTENCY_CACHE
