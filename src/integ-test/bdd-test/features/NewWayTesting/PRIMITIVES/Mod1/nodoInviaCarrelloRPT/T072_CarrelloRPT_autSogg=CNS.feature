Feature: T072_CarrelloRPT_autSogg=CNS 596
    ...
    @ALL @PRIMITIVE @MOD1 @MOD1INCARPTOK @MOD1INCARPTOK_18
    Scenario: CarrelloRPT_autSogg=CNS
        ...
        And RPT2 generation RPT_generation_complete with datatable vertical
            ...
            | dataEsecuzionePagamento           | #date#                      |
            | importoTotaleDaVersare            | 10.00                       |
            | identificativoUnivocoVersamento   | avanzaErrResponse$1iuv      |
        ...
        And from body with datatable vertical nodoInviaCarrelloRPT_2elemLista initial XML nodoInviaCarrelloRPT
            ...
            | identificativoUnivocoVersamento2      | avanzaErrResponse$1iuv      |
