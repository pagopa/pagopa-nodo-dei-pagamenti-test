Feature: T078_CarrelloRPT_soggVers_soggPag_G 601
    ...
    @ALL @PRIMITIVE @MOD1 @MOD1INCARPTOK @MOD1INCARPTOK_23
    Scenario: CarrelloRPT_soggVers_soggPag_G
        Given RPT1 generation RPT_generation_complete_soggPag with datatable vertical
