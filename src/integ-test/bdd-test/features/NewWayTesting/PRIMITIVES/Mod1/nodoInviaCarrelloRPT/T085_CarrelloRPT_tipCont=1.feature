Feature: T085_CarrelloRPT_tipCont=1 605
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MOD1INCARPTOK @MOD1INCARPTOK_25
    Scenario: CarrelloRPT_tipCont=1
        ...
        And pay_i:datiSpecificiRiscossione with 1/abc in rpt1AttachmentBody
