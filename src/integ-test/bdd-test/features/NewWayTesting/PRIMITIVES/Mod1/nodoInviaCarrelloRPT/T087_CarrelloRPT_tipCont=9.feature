Feature: T087_CarrelloRPT_tipCont=9 607
    Background:
        Given systems up
    ...
    @ALL @PRIMITIVE @MOD1 @MOD1INCARPTOK @MOD1INCARPTOK_27
    Scenario: CarrelloRPT_tipCont=9
        ...
        And pay_i:datiSpecificiRiscossione with 9/abc in rpt1AttachmentBody
