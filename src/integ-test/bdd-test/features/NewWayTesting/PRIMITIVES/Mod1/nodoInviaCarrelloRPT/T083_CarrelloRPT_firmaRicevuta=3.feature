Feature: T083_CarrelloRPT_firmaRicevuta=3 603
    ...
    @ALL @PRIMITIVE @MOD1 @MOD1INCARPTKO @MOD1INCARPTKO_6
    Scenario: CarrelloRPT_firmaRicevuta=3
        ...
        And check description is Errore validazione XML [RPT/datiVersamento/firmaRicevuta] - cvc-enumeration-valid: il valore "3" non è valido come facet rispetto all'enumerazione "[0]". Deve essere un valore dell'enumerazione. of nodoInviaCarrelloRPT response
