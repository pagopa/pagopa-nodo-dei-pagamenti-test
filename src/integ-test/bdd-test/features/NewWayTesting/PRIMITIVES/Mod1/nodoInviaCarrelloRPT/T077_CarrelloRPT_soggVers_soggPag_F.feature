Feature: T077_CarrelloRPT_soggVers_soggPag_F 600
    ...
    @ALL @PRIMITIVE @MOD1 @MOD1INCARPTOK @MOD1INCARPTOK_22
    Scenario: CCarrelloRPT_soggVers_soggPag_F
        ...
        And RPT2 body generation RPT_generation_complete with datatable vertical
            ...
            | ibanAppoggio                      | IT96R0123454321000000012345 |
            | importoSingoloVersamento          | 10.00                       |
        And pay_i:tipoIdentificativoUnivoco with G in rpt2AttachmentBody
