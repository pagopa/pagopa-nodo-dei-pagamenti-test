Feature: Semantic checks KO for nodoChiediCatalogoServizi 234
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MOD1SINCCSKO @MOD1SINCCSKO_9
    Scenario Outline: Check SIN_NCCS_09
        ...
        Examples:
            ...
            | identificativoIntermediarioPSP | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | SIN_NCCS_09 |