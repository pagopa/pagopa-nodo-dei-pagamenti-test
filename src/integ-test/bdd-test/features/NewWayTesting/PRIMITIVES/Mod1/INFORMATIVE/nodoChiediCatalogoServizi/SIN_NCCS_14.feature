Feature: Semantic checks KO for nodoChiediCatalogoServizi 239
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MOD1SINCCSKO @MOD1SINCCSKO_14
    Scenario Outline: Check SIN_NCCS_14
