Feature: Semantic checks KO for nodoChiediCatalogoServizi 240
    Background:
        Given systems up

    @ALL @FLOW @FLOW_FULL @NM1 @NM1INSINCCS @NM1INSINCCS_15
    Scenario Outline: Check SIN_NCCS_15
