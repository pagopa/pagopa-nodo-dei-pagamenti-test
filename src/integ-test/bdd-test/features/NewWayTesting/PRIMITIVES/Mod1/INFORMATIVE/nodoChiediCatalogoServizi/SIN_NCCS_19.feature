Feature: Semantic checks KO for nodoChiediCatalogoServizi 244
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MOD1SINCCSKO @MOD1SINCCSKO_19
    Scenario Outline: Check SIN_NCCS_19
        ...
        Examples:
            ...
            | identificativoDominio | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | SIN_NCCS_19 |