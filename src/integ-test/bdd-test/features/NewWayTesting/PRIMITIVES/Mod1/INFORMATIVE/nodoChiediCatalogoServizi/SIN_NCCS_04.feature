Feature: Semantic checks KO for nodoChiediCatalogoServizi 229
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MOD1SINCCSKO @MOD1SINCCSKO_4
    Scenario Outline: Check SIN_NCCS_04
        ...
        Examples:
            ...
            | identificativoPSP | None  | SIN_NCCS_04 |