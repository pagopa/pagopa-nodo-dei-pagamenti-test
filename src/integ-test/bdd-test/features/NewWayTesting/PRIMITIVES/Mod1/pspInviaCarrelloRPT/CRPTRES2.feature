Feature: process tests for pspInviaCarrelloRPT[CRPTRES2] 341
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MODCRPTRESKO @MODCRPTRESKO_2
    Scenario: tests for pspInviaCarrelloRPT
        ...
        And from body with datatable vertical pspInviaCarrelloRPT_malformed_respKO initial XML pspInviaCarrelloRPT
