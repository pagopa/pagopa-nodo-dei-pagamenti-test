Feature: process tests for pspInviaCarrelloRPT 344
    ...
    Scenario: Execute nodoInviaCarrelloRPT request [CRPTRES23]
        ...
        And from body with datatable vertical nodoInviaCarrelloRPT initial XML nodoInviaCarrelloRPT
            ...
            | codiceContestoPagamento               | CCD01                       |
            | rpt                                   | $rpt1Attachment             |
        And from body with datatable vertical pspInviaCarrelloRPT_resp_2EmptyFault initial XML pspInviaCarrelloRPT
    ...
    Scenario: Execute nodoInviaCarrelloRPT request [CRPTRES24]
        ...
        And from body with datatable vertical nodoInviaCarrelloRPT initial XML nodoInviaCarrelloRPT
            ...
            | codiceContestoPagamento               | CCD01                       |
            | rpt                                   | $rpt1Attachment             |
        And from body with datatable vertical pspInviaCarrelloRPT_resp_2NoneFault initial XML pspInviaCarrelloRPT
            | esitoComplessivoOperazione | KO                      |
            | identificativoCarrello     | $1iuv                   |
            | id                         | IDPSPFNZ                |
            | faultCode                  | CANALE_BUSTA_ERRATA     |
    ...
    Scenario: Execute nodoInviaCarrelloRPT request [CRPTRES25]
        ...
        And from body with datatable vertical nodoInviaCarrelloRPT initial XML nodoInviaCarrelloRPT
            ...
            | codiceContestoPagamento               | CCD01                       |
            | rpt                                   | $rpt1Attachment             |
        And from body with datatable vertical pspInviaCarrelloRPT_resp_2NoneFaultCode initial XML pspInviaCarrelloRPT
            | esitoComplessivoOperazione | KO                      |
            | identificativoCarrello     | $1iuv                   |
            | id                         | IDPSPFNZ                |
            | faultCode                  | CANALE_BUSTA_ERRATA     |
    ...
    Scenario: Execute nodoInviaCarrelloRPT request [CRPTRES27]
        ...
        And from body with datatable vertical nodoInviaCarrelloRPT initial XML nodoInviaCarrelloRPT
            ...
            | codiceContestoPagamento               | CCD01                       |
            | rpt                                   | $rpt1Attachment             |
        And from body with datatable vertical pspInviaCarrelloRPT_resp_2NoneFaultString initial XML pspInviaCarrelloRPT
            | esitoComplessivoOperazione | KO                      |
            | identificativoCarrello     | $1iuv                   |
            | id                         | IDPSPFNZ                |
            | faultCode                  | CANALE_BUSTA_ERRATA     |
