Feature: process tests for pspInviaCarrelloRPT[CRPTRES7] 342
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MODCRPTRESKO @MODCRPTRESKO_3
    Scenario: tests for pspInviaCarrelloRPT
        ...
        And from body with datatable vertical pspInviaCarrelloRPT_malformed_faultResponse initial XML pspInviaCarrelloRPT
