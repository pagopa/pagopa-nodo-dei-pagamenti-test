Feature: T003_nodoInviaRT_esito=0_causaleRPT_140caratteri_accenti 513
    ...
    @ALL @PRIMITIVE @MOD1 @MOD1NIRTOK @MOD1NIRTOK_2
    Scenario Outline: nodoInviaRT_esito=0_causaleRPT_140caratteri_accenti
        ...
        Examples:
            | elem                    | value                                                                                                                                        |
            | pay_i:causaleVersamento | /RFS/RF29 0001 1000 0006 480/37.10/TXT/Ticket Sanità Azienda Sanitaria Universitaria Integrata di Udine - n.pagamento=0190000002759992000001 |