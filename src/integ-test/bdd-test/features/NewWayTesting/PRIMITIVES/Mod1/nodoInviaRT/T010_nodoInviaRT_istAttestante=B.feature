Feature: T010_nodoInviaRT_istAttestante=B 525
    Background:
        Given systems up

    @ALL @PRIMITIVE @MOD1 @MOD1NIRTOK @MOD1NIRTOK_14
    Scenario Outline: nodoInviaRT_istAttestante=B
