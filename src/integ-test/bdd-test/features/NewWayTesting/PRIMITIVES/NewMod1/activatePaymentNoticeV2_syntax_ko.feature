Feature: syntax checks KO for activatePaymentNoticeV2Request 958
    ...
    Scenario Outline: Check PPT_SINTASSI_EXTRAXSD error on invalid wsdl namespace
        ...
        And <attribute> set <value> for <elem> in activatePaymentNoticeV2
    ...
    Scenario Outline: Check PPT_SINTASSI_EXTRAXSD error on invalid body element value
        ...
        Examples:
            ...
            | paymentMethod                      | Empty                                                                                                                                                                                                                           | #commissioni evolute 1 |
            | paymentMethod                      | PIPPO                                                                                                                                                                                                                           | #commissioni evolute 2 |
            | paymentMethod                      | po                                                                                                                                                                                                                              | #commissioni evolute 3 |
            | paymentMethod                      | POPOP                                                                                                                                                                                                                           | #commissioni evolute 4 |
            | touchPoint                         | Empty                                                                                                                                                                                                                           | #commissioni evolute 5 |
            | touchPoint                         | PIPPO                                                                                                                                                                                                                           | #commissioni evolute 6 |
            | touchPoint                         | psp                                                                                                                                                                                                                             | #commissioni evolute 7 |
            | touchPoint                         | PSPPSPPSPPS                                                                                                                                                                                                                     | #commissioni evolute 8 |