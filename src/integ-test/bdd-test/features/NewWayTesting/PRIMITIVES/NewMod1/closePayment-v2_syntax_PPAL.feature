Feature: syntax checks for closePaymentV2 - PAYPAL 966
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_1
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_2
    Scenario: check closePaymentV2 PAG-2555 KO totalAmount None
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_without_totalamount initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_3
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_4
    Scenario: check closePaymentV2 PAG-2555 KO totalAmount Empty
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_totalamount_null initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_5
    Scenario: check closePaymentV2 PAG-2555 KO fee None
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_without_fee initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_6
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_7
    Scenario: check closePaymentV2 PAG-2555 KO fee Empty
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_fee_null initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_8
    Scenario: check closePaymentV2 PAG-2555 KO timestampOperation None
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_without_time_oper initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_9
    Scenario: check closePaymentV2 PAG-2555 KO timestampOperation Empty
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_time_oper_null initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_10
    Scenario: check closePaymentV2 PAG-2555 KO transactionId None
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_without_transaction_id initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
    ...
    @ALL @PRIMITIVE @NMU @NMU_CLOSE_SYN_PPAL @NMU_CLOSE_SYN_PPAL_11
    Scenario: check closePaymentV2 PAG-2555 KO pspTransactionId None
        ...
        When psp sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given from body with datatable vertical closePaymentV2Body_PPAL_without_psptrans initial json v2/closepayment
            | token1                | $activatePaymentNoticeV2Response.paymentToken |
            | outcome               | OK                                            |
            | idPSP                 | #psp#                                         |
            | idBrokerPSP           | #psp#                                         |
