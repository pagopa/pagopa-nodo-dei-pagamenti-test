Feature: Syntax checks for SEMANTIC RPT 1578
  ...
  @ALL @PRIMITIVE @VALRPTSEMKO @VALRPTSEMKO_1
  # [RPTSEM7]
  ...
  @ALL @PRIMITIVE @VALRPTSEMKO @VALRPTSEMKO__2
  # [RPTSEM18]
  # pay_i:ibanAccredito with None in RPT
  Scenario: Check faultCode PPT_SEMANTICA error on invalid RPT tag [RPTSEM18]
    Given RPT generation RPT_generation_invalid_ibanAccredito with datatable vertical
      | identificativoDominio             | #creditor_institution_code_old# |
      | identificativoStazioneRichiedente | #id_station#                    |
      | dataOraMessaggioRichiesta         | #timedate#                      |
      | dataEsecuzionePagamento           | #date#                          |
  ...
  @ALL @PRIMITIVE @VALRPTSEMKO @VALRPTSEMKO_3
  # [RPTSEM9]
  # pay_i:ibanAddebito with None in RPT
  # pay_i:tipoVersamento with AD in RPT
  Scenario: Check faultCode PPT_AUTORIZZAZIONE error on invalid RPT tag [RPTSEM9]
    Given RPT generation RPT_generation_invalid_ibanAddebito with datatable vertical
      | identificativoDominio             | #creditor_institution_code_old# |
      | identificativoStazioneRichiedente | #id_station#                    |
      | dataOraMessaggioRichiesta         | #timedate#                      |
      | dataEsecuzionePagamento           | #date#                          |
      ...
      | indirizzoPagatore                 | via del gesu                    |
      | civicoPagatore                    | 11                              |
    #And pay_i:ibanAccredito with None in RPT
    And from body with datatable horizontal pspInviaRPT initial XML pspInviaRPT
      | esitoComplessivoOperazione | identificativoCarrello | parametriPagamentoImmediato |
      | OK                         | #iuv#                  | #iuv#                       |
    And PSP replies to nodo-dei-pagamenti with the pspInviaRPT
  ...
  @ALL @PRIMITIVE @VALRPTSEMKO @VALRPTSEMKO_4
  # [RPTSEM16]
  # pay_i:ibanAccredito with IT96R0123454321000000012345ZZ in RPT
  Scenario: Check faultCode PPT_AUTORIZZAZIONE error on invalid RPT tag [RPTSEM16]
    Given RPT generation RPT_generation_full with datatable vertical
      | identificativoDominio             | #creditor_institution_code_old# |
      | identificativoStazioneRichiedente | #id_station#                    |
      | dataOraMessaggioRichiesta         | #timedate#                      |
      ...
      | codiceContestoPagamento           | CCD01                           |
      | tipoVersamento                    | PO                              |
      | ibanAccredito                     | IT96R0123454321000000012345ZZ   |
      | ibanAddebito                      | IT96R0123454321000000012345     |
      | ibanAppoggio                      | IT96R0123454321000000012345     |
      | importoSingoloVersamento          | 1.01                            |
      | anagraficaPagatore                | Gesualdo;Riccitelli             |
  ...
  # OK
  @ALL @PRIMITIVE @VALRPTSEMKO @VALRPTSEMKO_5
  # [RPTSEM17]
  Scenario: Check faultCode PPT_SEMANTICA error on invalid RPT tag [RPTSEM17]
  ...
  # OK
  @ALL @PRIMITIVE @VALRPTSEMKO @VALRPTSEMKO_6
  # [RPTSEM12]
  Scenario: 2 datiSingoloVersamento + tipoVersamento = PO [RPTSEM12]
