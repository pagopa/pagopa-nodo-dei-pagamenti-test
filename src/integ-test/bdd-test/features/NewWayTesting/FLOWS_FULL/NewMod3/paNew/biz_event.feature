Feature: NM3 flows PA New con pagamento OK  event
  ...
  Background:
    ...
    Scenario: NM3 flow OK, FLOW con PSP activate vp2 PSP spo vp1: verify -> paVerify activateV2 -> paGetPayment spo+ -> paSendRT BIZ+ (si touchpoint e si paymentchannel)(NM3-66)
        Given from body with datatable horizontal verifyPaymentNoticeBody_noOptional initial XML verifyPaymentNotice
        | idPSP | idBrokerPSP | idChannel                    | password   | fiscalCode                  | noticeNumber |
        | #psp# | #psp#       | #canale_ATTIVATO_PRESSO_PSP# | #password# | #creditor_institution_code# | 302#iuv#     |
        And from body with datatable vertical paVerifyPaymentNoticeBody_full initial XML paVerifyPaymentNotice
    ...
    Scenario: NM3 flow OK, FLOW: verify -> paVerify activateV2 -> paGetPayment --> spoV2+ -> paSendRT BIZ+ (si touchpoint si paymentchannel)(NM3-9)
        Given from body with datatable horizontal verifyPaymentNoticeBody_noOptional initial XML verifyPaymentNotice
        | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber |
        | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     |
        And from body with datatable vertical paVerifyPaymentNoticeBody_full initial XML paVerifyPaymentNotice
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_1
    Scenario: NM3 flow KO, FLOW: activate -> paGetPayment, spo-, BIZ- (si touchpoint si paymentchannel)(NM3-3)
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_2
    Scenario: NM3 flow KO, FLOW: activate -> paGetPayment, spo-, BIZ- (si touchpoint no paymentchannel)(NM3-3)
        Given from body with datatable horizontal activatePaymentNoticeBody_full initial XML activatePaymentNotice
            | idPSP | idBrokerPSP     | idChannel                    | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_3
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spoV2-, BIZ- (no touchpoint e si paymentchannel)(NM3-11)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full_noTouchpoint initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_4
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spoV2-, BIZ- (si touchpoint e si paymentchannel)(NM3-11)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_5
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spoV2-, BIZ- (si touchpoint e no paymentchannel)(NM3-11)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_6
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spoV2-, BIZ- (no touchpoint e no paymentchannel)(NM3-11)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full_noTouchpoint initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_7
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spo-, BIZ-  (si touchpoint e si paymentchannel)(NM3-68)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_8
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spo-, BIZ- (no touchpoint e si paymentchannel)(NM3-68)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full_noTouchpoint initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_9
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spo-, BIZ- (si touchpoint e no paymentchannel)(NM3-68)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @FLOW @FLOW_FULL @NM3 @NM3PANEW @NM3PANEWPAGKOBIZ @NM3PANEWPAGKOBIZ_FULL_10
    Scenario: NM3 flow KO, FLOW: activateV2 -> paGetPayment, spo-, BIZ-  (no touchpoint e no paymentchannel)(NM3-68)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full_noTouchpoint initial XML activatePaymentNoticeV2
            | idPSP | idBrokerPSP         | idChannel  | password   | fiscalCode                  | noticeNumber | amount |
            | #psp# | #intermediarioPSP2# | #canale32# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
