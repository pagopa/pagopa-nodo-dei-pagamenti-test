...
Background:
 Given systems up
  ...
  @ALL @FLOW @FLOW_FULL @NM3 @NM3PAOLD @POSTEPAY @POSTEPAYNEW @POSTEPAY_TOGGLE_05
      Scenario: NM3 flow OK, FLOW con PA Old e PSP vp1: activate -> paaAttivaRPT  spo+  nodoInviaRPT -> paaInviaRT+ (subito, senza job paInviaRT) BIZ+ (NM3-2)
          Given update for table CONFIGURATION_KEYS with parameter CONFIG_VALUE = 'POSTE1' on db nodo_cfg with where datatable horizontal
          ...
          Given from body with datatable horizontal activatePaymentNoticeBody_full initial XML activatePaymentNotice
              ...
              | #pspPoste# | #brokerPspPoste# | #channelPoste# | #password# | #creditor_institution_code# | 305$iuv      | 10.00  |
