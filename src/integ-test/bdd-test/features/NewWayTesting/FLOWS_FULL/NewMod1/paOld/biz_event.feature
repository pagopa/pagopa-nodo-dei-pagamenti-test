Feature: NMU flows PA Old con pagamento OK
  ...
  Background:
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPAOLD @NMUPAOLDPAGOKBIZ @NMUPAOLDPAGOKBIZ_FULL_1
    Scenario: NMU flow OK, FLOW con PA Old e PSP vp1: checkPosition con 1 nav, activateV2 -> paaAttivaRPT, nodoInviaRPT , closeV2+ -> pspNotifyPayment con additionalPaymentInformations, spo+ -> paInviaRT+, BIZ+ e SPRv2+ (si touchpoint e si paymentchannel)(NMU-8)
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPAOLD @NMUPAOLDPAGOKBIZ @NMUPAOLDPAGOKBIZ_FULL_2
    Scenario: NMU flow OK, FLOW con PA Old e PSP vp1 notify PSP vp2 spo: checkPosition con 1 nav, activateV2 -> paaAttivaRPT, nodoInviaRPT, closeV2+ -> pspNotifyPayment con additionalPaymentInformations, spoV2+ -> paInviaRT+, BIZ+ e SPRv2+ (si touchpoint e si paymentchannel)(NMU-12)
        Given from body with datatable horizontal checkPositionBody initial JSON checkPosition
        | fiscalCode                  | noticeNumber |
        | #creditor_institution_code# | 305#iuv#     |
        When WISP sends rest POST checkPosition_json to nodo-dei-pagamenti
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPAOLD @NMUPAOLDPAGOKBIZ @NMUPAOLDPAGOKBIZ_FULL_3
    Scenario: NMU flow OK, FLOW con PA Old e PSP vp1: checkPosition con 1 nav, activateV2 -> paaAttivaRPT, nodoInviaRPT , closeV2+ -> pspNotifyPayment con additionalPaymentInformations, spo+ -> paInviaRT+, BIZ+ e SPRv2+ (si touchpoint e no paymentchannel)(NMU-8)
        Given from body with datatable horizontal checkPositionBody initial JSON checkPosition
        | fiscalCode                  | noticeNumber |
        | #creditor_institution_code# | 305#iuv#     |
        When WISP sends rest POST checkPosition_json to nodo-dei-pagamenti
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPAOLD @NMUPAOLDPAGOKBIZ @NMUPAOLDPAGOKBIZ_FULL_4
    Scenario: NMU flow OK, FLOW con PA Old e PSP vp1 notify PSP vp2 spo: checkPosition con 1 nav, activateV2 -> paaAttivaRPT, nodoInviaRPT, closeV2+ -> pspNotifyPayment con additionalPaymentInformations, spoV2+ -> paInviaRT+, BIZ+ e SPRv2+ (si touchpoint e no paymentchannel)(NMU-12)
        Given from body with datatable horizontal checkPositionBody initial JSON checkPosition
        | fiscalCode                  | noticeNumber |
        | #creditor_institution_code# | 305#iuv#     |
        When WISP sends rest POST checkPosition_json to nodo-dei-pagamenti
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPAOLD @NMUPAOLDPAGKOBIZ @NMUPAOLDPAGKOBIZ_FULL_1
    Scenario: NMU flow KO, FLOW con PA Old e PSP vp1: checkPosition con 1 nav, activateV2 -> paaAttivaRPT, closeV2+ con resp KO perché manca la RPT -> annulla il token, BIZ-, nodoInviaRPT -> paInviaRT-, BIZ- (si touchpoint)(NMU-5)
        Given from body with datatable horizontal checkPositionBody initial JSON checkPosition
            | fiscalCode                  | noticeNumber |
            | #creditor_institution_code# | 305#iuv#     |
        When WISP sends rest POST checkPosition_json to nodo-dei-pagamenti
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPAOLD @NMUPAOLDPAGKOBIZ @NMUPAOLDPAGKOBIZ_FULL_2
    Scenario: NMU flow KO, FLOW con PA Old e PSP vp1: checkPosition con 1 nav, activateV2 -> paaAttivaRPT, closeV2+ con resp KO perché manca la RPT -> annulla il token, BIZ-, nodoInviaRPT -> paInviaRT-, BIZ- (no touchpoint)(NMU-5)
        Given from body with datatable horizontal checkPositionBody initial JSON checkPosition
            | fiscalCode                  | noticeNumber |
            | #creditor_institution_code# | 305#iuv#     |
        When WISP sends rest POST checkPosition_json to nodo-dei-pagamenti
