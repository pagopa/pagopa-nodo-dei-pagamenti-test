Feature: NMU flows con PA New e MBD
    ...
    Scenario: NMU flow RETRY, FLOW con PA New vp2 e PSP vp2 con MBD: activateV2 -> paGetPaymentV2, closepaymentV2 -> override paSendRT malformata -> spoV2 -> job paSendRTV2 (OLD_NMU-5A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#                  |
            | Denominazione | #psp#                                        |
            | IUBD          | #iubd#                                       |
