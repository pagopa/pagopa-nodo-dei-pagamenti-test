Feature: NMU flows con PA New e MBD
    ...
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con 3 transfer con 2x MBD e 1x BAN : activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 con 1x MBD -> KO Check marca da bollo (OLD_NMU-8A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#                  |
            | Denominazione | #psp#                                        |
            | IUBD          | #iubd#                                       |
