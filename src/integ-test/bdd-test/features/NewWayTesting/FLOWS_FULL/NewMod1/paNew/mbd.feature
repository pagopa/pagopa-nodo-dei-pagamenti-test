Feature: NMU flows con PA New e MBD
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_10
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con MBD: activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 with MBD -> OK (OLD_NMU-10A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#                  |
            | Denominazione | #psp#                                        |
            | IUBD          | #iubd#                                       |
        ...
        Given from body with datatable horizontal sendPaymentOutcomeV2Body_MBD_full initial XML sendPaymentOutcomeV2
            | idPSP | idBrokerPSP     | idChannel                    | password   | paymentToken                                  | outcome | paymentMethod | fee  | MBDAttachment | idTransfer |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | $activatePaymentNoticeV2Response.paymentToken | OK      | creditCard    | 2.00 | $bollo        | 1          |
        When PSP sends SOAP sendPaymentOutcomeV2 to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcomeV2 response
        And wait 1 seconds for expiration
        # POSITION_ACTIVATE
    ...
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con MBD e IBAN: activateV2 -> paGetPaymentV2 sia con MBD che IBAN, closepaymentV2 -> override paSendRTV2 timeout -> spoV2 -> paSendRTV2 (OLD_NMU-7A)
        ...
        And from body with datatable horizontal activatePaymentNoticeV2Body_with_expiration_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount | expirationTime |
            | #pspEcommerce# | #brokerEcommerce# | #canaleEcommerce# | #password# | #creditor_institution_code# | 310#iuv#     | 10.00  | 120000         |
        And from body with datatable vertical paGetPaymentV2_MBD_IBAN_full initial XML paGetPaymentV2
            | outcome                     | OK                                           |
            | creditorReferenceId         | 10$iuv                                       |
            | paymentAmount               | 10.00                                        |
            | dueDate                     | 2021-12-12                                   |
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | CREDITOR_REFERENCE_ID    | 10$iuv                           |
            | PA_FISCAL_CODE_SECONDARY | #creditor_institution_code#      |
            | IBAN                     | None,IT45R0760103200000000001016 |
            | AMOUNT                   | 5.00                             |
            | REMITTANCE_INFORMATION   | NotNone                          |
            | TRANSFER_CATEGORY        | NotNone                          |
            | TRANSFER_IDENTIFIER      | 1,2                              |
            | VALID                    | Y                                |
            | COMPANY_NAME_SECONDARY   | None,companyTer                  |
            | FK_POSITION_PAYMENT      | NotNone                          |
            | INSERTED_TIMESTAMP       | NotNone                          |
            | UPDATED_TIMESTAMP        | NotNone                          |
            | FK_PAYMENT_PLAN          | NotNone                          |
        ...
        And from $activatePaymentNoticeV2Resp.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.transferAmount xml check value 5.00 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 1
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.hashDocumento xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 01 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.provinciaResidenza xml check value MI in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.idTransfer xml check value 2 in position 1
        And from $activatePaymentNoticeV2Resp.transferList.transfer.transferAmount xml check value 5.00 in position 1
        And from $activatePaymentNoticeV2Resp.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 2
        And from $activatePaymentNoticeV2Resp.transferList.transfer.companyName xml check value companyTer in position 1
        ...
        And from $activatePaymentNoticeV2Resp.transferList.transfer.remittanceInformation xml check value NotNone in position 1
        And from $activatePaymentNoticeV2Resp.transferList.transfer.transferCategory xml check value paGetPaymentTest in position 1
        And from $activatePaymentNoticeV2Resp.creditorReferenceId xml check value 10$iuv in position 0
        # paGetPaymentV2 REQ
        And execution query to get value result_query on the table RE, with the columns PAYLOAD with db name re with where datatable horizontal
            | where_keys         | where_values                                  |
        ...
        And from $paGetPaymentV2Resp.data.description xml check value pagamentoTest in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.transferAmount xml check value 5.00 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.hashDocumento xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 01 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.provinciaResidenza xml check value MI in position 0
        ...
        And from $paGetPaymentV2Resp.data.transferList.transfer.transferAmount xml check value 5.00 in position 1
        And from $paGetPaymentV2Resp.data.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 1
        And from $paGetPaymentV2Resp.data.transferList.transfer.companyName xml check value companyTer in position 1
        And from $paGetPaymentV2Resp.data.transferList.transfer.IBAN xml check value IT45R0760103200000000001016 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.remittanceInformation xml check value NotNone in position 1
        ...
        And from $paSendRTV2Req.receipt.companyName xml check value company in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.transferAmount xml check value 5.00 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.MBDAttachment xml check value NotNone in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.remittanceInformation xml check value NotNone in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.transferCategory xml check value paGetPaymentTest in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.idTransfer xml check value 2 in position 1
        And from $paSendRTV2Req.receipt.transferList.transfer.transferAmount xml check value 5.00 in position 1
        ...
        And from $paSendRTV2Req.receipt.transferList.transfer.companyName xml check value companyTer in position 1
        And from $paSendRTV2Req.receipt.transferList.transfer.IBAN xml check value IT45R0760103200000000001016 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.remittanceInformation xml check value NotNone in position 1
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_12
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con MBD x5 : activateV2 -> paGetPaymentV2 5 transfer, closepayment, sendPaymentOutcomeV2 with 5 MBD -> OK (OLD_NMU-9A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#                  |
            | Denominazione | #psp#                                        |
            | IUBD          | #iubd#                                       |
        ...
        And from body with datatable horizontal activatePaymentNoticeV2Body_with_expiration_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount | expirationTime |
            | #pspEcommerce# | #brokerEcommerce# | #canaleEcommerce# | #password# | #creditor_institution_code# | 310#iuv#     | 10.00  | 120000         |
        And from body with datatable vertical paGetPaymentV2_5transfer_MBD initial XML paGetPaymentV2
            | outcome                     | OK                                           |
            | creditorReferenceId         | 10$iuv                                       |
            | paymentAmount               | 25.00                                        |
            | dueDate                     | 2021-12-12                                   |
        ...
        Then verify the HTTP status code of v2/closepayment response is 200
        And check outcome is OK of v2/closepayment response
        Given from body with datatable horizontal sendPaymentOutcomeV2Body_5MBD_full initial XML sendPaymentOutcomeV2
            | idPSP | idBrokerPSP     | idChannel                    | password   | paymentToken                                  | outcome | paymentMethod | fee  | MBDAttachment | idTransfer |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | $activatePaymentNoticeV2Response.paymentToken | OK      | creditCard    | 2.00 | $bollo        | 1          |
        When PSP sends SOAP sendPaymentOutcomeV2 to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcomeV2 response
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | VALID                    | Y                                                   |
            | COMPANY_NAME_SECONDARY   | company,companyTer,companyQua,companyCin,companySei |
            | FK_POSITION_PAYMENT      | NotNone                                             |
            | INSERTED_TIMESTAMP       | NotNone                                             |
            | UPDATED_TIMESTAMP        | NotNone                                             |
            | FK_PAYMENT_PLAN          | NotNone                                             |
        ...
        And checks all values by $dict_fields_values_expected of the record for each columns $list_columns of the table POSITION_TRANSFER retrived by the query on db nodo_online with where datatable horizontal
            ...
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
            | ORDER BY       | INSERTED_TIMESTAMP,ID ASC             |
        And verify 5 record for the table POSITION_TRANSFER retrived by the query on db nodo_online with where datatable horizontal
            | where_keys     | where_values                          |
            | NOTICE_ID      | $activatePaymentNoticeV2.noticeNumber |
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
        # POSITION_PAYMENT_STATUS
        ...
        And through the query result_query retrieve xml PAYLOAD at position 0 and save it under the key activatePaymentNoticeV2Resp
        And from $activatePaymentNoticeV2Resp.outcome xml check value OK in position 0
        And from $activatePaymentNoticeV2Resp.totalAmount xml check value 25.0 in position 0
        And from $activatePaymentNoticeV2Resp.paymentDescription xml check value pagamentoTest in position 0
        And from $activatePaymentNoticeV2Resp.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $activatePaymentNoticeV2Resp.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.transferAmount xml check value 5.0 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 1
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.hashDocumento xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 01 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.provinciaResidenza xml check value MI in position 0
        ...
        And from $paGetPaymentV2Resp.outcome xml check value OK in position 0
        And from $paGetPaymentV2Resp.data.creditorReferenceId xml check value 10$iuv in position 0
        And from $paGetPaymentV2Resp.data.paymentAmount xml check value 25.0 in position 0
        And from $paGetPaymentV2Resp.data.dueDate xml check value 2021-12-12 in position 0
        And from $paGetPaymentV2Resp.data.description xml check value pagamentoTest in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.transferAmount xml check value 5.0 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.hashDocumento xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 01 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.provinciaResidenza xml check value MI in position 0
        ...
        And from $closePaymentv2Req.paymentMethod json check value TPAY in position 0
        And from $closePaymentv2Req.paymentToken json check value $activatePaymentNoticeV2Response.paymentToken in position 0
        And from $closePaymentv2Req.totalAmount json check value 27.0 in position 0
        And from $closePaymentv2Req.timestampOperation json check value NotNone in position 0
        And from $closePaymentv2Req.additionalPaymentInformations.key json check value 12345678 in position 0
        # closePayment-v2 RESP
        And execution query to get value result_query on the table RE, with the columns PAYLOAD with db name re with where datatable horizontal
        ...
        And from $pspNotifyPaymentV2Req.paymentList.payment.debtAmount xml check value 25 in position 0
        ### TRANSFER 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 5.0 in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value company in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 0
        ### TRANSFER 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 2 in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 5.0 in position 1
        ...
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companyTer in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 1
        ### TRANSFER 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 3 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 5.0 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companyQua in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 2
        ### TRANSFER 4
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 4 in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 5.0 in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companyCin in position 4
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 3
        ### TRANSFER 5
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 5 in position 4
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 5.0 in position 4
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 4
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companySei in position 5
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 4
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.key xml check value tipoVersamento in position 0
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.value xml check value TPAY in position 0
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.key xml check value key in position 1
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.value xml check value 12345678 in position 1
        ...
        And from $paSendRTV2Req.receipt.outcome xml check value OK in position 0
        And from $paSendRTV2Req.receipt.creditorReferenceId xml check value 10$iuv in position 0
        And from $paSendRTV2Req.receipt.paymentAmount xml check value 25.0 in position 0
        And from $paSendRTV2Req.receipt.description xml check value pagamentoTest in position 0
        And from $paSendRTV2Req.receipt.companyName xml check value company in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.transferAmount xml check value 5.0 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.MBDAttachment xml check value NotNone in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.remittanceInformation xml check value NotNone in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.transferCategory xml check value paGetPaymentTest in position 0
        ...
        And from $sendPaymentOutcomeV2Req.outcome xml check value OK in position 0
        ### TRANSFER 1
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 1
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.idTransfer xml check value 1 in position 0
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.MBDAttachment xml check value NotNone in position 0
        ### TRANSFER 2
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 2
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.idTransfer xml check value 2 in position 1
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.MBDAttachment xml check value NotNone in position 1
        ### TRANSFER 3
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 3
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.idTransfer xml check value 3 in position 2
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.MBDAttachment xml check value NotNone in position 2
        ### TRANSFER 4
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 4
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.idTransfer xml check value 4 in position 3
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.MBDAttachment xml check value NotNone in position 3
        ### TRANSFER 5
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 5
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.idTransfer xml check value 5 in position 4
        And from $sendPaymentOutcomeV2Req.details.marcheDaBollo.marcaDaBollo.MBDAttachment xml check value NotNone in position 4
        # sendPaymentOutcomeV2 RESP
        And execution query to get value result_query on the table RE, with the columns PAYLOAD with db name re with where datatable horizontal
            | where_keys         | where_values                                  |
            | PAYMENT_TOKEN      | $activatePaymentNoticeV2Response.paymentToken |
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_13
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con 3 transfer broadcast 'Y' e MBD: activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 with MBD -> OK (OLD_NMU-8A)
        Given update for table STAZIONI with parameter VERSIONE_PRIMITIVE = '2' on db nodo_cfg with where datatable horizontal
            | where_keys  | where_values                        |
            | ID_STAZIONE | ('90000000001_06','90000000001_01') |
        And update for table PA_STAZIONE_PA  with parameter BROADCAST = 'Y' on db nodo_cfg with where datatable horizontal
            | where_keys | where_values  |
            | OBJ_ID     | ('1201','13') |
        And waiting after triggered refresh job ALL
        Given MB generation MBD_generation with datatable vertical
        ...
        And from body with datatable horizontal activatePaymentNoticeV2Body_with_expiration_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount | expirationTime |
            | #pspEcommerce# | #brokerEcommerce# | #canaleEcommerce# | #password# | #creditor_institution_code# | 310#iuv#     | 10.00  | 120000         |
        And from body with datatable vertical paGetPaymentV2_3transfer_MBD initial XML paGetPaymentV2
            | outcome                     | OK                                           |
            | creditorReferenceId         | 10$iuv                                       |
            | paymentAmount               | 12.00                                        |
            | dueDate                     | 2021-12-12                                   |
        ...
        Then verify the HTTP status code of v2/closepayment response is 200
        And check outcome is OK of v2/closepayment response
        Given from body with datatable horizontal sendPaymentOutcomeV2Body_3MBD_full initial XML sendPaymentOutcomeV2
            | idPSP | idBrokerPSP     | idChannel                    | password   | paymentToken                                  | outcome | paymentMethod | fee  | MBDAttachment | idTransfer |
            | #psp# | #id_broker_psp# | #canale_ATTIVATO_PRESSO_PSP# | #password# | $activatePaymentNoticeV2Response.paymentToken | OK      | creditCard    | 2.00 | $bollo        | 1          |
        When PSP sends SOAP sendPaymentOutcomeV2 to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcomeV2 response
        Given update for table STAZIONI  with parameter VERSIONE_PRIMITIVE = '1' on db nodo_cfg with where datatable horizontal
            | where_keys  | where_values                        |
            | ID_STAZIONE | ('90000000001_06','90000000001_01') |
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | ID                       | NotNone                                             |
            | CREDITOR_REFERENCE_ID    | 10$iuv                                              |
            | PA_FISCAL_CODE_SECONDARY | #creditor_institution_code#,90000000001,90000000002 |
            | IBAN                     | None                                                |
            | AMOUNT                   | 4.0                                                 |
            | REMITTANCE_INFORMATION   | NotNone                                             |
            | TRANSFER_CATEGORY        | NotNone                                             |
            ...
            | VALID                    | Y                                                   |
            | COMPANY_NAME_SECONDARY   | company,companyTer,companyQua                       |
            | FK_POSITION_PAYMENT      | NotNone                                             |
            | INSERTED_TIMESTAMP       | NotNone                                             |
            | UPDATED_TIMESTAMP        | NotNone                                             |
            | FK_PAYMENT_PLAN          | NotNone                                             |
        ...
        And checks all values by $dict_fields_values_expected of the record for each columns $list_columns of the table POSITION_TRANSFER retrived by the query on db nodo_online with where datatable horizontal
            ...
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
            | ORDER BY       | INSERTED_TIMESTAMP,ID ASC             |
        And verify 3 record for the table POSITION_TRANSFER retrived by the query on db nodo_online with where datatable horizontal
            | where_keys     | where_values                          |
            | NOTICE_ID      | $activatePaymentNoticeV2.noticeNumber |
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
        # POSITION_PAYMENT_STATUS
        ...
        And through the query result_query retrieve xml PAYLOAD at position 0 and save it under the key activatePaymentNoticeV2Resp
        And from $activatePaymentNoticeV2Resp.outcome xml check value OK in position 0
        And from $activatePaymentNoticeV2Resp.totalAmount xml check value 12.0 in position 0
        And from $activatePaymentNoticeV2Resp.paymentDescription xml check value pagamentoTest in position 0
        And from $activatePaymentNoticeV2Resp.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $activatePaymentNoticeV2Resp.paymentToken xml check value $activatePaymentNoticeV2Response.paymentToken in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.transferAmount xml check value 4.0 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 1
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.hashDocumento xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 01 in position 0
        And from $activatePaymentNoticeV2Resp.transferList.transfer.richiestaMarcaDaBollo.provinciaResidenza xml check value MI in position 0
        ...
        And from $paGetPaymentV2Resp.outcome xml check value OK in position 0
        And from $paGetPaymentV2Resp.data.creditorReferenceId xml check value 10$iuv in position 0
        And from $paGetPaymentV2Resp.data.paymentAmount xml check value 12.0 in position 0
        And from $paGetPaymentV2Resp.data.dueDate xml check value 2021-12-12 in position 0
        And from $paGetPaymentV2Resp.data.description xml check value pagamentoTest in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.transferAmount xml check value 4.0 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.fiscalCodePA xml check value #creditor_institution_code# in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.hashDocumento xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 01 in position 0
        And from $paGetPaymentV2Resp.data.transferList.transfer.richiestaMarcaDaBollo.provinciaResidenza xml check value MI in position 0
        ...
        And from $closePaymentv2Req.paymentMethod json check value TPAY in position 0
        And from $closePaymentv2Req.paymentToken json check value $activatePaymentNoticeV2Response.paymentToken in position 0
        And from $closePaymentv2Req.totalAmount json check value 14.0 in position 0
        And from $closePaymentv2Req.timestampOperation json check value NotNone in position 0
        And from $closePaymentv2Req.additionalPaymentInformations.key json check value 12345678 in position 0
        # closePayment-v2 RESP
        And execution query to get value result_query on the table RE, with the columns PAYLOAD with db name re with where datatable horizontal
        ...
        And from $pspNotifyPaymentV2Req.paymentList.payment.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.companyName xml check value company in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.debtAmount xml check value 12 in position 0
        ### TRANSFER 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 4.0 in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value company in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 0
        ### TRANSFER 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 2 in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 4.0 in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value 90000000001 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companyTer in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 1
        ### TRANSFER 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 3 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 4.0 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value 90000000002 in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companyQua in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 2
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.key xml check value tipoVersamento in position 0
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.value xml check value TPAY in position 0
        ...
        And from $paSendRTV2Req.receipt.outcome xml check value OK in position 0
        And from $paSendRTV2Req.receipt.creditorReferenceId xml check value 10$iuv in position 0
        And from $paSendRTV2Req.receipt.paymentAmount xml check value 12.0 in position 0
        And from $paSendRTV2Req.receipt.description xml check value pagamentoTest in position 0
        And from $paSendRTV2Req.receipt.companyName xml check value company in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.idTransfer xml check value 1 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.transferAmount xml check value 4.0 in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.MBDAttachment xml check value NotNone in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.remittanceInformation xml check value NotNone in position 0
        And from $paSendRTV2Req.receipt.transferList.transfer.transferCategory xml check value paGetPaymentTest in position 0
        ...
        And execution query to get value result_query on the table RE, with the columns PAYLOAD with db name re with where datatable horizontal
            | where_keys               | where_values                                  |
            | PAYMENT_TOKEN            | $activatePaymentNoticeV2Response.paymentToken |
            | IDENTIFICATIVO_EROGATORE | 90000000001_06                                |
            | TIPO_EVENTO              | paSendRTV2                                    |
            | SOTTO_TIPO_EVENTO        | REQ                                           |
            | ESITO                    | INVIATA                                       |
            | INSERTED_TIMESTAMP       | TRUNC(SYSDATE-1)                              |
            | ORDER BY                 | DATA_ORA_EVENTO ASC                           |
        And through the query result_query retrieve xml PAYLOAD at position 0 and save it under the key paSendRTV2Req
        And from $paSendRTV2Req.idPA xml check value 90000000001 in position 0
        And from $paSendRTV2Req.idBrokerPA xml check value 90000000001 in position 0
        And from $paSendRTV2Req.idStation xml check value 90000000001_06 in position 0
        And from $paSendRTV2Req.receipt.noticeNumber xml check value $activatePaymentNoticeV2.noticeNumber in position 0
        And from $paSendRTV2Req.receipt.fiscalCode xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $paSendRTV2Req.receipt.outcome xml check value OK in position 0
        And from $paSendRTV2Req.receipt.creditorReferenceId xml check value 10$iuv in position 0
        ...
        And execution query to get value result_query on the table RE, with the columns PAYLOAD with db name re with where datatable horizontal
            ...
            | ORDER BY                 | DATA_ORA_EVENTO ASC                           |
        And through the query result_query retrieve xml PAYLOAD at position 0 and save it under the key paSendRTV2Req
        And from $paSendRTV2Req.idPA xml check value 90000000002 in position 0
        And from $paSendRTV2Req.idBrokerPA xml check value 90000000001 in position 0
        And from $paSendRTV2Req.idStation xml check value 90000000001_01 in position 0
        And from $paSendRTV2Req.receipt.noticeNumber xml check value $activatePaymentNoticeV2.noticeNumber in position 0
        And from $paSendRTV2Req.receipt.fiscalCode xml check value $activatePaymentNoticeV2.fiscalCode in position 0
        And from $paSendRTV2Req.receipt.outcome xml check value OK in position 0
        And from $paSendRTV2Req.receipt.creditorReferenceId xml check value 10$iuv in position 0
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_14
    Scenario: NMU flow KO, FLOW con PA New vp2 e PSP vp2 con 3 transfer con 2x MBD e 1x BAN : activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 con 1x MBD -> KO Check marca da bollo (OLD_NMU-8A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#                  |
            | Denominazione | #psp#                                        |
            | IUBD          | #iubd#                                       |
        ...
        And from body with datatable horizontal activatePaymentNoticeV2Body_with_expiration_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount | expirationTime |
            | #pspEcommerce# | #brokerEcommerce# | #canaleEcommerce# | #password# | #creditor_institution_code# | 310#iuv#     | 10.00  | 120000         |
        And from body with datatable vertical paGetPaymentV2_3transfer_2MBD_IBAN initial XML paGetPaymentV2
            | outcome                     | OK                                           |
            | creditorReferenceId         | 10$iuv                                       |
            | paymentAmount               | 12.00                                        |
            | dueDate                     | 2021-12-12                                   |
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | CREDITOR_REFERENCE_ID    | 10$iuv                                |
            | PA_FISCAL_CODE_SECONDARY | #creditor_institution_code#           |
            | IBAN                     | None,IT45R0760103200000000001016,None |
            | AMOUNT                   | 4.0                                   |
            | REMITTANCE_INFORMATION   | NotNone                               |
            | TRANSFER_CATEGORY        | NotNone                               |
            | TRANSFER_IDENTIFIER      | 1,2,3                                 |
        ...
        And generate list columns list_columns and dict fields values expected dict_fields_values_expected for query checks all values with datatable horizontal
            ...
            | CREDITOR_REFERENCE_ID | $paGetPaymentV2.creditorReferenceId                                        |
            | PAYMENT_TOKEN         | $activatePaymentNoticeV2Response.paymentToken                              |
            | INSERTED_BY           | activatePaymentNoticeV2,closePayment-v2,closePayment-v2,pspNotifyPaymentV2 |
        And checks all values by $dict_fields_values_expected of the record for each columns $list_columns of the table POSITION_PAYMENT_STATUS retrived by the query on db nodo_online with where datatable horizontal
            | where_keys     | where_values                          |
            | NOTICE_ID      | $activatePaymentNoticeV2.noticeNumber |
            | PA_FISCAL_CODE | $activatePaymentNoticeV2.fiscalCode   |
        ...
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value company in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 0
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.hashDocumento  xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 0
        ### TRANSFER 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 2 in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 4.0 in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 2
        ...
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.remittanceInformation xml check value /RFB/00202200000217527/5.00/TXT/ in position 0
        ### TRANSFER 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.idTransfer xml check value 3 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.transferAmount xml check value 4.0 in position 2
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.fiscalCodePA xml check value $activatePaymentNoticeV2.fiscalCode in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.companyName xml check value companyQua in position 3
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.richiestaMarcaDaBollo.tipoBollo xml check value 1 in position 1
        And from $pspNotifyPaymentV2Req.paymentList.payment.transferList.transfer.hashDocumento  xml check value wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= in position 1
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.key xml check value tipoVersamento in position 0
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.value xml check value TPAY in position 0
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.key xml check value key in position 1
        And from $pspNotifyPaymentV2Req.additionalPaymentInformations.metadata.mapEntry.value xml check value 12345678 in position 1
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_15
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con 3 transfer con MBD e iubd non univoco : activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 -> OK  (OLD_NMU-18A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#                  |
            | Denominazione | #psp#                                        |
            | IUBD          | 1574213715129721                             |
            | OraAcquisto   | 2022-02-06T15:00:44.659+01:00                |
            | Importo       | 5.00                                         |
            | TipoBollo     | 01                                           |
            | DigestValue   | wHpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E= |
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_16
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con MBD e hash in DigestValue diverso: activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 -> OK  (OLD_NMU-19A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | #creditor_institution_code#   |
            | Denominazione | #psp#                         |
            | IUBD          | 1574213715129721              |
    ...
    @ALL @FLOW @FLOW_FULL @NMU @NMUPANEW @NMUPANEWMBD @NMUPANEWMBD_FULL_17
    Scenario: NMU flow OK, FLOW con PA New vp2 e PSP vp2 con 3 transfer con 1 IBAN con CF PSP diverso: activateV2 -> paGetPaymentV2, closepayment, sendPaymentOutcomeV2 -> OK  (OLD_NMU-20A)
        Given MB generation MBD_generation with datatable vertical
            | CodiceFiscale | CF40000000001                                |
            | Denominazione | #psp#                                        |
            | IUBD          | 1574213715129721                             |
            | OraAcquisto   | 2022-02-06T15:00:44.659+01:00                |
            | Importo       | 5.00                                         |
