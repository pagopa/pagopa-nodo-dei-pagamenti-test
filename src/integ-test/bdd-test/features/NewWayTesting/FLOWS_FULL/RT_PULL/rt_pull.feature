Feature: RT PULL flow
    ...
    Scenario: RT pull, FLOW con PA Old e PSP Old, PSP che utilizza flag 'RT Push' e 'Recovery' disabilitati e che l'RT vada in esito sconosciuto PA.: nodoInviaRPT, job rt-pull -> pspChiediListaRT, pspChiediRT, paaInviaRT+, BIZ+ (OLD_RTPull-25A)
