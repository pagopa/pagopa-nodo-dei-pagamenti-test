Feature: NMU flows con pagamento KO
    ...
    Scenario: NMU flow paNEW KO con canale irraggiungibile: activateV2 -> paGetPayment, closeV2+ BIZ- (PG-130_1)
    ...
    @ALL @PG_130 @PG_130_2
    Scenario: NMU flow paNEW KO con KO dal PSP: activateV2 -> paGetPayment, closeV2+ BIZ- (PG-130_2)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount |
            | #pspEcommerce# | #brokerEcommerce# | #canaleEcommerce# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
    ...
    @ALL @PG_130 @PG_130_4
    Scenario: NMU flow paNEW KO con KO dal PSP: activateV2 -> paGetPaymentV2, pspNotifyPaymentV2 malformata, closeV2+ BIZ- (PG-130_4)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount |
    ...
    @ALL @PG_130 @PG_130_3
    Scenario: NMU flow paNEW KO con TIMEOUT dal PSP: activateV2 -> paGetPayment, closeV2+ BIZ- (PG-130_3)
        Given from body with datatable horizontal activatePaymentNoticeV2Body_full initial XML activatePaymentNoticeV2
            | idPSP          | idBrokerPSP       | idChannel         | password   | fiscalCode                  | noticeNumber | amount |
            | #pspEcommerce# | #brokerEcommerce# | #canaleEcommerce# | #password# | #creditor_institution_code# | 302#iuv#     | 10.00  |
        And from body with datatable vertical paGetPayment_full initial XML paGetPayment
