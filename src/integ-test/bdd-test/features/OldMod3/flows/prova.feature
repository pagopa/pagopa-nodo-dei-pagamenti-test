Feature: Check codifica bar code- OK
            ...
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/" xmlns:bc="http://PuntoAccessoPSP.spcoop.gov.it/BarCode_GS1_128_Modified" xmlns:aim="http://PuntoAccessoPSP.spcoop.gov.it/Code_128_AIM_USS-128_tipo_C" xmlns:qrc="http://PuntoAccessoPSP.spcoop.gov.it/QrCode">
                ...
                <soapenv:Body>
                    <ws:nodoVerificaRPT>
                        ...
                        <codiceIdRPT>
                            <bc:BarCode>  
                                <bc:Gln>4444444444444</bc:Gln>  <bc:CodStazPA>02</bc:CodStazPA>  <bc:AuxDigit>0</bc:AuxDigit>  <bc:CodIUV>139071058514448</bc:CodIUV> 
                            </bc:BarCode>
                        </codiceIdRPT>
                    </ws:nodoVerificaRPT>
                </soapenv:Body>
    ...
    Scenario: sendRPT phase
        Given the activateRPT phase scenario executed successfully
        When PSP sends SOAP sendRPT to nodo-dei-pagamenti
        Then check esito is OK of sendRPT response

    Scenario: sendRT phase
        Given the sendRPT phase scenario executed successfully
