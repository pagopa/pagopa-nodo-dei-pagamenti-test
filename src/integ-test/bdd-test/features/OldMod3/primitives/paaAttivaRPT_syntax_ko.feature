Feature: Syntax checks KO for nodoAttivaRPT
    Background:
        ...
        And initial XML nodoAttivaRPT
            ...
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/" xmlns:pag="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:bc="http://PuntoAccessoPSP.spcoop.gov.it/BarCode_GS1_128_Modified">
                ...
                <soapenv:Body>
                    <ws:nodoAttivaRPT>
                        ...
                        <codiceIdRPT><bc:BarCode>  <bc:Gln>9000000000001</bc:Gln>  <!--<bc:CodStazPA>11</bc:CodStazPA>-->  <bc:AuxDigit>3</bc:AuxDigit>  <bc:CodIUV></bc:CodIUV> </bc:BarCode> </codiceIdRPT>
                        <datiPagamentoPSP>
            ...
            """
    Scenario: Check faultCode PPT_SINTASSI_EXTRAXSD error on invalid wsdl namespace
