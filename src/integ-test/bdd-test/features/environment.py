...
def before_all(context):
    ...
    lib_dir = os.path.abspath(os.path.join(__file__, os.pardir, os.pardir, os.pardir, os.pardir, os.pardir, '/opt/oracle/instantclient-basic-linux.x64-21.6.0.0.0dbru'))
