#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con idTransfer contenente lettere

Feature: activatePaymentNoticeV2Request with idTransfer containing letters
