# Il test verifica che il nodo restituisca un KO se il body è presente e i sottotag assenti

Feature: check syntax KO for paGetPaymentV2 with body and without tags
