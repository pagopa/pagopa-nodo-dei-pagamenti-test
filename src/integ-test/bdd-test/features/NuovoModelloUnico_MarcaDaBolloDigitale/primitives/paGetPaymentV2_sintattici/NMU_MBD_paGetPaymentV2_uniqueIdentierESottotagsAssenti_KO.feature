#Il test verifica che il nodo non accetti una paGetPaymentV2Response con uniqueIdentifier e sottotag assenti

Feature: paGetPaymentV2Response uniqueIdetifier and tags not present
