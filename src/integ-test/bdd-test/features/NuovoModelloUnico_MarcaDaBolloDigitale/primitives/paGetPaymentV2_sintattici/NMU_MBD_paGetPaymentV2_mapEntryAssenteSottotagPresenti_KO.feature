#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 senza mapEntry ma con i sottotag

Feature: activatePaymentNoticeV2Request without mapEntry but with tags
