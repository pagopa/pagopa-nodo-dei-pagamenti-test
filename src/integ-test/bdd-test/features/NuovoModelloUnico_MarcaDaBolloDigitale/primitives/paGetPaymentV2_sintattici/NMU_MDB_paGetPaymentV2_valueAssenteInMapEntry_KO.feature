#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 senza value in mapEntry

Feature: activatePaymentNoticeV2Request without value in mapEntry
