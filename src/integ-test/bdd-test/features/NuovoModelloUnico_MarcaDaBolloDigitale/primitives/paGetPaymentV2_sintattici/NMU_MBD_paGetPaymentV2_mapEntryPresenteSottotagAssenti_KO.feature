# Il test verifica che il nodo restituisca un KO se mapEntry è presente e i sottotag assenti

Feature: check syntax KO for paGetPaymentV2 without mapEntry but with tags at the end
