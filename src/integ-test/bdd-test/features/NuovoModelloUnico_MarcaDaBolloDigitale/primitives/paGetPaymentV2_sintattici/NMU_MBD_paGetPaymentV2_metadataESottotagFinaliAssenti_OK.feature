#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 senza metadata e sottotag finali

Feature: activatePaymentNoticeV2Request without metadata and tags at the end
