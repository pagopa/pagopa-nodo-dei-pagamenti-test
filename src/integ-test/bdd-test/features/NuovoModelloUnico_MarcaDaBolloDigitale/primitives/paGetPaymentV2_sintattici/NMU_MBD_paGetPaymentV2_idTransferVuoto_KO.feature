#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con idTransfer vuoto

Feature: activatePaymentNoticeV2Request with empty idTransfer KO
