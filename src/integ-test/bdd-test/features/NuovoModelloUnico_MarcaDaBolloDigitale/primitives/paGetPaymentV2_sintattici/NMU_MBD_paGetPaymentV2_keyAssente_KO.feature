#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 senza key in mapEntry

Feature: activatePaymentNoticeV2Request without key in mapEntry
