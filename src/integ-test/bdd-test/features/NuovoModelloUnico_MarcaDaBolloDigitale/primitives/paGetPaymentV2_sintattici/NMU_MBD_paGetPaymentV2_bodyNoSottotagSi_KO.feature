# Il test verifica che il nodo restituisca un KO se la paGetPaymentV2 non contiene il body ma ci sono i relativi sottotag

Feature: check syntax KO for paGetPaymentV2 without body and with tags
