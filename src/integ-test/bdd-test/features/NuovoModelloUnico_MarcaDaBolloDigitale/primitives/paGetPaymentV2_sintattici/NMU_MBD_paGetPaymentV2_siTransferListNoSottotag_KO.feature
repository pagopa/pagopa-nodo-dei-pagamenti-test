#Il test verifica che il nodo non accetti una paGetPaymentV2Response senza transferList ma con i sottotag presenti

Feature: paGetPaymentV2Response no transferList but with tags
