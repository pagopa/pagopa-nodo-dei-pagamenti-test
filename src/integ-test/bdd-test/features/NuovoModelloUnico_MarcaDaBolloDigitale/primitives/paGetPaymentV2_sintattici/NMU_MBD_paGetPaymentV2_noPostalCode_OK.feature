# Il test verifica che il nodo restituisca un OK se il campo optional postalCode non è presente

Feature: check syntax OK for paGetPaymentV2 without postalCode
