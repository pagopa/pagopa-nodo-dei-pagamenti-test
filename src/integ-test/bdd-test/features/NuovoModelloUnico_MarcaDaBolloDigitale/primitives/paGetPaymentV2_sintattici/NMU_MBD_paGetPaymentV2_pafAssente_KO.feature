# Il test verifica che il nodo restituisca un KO se la paGetPaymentV2 non contiene il 'paf:' ma ci sono i relativi sottotag

Feature: check syntax KO for paGetPaymentV2 without paf and with tags
