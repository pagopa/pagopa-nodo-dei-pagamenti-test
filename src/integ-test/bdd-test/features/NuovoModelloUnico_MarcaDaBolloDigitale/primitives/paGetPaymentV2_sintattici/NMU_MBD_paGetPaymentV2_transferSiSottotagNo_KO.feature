# Il test verifica che il nodo restituisca un KO se il campo transfer non è presente e i suoi sottotag si

Feature: check syntax KO for paGetPaymentV2 without transfer but with tags
