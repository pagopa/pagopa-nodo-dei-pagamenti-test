#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con idTransfer non compreso nell'enumeration

Feature: activatePaymentNoticeV2Request with idTransfer not in enumeration
