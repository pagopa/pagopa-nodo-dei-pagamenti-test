#Il test verifica che il nodo non accetti un'activatePAymentNoticeV2 con 6 transfers con IBAN

Feature: activatePaymentNoticeV2Request with 6 transfers KO
