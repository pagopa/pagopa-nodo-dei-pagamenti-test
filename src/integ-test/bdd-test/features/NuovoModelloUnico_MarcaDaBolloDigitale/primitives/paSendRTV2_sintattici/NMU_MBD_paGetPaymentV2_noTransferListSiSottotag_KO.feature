#Il test verifica che il nodo non accetti una paGetPaymentV2Response senza transferList e i sottotag

Feature: paGetPaymentV2Response no transferList and tags
