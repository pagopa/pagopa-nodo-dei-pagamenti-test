#Il test verifica che il nodo non accetti una paGetPaymentV2Response senza debtor ma con i relativi sottotag

Feature: paGetPaymentV2Response without debtor but with tags
