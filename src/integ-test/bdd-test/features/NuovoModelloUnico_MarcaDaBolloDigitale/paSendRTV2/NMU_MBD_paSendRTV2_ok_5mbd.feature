...
Feature: flow tests for paSendRTV2 - Marca da bollo
    ...
    Scenario: Execute activatePaymentNoticeV2
        ...
        And initial XML paGetPaymentV2
            ...
            <remittanceInformation>information4</remittanceInformation>
            ...
            <remittanceInformation>information5</remittanceInformation>
    ...
    Scenario: execute DB check
        ...
        Then verify 5 record for the table POSITION_TRANSFER_MBD retrived by the query select_position_transfer_mbd on db nodo_online under macro NewMod1
        ...
        # POSITION_TRANSFER
        And verify 5 record for the table POSITION_TRANSFER retrived by the query position_receipt_recipient_v2 on db nodo_online under macro sendPaymentResultV2
        ...
        And checks the value 05 of the record at column REQ_TIPO_BOLLO of the table POSITION_TRANSFER retrived by the query position_receipt_recipient_v2_desc on db nodo_online under macro sendPaymentResultV2
