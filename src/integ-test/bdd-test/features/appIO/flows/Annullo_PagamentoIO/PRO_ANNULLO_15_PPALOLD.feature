Feature: PRO_ANNULLO_15_PPALOLD 47
    ...
    Scenario: Execute nodoInoltroEsitoPayPal (Phase 5) - Response malformata
        ...
        And checks the value RPT_RICEVUTA_NODO, RPT_ACCETTATA_NODO, RPT_PARCHEGGIATA_NODO, RPT_INVIATA_A_PSP, RPT_ERRORE_INVIO_A_PSP of the record at column STATO of the table STATI_RPT retrived by the query rpt_stati on db nodo_online under macro AppIO
