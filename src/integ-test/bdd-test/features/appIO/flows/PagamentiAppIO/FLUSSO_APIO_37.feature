...
#     Scenario: Execute nodoChiediAvanzamentoPagamento2 (Phase 5)
#         Given the Execute nodoChiediAvanzamentoPagamento1 (Phase 4) scenario executed successfully
#         When WISP sends rest GET avanzamentoPagamento?idPagamento=$activateIOPaymentResponse.paymentToken to nodo-dei-pagamenti
#         Then verify the HTTP status code of avanzamentoPagamento response is 200
#         And check esito is PARKED of avanzamentoPagamento response

#     Scenario: Execute nodoChiediAvanzamentoPagamento3 (Phase 6)
#         Given the Execute nodoChiediAvanzamentoPagamento2 (Phase 5) scenario executed successfully
#         When WISP sends rest GET avanzamentoPagamento?idPagamento=$activateIOPaymentResponse.paymentToken to nodo-dei-pagamenti
#         Then verify the HTTP status code of avanzamentoPagamento response is 200
#         And check esito is PARKED of avanzamentoPagamento response

#     Scenario: Execute nodoChiediAvanzamentoPAgamento4 (Phase 7)
#         Given the Execute nodoChiediAvanzamentoPagamento3 (Phase 6) scenario executed successfully
#         When WISP sends REST get avanzamentoPagamento?idPagamento=$activateIOPaymentResponse.paymentToken to nodo-dei-pagamenti
#         Then verify the HTTP status code of avanzamentoPagamento response is 200
#         And check esito is PARKED of avanzamentoPagamento response
    
#     Scenario: Execute nodoInoltroEsitoCarta (Phase 8)
#         Given the Execute nodoChiediAvanzamentoPAgamento4 (Phase 7) scenario executed successfully
...
#     Scenario: Execute sendPaymentOutcome (Phase 9)
#         Given nodo-dei-pagamenti has config parameter maxChiediAvanzamento set to 3
#         And nodo-dei-pagamenti has config parameter useCountChiediAvanzamento set to true
#         And the Execute nodoInoltroEsitoCarta (Phase 8) scenario executed successfully
