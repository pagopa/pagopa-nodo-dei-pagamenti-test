Feature:  flow check for sendPaymentResult-v2 request - pagamento con appIO diverso da BPAY e PPAL, scadenza del token, closePayment-v2 OK, spr-v2 non inviata [T_SPR_V2_22]
    ...
    Scenario: Execute a closePayment-v2 request
        ...
        And verify the HTTP status code of v2/closepayment response is 404
