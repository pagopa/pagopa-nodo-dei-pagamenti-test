Feature:  flow check for sendPaymentResult-v2 request - spr-v2 200 KO nessun retry [T_SPR_V2_23]
...
#implementare i check db e verificare che la tabella POSITION_RETRY_SENDPAYMENTRESULT sia vuota