Feature:  flow check for sendPaymentResult-v2 request - spr-v2 400 Bad Request,200 OK, retry [T_SPR_V2_28]
    ...
    Scenario: Execute sendPaymentOutcome request
        ...
        And REST POST sendPaymentResult-v2
            """
            400 Bad Request
            """

        And REST POST sendPaymentResult-v2_ok
            """
            200 OK
            """
        ...
        And WISP sends REST POST sendPaymentResult-v2 to nodo-dei-pagamenti
        And wait 90 seconds for expiration
        And WISP sends REST POST sendPaymentResult-v2_ok to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcome response

#implementare i check db e verificare che la tabella POSITION_RETRY_SENDPAYMENTRESULT sia popolata e poi svuotata dopo aver ricevuto la response 200 ok