Feature:  flow check for sendPaymentResult-v2 request - pagamento con appIO diverso da BPAY e PPAL, spr-v2 inviata [T_SPR_V2_16]
...
# implementare i check su RE per verificare che la sendPaymentResult-v2 sia inviata e sulle altre tabelle del db per gli stati
