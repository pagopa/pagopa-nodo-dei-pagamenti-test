Feature:  flow check for sendPaymentResult-v2 request - pagamento con appIO diverso da BPAY e PPAL, scadenza del token, closePayment-v2 OK, spr-v2 non inviata [T_SPR_V2_08]
    ...
    Scenario: Execute a closePayment-v2 request
        ...
        Then check outcome is Unacceptable outcome when token has expired of closePayment-v2
        And verify the HTTP status code of closePayment-v2 response is 400




# implementare i check DB e verificare che la sendPaymentResult-v2 non sia inviata
