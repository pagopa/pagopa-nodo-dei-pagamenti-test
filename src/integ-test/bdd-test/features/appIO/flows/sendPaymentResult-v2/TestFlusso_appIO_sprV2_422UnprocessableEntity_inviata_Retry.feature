Feature:  flow check for sendPaymentResult-v2 request - spr-v2 422 Unprocessable entity, retry [T_SPR_V2_13]
...
#implementare i check db e verificare che la tabella POSITION_RETRY_SENDPAYMENTRESULT sia popolata