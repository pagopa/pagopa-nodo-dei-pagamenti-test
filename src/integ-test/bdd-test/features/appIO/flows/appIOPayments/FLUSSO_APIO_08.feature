...
Scenario: check sendPaymentOutcome response on PAYMENT_SEND_ERROR
    ...
    And check STATUS column of POSITION_PAYMENT_STATUS table contains PAYMENT_SEND_ERROR value in nodo_online db
    And check STATUS column of POSITION_PAYMENT_STATUS_SNAPSHOT table contains PAYMENT_SEND_ERROR value in nodo_online db
