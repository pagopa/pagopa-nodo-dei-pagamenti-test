...
Scenario: Check sendPaymentOutcome response on malformed pspNotifyPayment response
    ...
    And check STATUS column of POSITION_PAYMENT_STATUS_SNAPSHOT table contains PAYMENT_UNKNOWN value in nodo_online db
    And check STATUS column of POSITION_STATUS table contains PAYING value in nodo_online db
    And check STATUS column of POSITION_STATUS_SNAPSHOT contains PAYING value in nodo_online db
