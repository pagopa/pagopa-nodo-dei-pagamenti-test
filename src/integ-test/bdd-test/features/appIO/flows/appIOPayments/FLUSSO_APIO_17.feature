...
Scenario: Check nodoNotificaAnnullamento response after nodoInoltroEsitoCarta primitive and the correctness of column values
    ...
    ###### FIX MOTIVO_ANNULLAMENTO column in PM_SESSION_DATA table