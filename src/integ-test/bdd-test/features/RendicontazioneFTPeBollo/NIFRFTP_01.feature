Feature: NCAP
    ...
    Scenario: Execute nodoInviaFlussoRendicontazione request
        ...
        And replace idFlusso content with $identificativoFlusso content
        ...
        And checks the value $idFlusso.xml.zip of the record at column FILE_NAME of the table RENDICONTAZIONE_SFTP_SEND_QUEUE retrived by the query send_queue on db nodo_offline under macro RendicontazioneFTPeBollo
