Feature: revision checks for sendPaymentOutcomeV2
    ...
    Scenario: activatePaymentNoticeV2
        ...
        And initial XML paGetPaymentV2
            ...
            <hashDocumento>1HpFSLCGZjIvNSXxqtGbxg7275t446DRTk5ZrsdUQ6E=</hashDocumento>
    ...
    Scenario: sendPaymentOutcomeV2 MB
        Given MB1 generation
            """
        ...
        And initial XML sendPaymentOutcomeV2
            ...
            <paymentToken>$activatePaymentNoticeV2Response.paymentToken</paymentToken>
            <idTransfer>1</idTransfer>
            <MBDAttachment>$1bollo</MBDAttachment>
            </marcaDaBollo>
            <marcaDaBollo>
            <paymentToken>$activatePaymentNoticeV2Response.paymentToken</paymentToken>
            <idTransfer>2</idTransfer>
            ...
            <paymentToken>$activatePaymentNoticeV2Response.paymentToken</paymentToken>
            <idTransfer>3</idTransfer>
            <MBDAttachment>$3bollo</MBDAttachment>
            </marcaDaBollo>
            <marcaDaBollo>
            <paymentToken>$activatePaymentNoticeV2Response.paymentToken</paymentToken>
            <idTransfer>4</idTransfer>
            <MBDAttachment>$4bollo</MBDAttachment>
            </marcaDaBollo>
            <marcaDaBollo>
            <paymentToken>$activatePaymentNoticeV2Response.paymentToken</paymentToken>
            <idTransfer>5</idTransfer>
            <MBDAttachment>$5bollo</MBDAttachment>
            </marcaDaBollo>
            </marcheDaBollo>
            </details>
            </nod:sendPaymentOutcomeV2Request>
    ...
    Scenario: activatePaymentNoticeV2 with more metadata
        Given initial XML activatePaymentNoticeV2
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
            xmlns:nod="http://pagopa-api.pagopa.gov.it/node/nodeForPsp.xsd">
        ...
        And initial XML paGetPaymentV2
            ...
            <metadata>
            <mapEntry>
            <key>%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à</key>
            <value>%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à</value>
            </mapEntry>
            <mapEntry>
            <key>%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à</key>
            <value>%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à%%%%%%%%%à</value>
    ...
    Scenario: Step1 MB with metadata
        Given the activatePaymentNoticeV2 with more metadata scenario executed successfully
        When PSP sends SOAP activatePaymentNoticeV2 to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNoticeV2 response
        Given the closePaymentV2 request scenario executed successfully
        When WISP sends rest POST v2/closepayment_json to nodo-dei-pagamenti
    ...
    Scenario: Step2 MB with metadata
        Given the Step1 MB with metadata scenario executed successfully
        And the sendPaymentOutcomeV2 MB scenario executed successfully
        When PSP sends SOAP sendPaymentOutcomeV2 to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcomeV2 response