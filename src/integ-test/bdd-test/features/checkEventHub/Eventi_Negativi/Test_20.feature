Feature: Block revision for sendPaymentOutcome 180
    ...
    Scenario: activatePaymentNotice token 1
    ...
    Scenario: mod3CancelV2
        Given the activatePaymentNotice token 1 scenario executed successfully
        When job mod3CancelV2 triggered after 3 seconds
        Then verify the HTTP status code of mod3CancelV2 response is 200

    Scenario: activatePaymentNotice token 2
        Given the mod3CancelV2 scenario executed successfully
        When PSP sends SOAP activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
        And save activatePaymentNotice response in activatePaymentNotice2

    Scenario: sendPaymentOutcome token 2
        Given the activatePaymentNotice token 2 scenario executed successfully
    ...
    @eventhub
    Scenario: sendPaymentOutcome token 1
        Given the sendPaymentOutcome token 2 scenario executed successfully
