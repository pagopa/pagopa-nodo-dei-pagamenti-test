Feature: Flow checks Bollo 7 -12
  ...
  Background: 
    ...
    Scenario: Check faultCode PPT_SEMANTICA error on invalid certificate MB [Bollo_8]
      Given MB generation
        """
        <?xml version="1.0" encoding="UTF-8"?>
        <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
          ...
          <ImprontaDocumento>
              <DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256" />
              <ns2:DigestValue>WsmwKj7w4LvPn7ao2SuU0Gc37SuV0G9H9kxTeRQU85M=</ns2:DigestValue>
          </ImprontaDocumento>
          <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
              <SignedInfo>
                <CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315" />
      ...
      And RT generation
        """
          ...
          <pay_i:RT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0.xsd ">
            <pay_i:versioneOggetto>6.0</pay_i:versioneOggetto>
            <pay_i:dominio>
                <pay_i:identificativoDominio>90000000002</pay_i:identificativoDominio>
    ...
    Scenario: Check faultCode PPT_SEMANTICA error on fake certificate MB [Bollo_9]
      Given MB generation
        """
        <?xml version="1.0" encoding="UTF-8"?>
        <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
          ...
          <ImprontaDocumento>
              <DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256" />
              <ns2:DigestValue>8FqHpTji9pboxWmx7p1WoMiKh8MOMujHv1+zg+M3LSo=</ns2:DigestValue>
          </ImprontaDocumento>
          <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
              <SignedInfo>
                <CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315" />
    ...
    Scenario: Check faultCode PPT_SEMANTICA error on expired certificate MB [Bollo_10]
      Given MB generation
        """
        <?xml version="1.0" encoding="UTF-8"?>
        <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
          ...
          <ImprontaDocumento>
              <DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256" />
              <ns2:DigestValue>gefYZaaBvVexylet9qocdTF7Wrl1gfpyMSM-28IfCBU=</ns2:DigestValue>
          </ImprontaDocumento>
          <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
              <SignedInfo>
                <CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315" />
          ...
          <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_2_0.xsd ">
            ...
            <pay_i:datiVersamento>
                ...
                <pay_i:datiSingoloVersamento>
                  ...
                  <pay_i:datiMarcaBolloDigitale>
                      <pay_i:tipoBollo>01</pay_i:tipoBollo>
                      <pay_i:hashDocumento>gefYZaaBvVexylet9qocdTF7Wrl1gfpyMSM-28IfCBU=</pay_i:hashDocumento>
                      <pay_i:provinciaResidenza>MI</pay_i:provinciaResidenza>
                  </pay_i:datiMarcaBolloDigitale>
                </pay_i:datiSingoloVersamento>
            </pay_i:datiVersamento>
      ...
      Then check esito is KO of nodoInviaRT response
      And check faultCode is PPT_SEMANTICA of nodoInviaRT response
    Scenario: Check faultCode PPT_SEMANTICA error on Impronta MB [Bollo_11]
      Given MB generation
        """
        <?xml version="1.0" encoding="UTF-8"?>
        <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
          ...
          <ImprontaDocumento>
              <DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256" />
              <ns2:DigestValue>LdfszF/ejk/qQ2X0zYnwNgXa4vIMwzHQkDwDDlHRD24=</ns2:DigestValue>
          </ImprontaDocumento>
          <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
              <SignedInfo>
                <CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315" />
      ...
      Then check esito is KO of nodoInviaRT response
      And check faultCode is PPT_SEMANTICA of nodoInviaRT response
    Scenario: Check faultCode PPT_SEMANTICA error on diffrent PSP [Bollo_12]
      Given MB generation
        """
        <?xml version="1.0" encoding="UTF-8"?>
        <marcaDaBollo xmlns="http://www.agenziaentrate.gov.it/2014/MarcaDaBollo" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#">
          ...
          <ImprontaDocumento>
              <DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256" />
              <ns2:DigestValue>dztKdM1yp++sKbCn5jX+woPMEJQ4-W6Eb+rMlrag3zo=</ns2:DigestValue>
          </ImprontaDocumento>
          <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
              <SignedInfo>
                <CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315" />
          ...
          <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_2_0.xsd ">
            ...
            <pay_i:datiVersamento>
                ...
                <pay_i:datiSingoloVersamento>
                  ...
                  <pay_i:datiMarcaBolloDigitale>
                      <pay_i:tipoBollo>01</pay_i:tipoBollo>
                      <pay_i:hashDocumento>dztKdM1yp++sKbCn5jX+woPMEJQ4-W6Eb+rMlrag3zo=</pay_i:hashDocumento>
                      <pay_i:provinciaResidenza>MI</pay_i:provinciaResidenza>
                  </pay_i:datiMarcaBolloDigitale>
                </pay_i:datiSingoloVersamento>
            </pay_i:datiVersamento>
