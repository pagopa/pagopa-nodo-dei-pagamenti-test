Feature: flows checks for Bollo 1573
    ...
    Scenario: RR generation
        ...
        And RR generation
            ...
            <pay_i:datiMarcaBolloDigitale>
            <pay_i:tipoBollo>01</pay_i:tipoBollo>
            <pay_i:hashDocumento>7zVEKpx6ABfFXsmMGyc4GSIIP5SonnANAKfKFQ0vgAY=</pay_i:hashDocumento>
            <pay_i:provinciaResidenza>MI</pay_i:provinciaResidenza>
            </pay_i:datiMarcaBolloDigitale>
            </pay_i:datiSingoloVersamento>
            </pay_i:datiVersamento>
        ...
        And ER generation
            ...
            """
    Scenario: Execute nodoInviaRPT second
