...
#----------------------------------------------------------------------------------------------------
# faultCode PPT_TIPOFIRMA_SCONOSCIUTO
#----------------------------------------------------------------------------------------------------
@midRunnable
Scenario: Check faultCode PPT_TIPOFIRMA_SCONOSCIUTO error on invalid RPT tag combination [RPTSEM10]
    Given pay_i:tipoVersamento with AD in RPT
    And  pay_i:firmaRicevuta with 3 in RPT
    And RPT generation
      """
      $RPT
      """
    ...
    When EC sends SOAP nodoInviaRPT to nodo-dei-pagamenti
    Then check esito is KO of nodoInviaRPT response
    And check faultCode is PPT_TIPOFIRMA_SCONOSCIUTO of nodoInviaRPT response
...
#----------------------------------------------------------------------------------------------------
# faultCode PPT_SEMANTICA [RPTSEM12]
#----------------------------------------------------------------------------------------------------
@midRunnable
...
#----------------------------------------------------------------------------------------------------
# faultCode PPT_SEMANTICA [RPTSEM14]
#----------------------------------------------------------------------------------------------------
@midRunnable
Scenario: 2 datiSingoloVersamento +  importoTotaleDaVersare = 2.00 +  [RPTSEM14]
    Given RPT generation
    """
    <?xml version="1.0" encoding="UTF-8"?>
    <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0_1.xsd ">
      ...
      <pay_i:datiVersamento>
        <pay_i:dataEsecuzionePagamento>2022-07-07</pay_i:dataEsecuzionePagamento>
        <pay_i:importoTotaleDaVersare>2.00</pay_i:importoTotaleDaVersare>
        <pay_i:tipoVersamento>PO</pay_i:tipoVersamento>
        <pay_i:identificativoUnivocoVersamento>$1iuv</pay_i:identificativoUnivocoVersamento>
        <pay_i:codiceContestoPagamento>CCD01</pay_i:codiceContestoPagamento>
        <pay_i:ibanAddebito>IT96R0123454321000000012345</pay_i:ibanAddebito>
        ...
        <pay_i:firmaRicevuta>0</pay_i:firmaRicevuta>
        <pay_i:datiSingoloVersamento>
          <pay_i:importoSingoloVersamento>0.00</pay_i:importoSingoloVersamento>
          <pay_i:commissioneCaricoPA>1.25</pay_i:commissioneCaricoPA>
          <pay_i:ibanAccredito>IT96R0123454321000000012345</pay_i:ibanAccredito>
          <pay_i:bicAccredito>ARTIITM1050</pay_i:bicAccredito>
          <pay_i:ibanAppoggio>IT96R0123454321000000012345</pay_i:ibanAppoggio>
         ...
         <pay_i:datiSingoloVersamento>
          <pay_i:importoSingoloVersamento>2.00</pay_i:importoSingoloVersamento>
          <pay_i:commissioneCaricoPA>1.25</pay_i:commissioneCaricoPA>
          <pay_i:ibanAccredito>IT96R0123454321000000012345</pay_i:ibanAccredito>
          <pay_i:bicAccredito>ARTIITM1050</pay_i:bicAccredito>
          <pay_i:ibanAppoggio>IT96R0123454321000000012345</pay_i:ibanAppoggio>
