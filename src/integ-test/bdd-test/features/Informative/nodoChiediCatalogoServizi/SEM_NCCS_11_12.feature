Feature: Semantic checks KO for nodoChiediCatalogoServizi
    ...
    Scenario: Check SEM_NCCS_11
        ...
        And checks the value NotNone of the record at column ID_SERVIZIO of the table CDS_SERVIZIO retrived by the query cds_ervizio on db nodo_cfg under macro informative
