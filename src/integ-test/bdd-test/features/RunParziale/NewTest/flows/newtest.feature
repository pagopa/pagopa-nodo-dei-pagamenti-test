...
### NEW TEST 7 ACTIVATE - PA PRINCIPALE CON 2 BROADCAST E PA SECONDARIA SENZA BROADCAST - VER. PRIMITIVE 2
    ...
    Scenario: activatePaymentNoticeV2_request_7
        Given the checkPosition_7 scenario executed successfully
        And initial XML activatePaymentNoticeV2
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
            xmlns:nod="http://pagopa-api.pagopa.gov.it/node/nodeForPsp.xsd">
    ...
    Scenario: closePaymentV2_7
        Given the activatePaymentNoticeV2_request_7 scenario executed successfully
        And initial json v2/closepayment
            """
            {
                "paymentTokens": [
    ...
    Scenario: sendPaymentOutcomeV2 - PA principale con 2 broadcast e pa secondaria senza broadcast - ver. primitive 2
        Given the Update broadcast for primary pa scenario executed successfully
        And the closePaymentV2_7 scenario executed successfully
        And initial XML sendPaymentOutcomeV2
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:nod="http://pagopa-api.pagopa.gov.it/node/nodeForPsp.xsd">
            <soapenv:Header/>
...
### NEW TEST 8 ACTIVATE - PA PRINCIPALE CON 2 BROADCAST E PA SECONDARIA CON 2 BROADCAST - VER. PRIMITIVE 2
    ...
    Scenario: activatePaymentNoticeV2_request_8
        Given the checkPosition_8 scenario executed successfully
        And initial XML activatePaymentNoticeV2
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
            xmlns:nod="http://pagopa-api.pagopa.gov.it/node/nodeForPsp.xsd">
    ...
    Scenario: closePaymentV2_8
        Given the activatePaymentNoticeV2_request_8 scenario executed successfully
        And initial json v2/closepayment
            """
            {
                "paymentTokens": [
    ...
    Scenario: sendPaymentOutcomeV2 - PA principale con 2 broadcast e pa secondaria con 2 broadcast - ver. primitive 2
        Given the Update broadcast for primary and secondary pa scenario executed successfully
        And the closePaymentV2_8 scenario executed successfully
        And initial XML sendPaymentOutcomeV2
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:nod="http://pagopa-api.pagopa.gov.it/node/nodeForPsp.xsd">
            <soapenv:Header/>
...
### NEW TEST 1 CARRELLO - PA PRINCIPALE SENZA BROADCAST E PA SECONDARIA SENZA BROADCAST - VER. PRIMITIVE 1
    ...
    @newtest1carrello
    Scenario: Execute nodoInviaRT1 request - PA principale senza broadcast e pa secondaria senza broadcast - ver. primitive 1
...
### NEW TEST 2 CARRELLO - PA PRINCIPALE SENZA BROADCAST E PA SECONDARIA CON 2 BROADCAST - VER. PRIMITIVE 1
    ...
    @newtest2carrello
    Scenario: Execute nodoInviaRT1 request - PA principale senza broadcast e pa secondaria con 2 broadcast - ver. primitive 1
        Given the Update broadcast for secondary pa scenario executed successfully
        And the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header/>
...
### NEW TEST 3 CARRELLO - PA PRINCIPALE CON 2 BROADCAST E PA SECONDARIA SENZA BROADCAST - VER. PRIMITIVE 1
    ...
    @newtest3carrello
    Scenario: Execute nodoInviaRT1 request - PA principale con 2 broadcast e pa secondaria senza broadcast - ver. primitive 1
        Given the Update broadcast for primary pa scenario executed successfully
        And the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
...
### NEW TEST 4 CARRELLO - PA PRINCIPALE CON 2 BROADCAST E PA SECONDARIA CON 2 BROADCAST - VER. PRIMITIVE 1
    ...
    @newtest4carrello
    Scenario: Execute nodoInviaRT1 request - PA principale con 2 broadcast e pa secondaria con 2 broadcast - ver. primitive 1
        Given the Update broadcast for primary and secondary pa scenario executed successfully
        And the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
...
### NEW TEST 5 CARRELLO - PA PRINCIPALE SENZA BROADCAST E PA SECONDARIA SENZA BROADCAST - VER. PRIMITIVE 2
    ...
    @newtest5carrello
    Scenario: Execute nodoInviaRT1 request - PA principale senza broadcast e pa secondaria senza broadcast - ver. primitive 2
        Given the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
...
### NEW TEST 6 CARRELLO - PA PRINCIPALE SENZA BROADCAST E PA SECONDARIA CON 2 BROADCAST - VER. PRIMITIVE 2
    ...
    @newtest6carrello
    Scenario: Execute nodoInviaRT1 request - PA principale senza broadcast e pa secondaria con 2 broadcast - ver. primitive 2
        Given the Update broadcast for secondary pa scenario executed successfully
        And the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
...
### NEW TEST 7 CARRELLO - PA PRINCIPALE CON 2 BROADCAST E PA SECONDARIA SENZA BROADCAST - VER. PRIMITIVE 2
    ...
    @newtest7carrello
    Scenario: Execute nodoInviaRT1 request - PA principale con 2 broadcast e pa secondaria senza broadcast - ver. primitive 2
        Given the Update broadcast for primary pa scenario executed successfully
        And the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
...
### NEW TEST 8 CARRELLO - PA PRINCIPALE CON 2 BROADCAST E PA SECONDARIA CON 2 BROADCAST - VER. PRIMITIVE 2
    ...
    @newtest8carrello
    Scenario: Execute nodoInviaRT1 request - PA principale con 2 broadcast e pa secondaria con 2 broadcast - ver. primitive 2
        Given the Update broadcast for primary and secondary pa scenario executed successfully
        And the Execute nodoInviaRT request scenario executed successfully
        And initial XML nodoInviaRT
            """
