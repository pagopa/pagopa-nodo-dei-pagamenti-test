Feature: Block revision for sendPaymentOutcome
    ...
    Scenario: parallel calls and test scenario
        ...
        And verify the HTTP status code of nodoInviaRPT response is 200
        And verify the HTTP status code of v2/closepayment response is 422

        # Aggiungere check sulla stati rpt snapshot controllando che lo stato non sia più in rpt_parcheggiata_nodo
