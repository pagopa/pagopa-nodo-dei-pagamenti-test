Feature: NM3 PA Old KO without optional - attivaRPT timeout 
    ...
    Scenario: activatePaymentNotice request
        ...
        And from body activatePaymentNoticeBodyExpiration_paOld_noOptional initial XML activatePaymentNotice
        And from body paaAttivaRPT_Timeout_noOptional initial XML paaAttivaRPT
