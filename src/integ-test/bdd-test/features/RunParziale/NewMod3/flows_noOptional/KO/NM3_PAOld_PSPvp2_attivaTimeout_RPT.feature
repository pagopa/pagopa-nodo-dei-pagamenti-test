Feature: NM3 PA Old KO without optional - attivaRPT timeout 
    ...
    Scenario: activatePaymentNoticeV2 request
        ...
        And from body activatePaymentNoticeV2BodyExpiration_paOld_Ecommerce initial XML activatePaymentNoticeV2
        And from body paaAttivaRPT_Timeout_tokenFromActivateV2_noOptional initial XML paaAttivaRPT
        ...
        And execution query select_activatev2 to get value on the table RPT_ACTIVATIONS, with the columns PAYMENT_TOKEN under macro NewMod3 with db name nodo_online
    ...
    Scenario: nodoInviaRPT with ccp from DB
        ...
        And RPT generation
            ...
            """
        And from body nodoInviaRPTBody_paOld_TimeoutActivate_noOptional initial xml nodoInviaRPT
