Feature: NM3 PA Old without optional
    ...
    @noOptional
    Scenario: happyflow PA Old PSP vp1 POSTE
        ...
        Given from body with datatable activatePaymentNoticeBody_noOptional initial XML activatePaymentNotice
        ...
        Given from body sendPaymentOutcomeBody_POSTE_noOptional initial XML sendPaymentOutcome
