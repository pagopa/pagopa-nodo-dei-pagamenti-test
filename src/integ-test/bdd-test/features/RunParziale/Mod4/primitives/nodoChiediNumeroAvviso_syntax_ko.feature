Feature: syntax checks for nodoChiediNumeroAvviso - KO 1500
    ...
    Scenario: nodoChiediNumeroAvviso with two occurrences of datiSpecificiServizio
        Given initial XML nodoChiediNumeroAvviso
            ...
            """
    @chiediNumeroAvvisoSinKO_1 @Mod4 @ALL
    ...
    @chiediNumeroAvvisoSinKO_2 @Mod4 @ALL
    # element value check
    ...
    @chiediNumeroAvvisoSinKO_3 @Mod4 @ALL
