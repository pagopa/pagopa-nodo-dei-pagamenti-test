Feature: flow tests for demandPaymentNotice
    ...
    ### HAPPY PATH WITH ONE ACTIVATE

    @Mod4_1 @Mod4 @ALL
    Scenario: Happy flow with 1 activate
    ...
    ### HAPPY PATH WITH ONE ACTIVATE AND PAYMENT CHANNEL WITH NONE

    @Mod4_2 @Mod4 @ALL
    Scenario: Happy flow with 1 activate and paymentChannel with None
        Given the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request scenario executed successfully
        When PSP sends soap activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
    ...
    ### SPO WITH OUTCOME SET TO KO - FAILURE SCENARIO

    @Mod4_3 @Mod4 @ALL
    Scenario: SendPaymentOutcome with Outcome set to KO - failure
        Given the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request scenario executed successfully
        When PSP sends soap activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
    ...
    ### ACTIVATE WITH TOKEN EXPIRED

    @Mod4_4 @Mod4 @ALL
    Scenario: Activate with token expired
        Given the demandPaymentNotice scenario executed successfully
    ...
    ### HAPPY PATH WITH ACTIVATE WITH 3 TRANSFERS

    @Mod4_5 @Mod4 @ALL
    Scenario: Happy path with activate with 3 transfers
    ...
    ### SPO WITH OUTCOME SET TO KO WITH ACTIVATE WITH 3 TRANSFERS - FAILURE SCENARIO

    @Mod4_6 @Mod4 @ALL
    Scenario: SendPaymentOutcome set to KO with activate with 3 transfers - failure
        Given updates through the query update_fk_pa of the table PA_STAZIONE_PA the parameter BROADCAST with N under macro Mod4 on db nodo_cfg
        And refresh job ALL triggered after 10 seconds
        And the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request with 3 transfers scenario executed successfully
    ...
    ### ACTIVATE WITH 3 TRANSFERS WITH TOKEN EXPIRED

    @Mod4_7 @Mod4 @ALL
    Scenario: Activate with 3 transfers with token expired
        Given updates through the query update_fk_pa of the table PA_STAZIONE_PA the parameter BROADCAST with N under macro Mod4 on db nodo_cfg
        And refresh job ALL triggered after 10 seconds
        And the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request with 3 transfers scenario executed successfully
    ...
    ### SCENARIOS WITH BROADCAST SET TO YES

    ### ACTIVATE WITH 3 TRANSFERS AND STATIONS WITH BROADCAST SET TO YES

    @Mod4_8 @Mod4 @ALL
    Scenario: Activate with 3 transfers and stations with broadcast set to yes
    ...
    ### SPO WITH OUTCOME SET TO KO AND ACTIVATE WITH 3 TRANSFERS AND STATIONS WITH BROADCAST SET TO YES - FAILURE SCENARIO

    @Mod4_9 @Mod4 @ALL
    Scenario: SendPaymentOutcome with outcome set to KO and activate with 3 transfers and stations with broadcast set to yes 
        Given updates through the query update_obj_id of the table PA_STAZIONE_PA the parameter BROADCAST with Y under macro Mod4 on db nodo_cfg
        And refresh job ALL triggered after 10 seconds
        And the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request with 3 transfers scenario executed successfully
    ...
    ### ACTIVATE WITH 3 TRANSFERS WITH TOKEN EXPIRED AND STATIONS WITH BROADCAST SET TO YES

    @Mod4_10 @Mod4 @ALL
    Scenario: Activate with 3 transfers with token expired and stations with broadcast set to yes
        Given updates through the query update_obj_id of the table PA_STAZIONE_PA the parameter BROADCAST with Y under macro Mod4 on db nodo_cfg
        And refresh job ALL triggered after 10 seconds
        And the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request with 3 transfers scenario executed successfully
    ...
    ### HAPPY PATH WITH ACTIVATE WITH 2 TRANSFERS AND STATIONS WITH BROADCAST SET TO YES

    @Mod4_11 @Mod4 @ALL
    Scenario: Happy path with activate with 2 transfers and stations with broadcast set to yes
    ...
    ### SPO WITH OUTCOME KO AND SECOND ACTIVATE WITH TOKEN EXPIRED

    @Mod4_12 @Mod4 @ALL
    Scenario: SendPaymentOutcome with outcome KO and second activate with token expired
        Given the demandPaymentNotice scenario executed successfully
        And the activatePaymentNotice request scenario executed successfully
        When PSP sends soap activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
        ...
        When PSP sends soap sendPaymentOutcome to nodo-dei-pagamenti
        Then check outcome is OK of sendPaymentOutcome response
        Given random idempotencyKey having $activatePaymentNotice.idPSP as idPSP in activatePaymentNotice
        And expirationTime with 2000 in activatePaymentNotice
        And EC replies to nodo-dei-pagamenti with the paGetPayment
        When PSP sends soap activatePaymentNotice to nodo-dei-pagamenti
        Then check outcome is OK of activatePaymentNotice response
