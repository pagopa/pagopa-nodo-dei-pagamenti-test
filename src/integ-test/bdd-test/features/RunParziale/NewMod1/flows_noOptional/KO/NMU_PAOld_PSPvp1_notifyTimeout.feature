Feature: NM1 PA New without optional
    ...
    Scenario: checkPosition request
        ...
        And from body checkPositionBody_paOld initial JSON checkPosition
    ...
    Scenario: activatePaymentNoticeV2 request
        ...
        And from body paaAttivaRPT_tokenFromActivateV2_noOptional initial XML paaAttivaRPT
    ...
    Scenario: nodoInviaRPT request
        ...
        And RPT generation
            ...
            """
        And from body nodoInviaRPTBody_tokenFromActivateV2_paOld_noOptional initial xml nodoInviaRPT
        When EC sends SOAP nodoInviaRPT to nodo-dei-pagamenti
        Then check esito is OK of nodoInviaRPT response
    
    Scenario: closePaymentV2 request
        Given the nodoInviaRPT request scenario executed successfully
        And from body pspNotifyPayment_Timeout_noOptional initial XML pspNotifyPayment
