Feature: NM1 PA New without optional
    ...
    Scenario: checkPosition request
        Given from body checkPositionBody_paOld initial JSON checkPosition
    ...
    Scenario: activatePaymentNoticeV2 request
        ...
        And from body activatePaymentNoticeV2Body_paOld_Ecommerce initial XML activatePaymentNoticeV2
