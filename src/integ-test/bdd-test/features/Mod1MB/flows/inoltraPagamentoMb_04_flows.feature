...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
  ...
  Scenario: Execute nodoInoltraEsitoPagamentoCarta request
    ...
    And initial XML nodoInoltraEsitoPagamentoCarta
      """
     ##manca primitiva
      """
    When psp sends SOAP nodoInoltraEsitoPagamentoCarta to nodo-dei-pagamenti
    Then check outcome is OK of nodoInoltraEsitoPagamentoCarta response
