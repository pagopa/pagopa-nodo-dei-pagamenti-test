Feature: Flows checks for nodoInviaCarrelloRPT [inoltro_pagamento_09]

    Background:
        Given systems up


    # [inoltro_pagamento_09]
    ...
    Scenario: Execute nodoInoltraPagamentoMod2
        ...
        When WISP sends rest GET inoltroEsito/mod2 to nodo-dei-pagamenti
            """
            {
                "idPagamento": "${#TestCase#idPagamento}",
