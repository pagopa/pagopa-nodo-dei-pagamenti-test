...
#todo implementare test per cui la tabella position_receipt non sia popolata tramite query DB_RECEIPIT_01_position_receipit
    ...
    Scenario: DB check
    Given the Execute nodoInviaCarrelloRPT request scenario executed successfully
#todo implementare test per cui la tabella position_receipt_transfer non sia popolata tramite query DB_RECEIPIT_01_position_receipit_transfer


          #db check 1
    Scenario: DB check
    Given the Execute nodoInviaCarrelloRPT request scenario executed successfully
#todo implementare test per cui la tabella position_receipt_recipient non sia popolata tramite query DB_RECEIPIT_01_position_receipit_recipient


          #db check 1
    Scenario: DB check
    Given the Execute nodoInviaCarrelloRPT request scenario executed successfully
#todo implementare test per cui la tabella position_receipt_recipient_status non sia popolata tramite query DB_RECEIPIT_01_position_receipit_recipient_status


          #db check 1
    Scenario: DB check
    Given the Execute nodoInviaCarrelloRPT request scenario executed successfully
#todo implementare test per cui la tabella position_receipt_xml non sia popolata tramite query DB_RECEIPIT_01_position_receipit_xml
