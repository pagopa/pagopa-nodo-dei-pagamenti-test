Feature: process tests for nodoInviaCarrelloMb
    ...
    Scenario: RPT generation
        ...
        And RPT3 generation
            ...
            """
        And generate 3 notice number and iuv with aux digit 3, segregation code #cod_segr# and application code NA
        And RPT4 generation
            """
            <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0_1.xsd ">
            <pay_i:versioneOggetto>1.1</pay_i:versioneOggetto>
        ...
        And generate 4 notice number and iuv with aux digit 3, segregation code #cod_segr# and application code NA
        And RPT5 generation
            """
            <pay_i:RPT xmlns:pay_i="http://www.digitpa.gov.it/schemas/2011/Pagamenti/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.digitpa.gov.it/schemas/2011/Pagamenti/ PagInf_RPT_RT_6_0_1.xsd ">
            <pay_i:versioneOggetto>1.1</pay_i:versioneOggetto>
    ...
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        #And checks the value $1iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_PAYMENT_PLAN retrived by the query by_position_service on db nodo_online under macro Mod1Mb
        ...
        #And checks the value $1noticeNumber of the record at column NOTICE_ID of the table POSITION_TRANSFER retrived by the query by_position_subject on db nodo_online under macro Mod1Mb
        #And checks the value iuv of the record at column CREDITOR_REFERENCE_ID of the table POSITION_TRANSFER retrived by the query by_position_service on db nodo_online under macro Mod1Mb
