Feature: NICM_DB_03 899
    ...
    Scenario: Execute nodoInviaCarrelloRPT (Phase 1)
        ...
        And verify 1 record for the table POSITION_SUBJECT retrived by the query by_position_subject on db nodo_online under macro Mod1Mb
