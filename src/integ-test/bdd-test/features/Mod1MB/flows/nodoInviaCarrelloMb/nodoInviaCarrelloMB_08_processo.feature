Feature: process tests for nodoInviaCarrelloMB 880

    #[nodoInviaCarrelloMB_08]
    Background:
        Given systems up
...
@runnable
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        And check description is Lo stesso Ente deve essere presente con una sola RPT of nodoInviaCarrelloRPT response
