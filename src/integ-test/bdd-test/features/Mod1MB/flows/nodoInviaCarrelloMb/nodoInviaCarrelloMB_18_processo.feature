    Feature: process tests for nodoInviaCarrelloMB[nodoInviaCarrelloMB_18] 890
   ...
   Scenario: MB generation
        ...
        And RPT2 generation
            ...
            <pay_i:dominio>
                ...
                <pay_i:identificativoStazioneRichiedente>#creditor_institution_code_secondary#_02</pay_i:identificativoStazioneRichiedente>
            </pay_i:dominio>
            <pay_i:identificativoMessaggioRichiesta>idMsgRichiesta</pay_i:identificativoMessaggioRichiesta>
            <pay_i:dataOraMessaggioRichiesta>#timedate#</pay_i:dataOraMessaggioRichiesta>
            <pay_i:autenticazioneSoggetto>CNS</pay_i:autenticazioneSoggetto>
