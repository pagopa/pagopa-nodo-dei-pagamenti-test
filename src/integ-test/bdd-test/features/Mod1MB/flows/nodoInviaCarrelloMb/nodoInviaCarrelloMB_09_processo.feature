Feature: process tests for nodoInviaCarrelloMB 881

    #[nodoInviaCarrelloMB_09]
    Background:
        Given systems up
...
@runnable
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        And check description is Lo IUV non è identico per ogni RPT of nodoInviaCarrelloRPT response
