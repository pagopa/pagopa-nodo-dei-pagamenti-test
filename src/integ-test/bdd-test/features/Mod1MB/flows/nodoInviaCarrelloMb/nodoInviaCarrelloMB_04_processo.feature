Feature: process tests for nodoInviaCarrelloMB 876

    #[nodoInviaCarrelloMB_04]
    Background:
        Given systems up
...
@runnable
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        Then check description is Il carrello deve avere massimo 5 versamenti totali of nodoInviaCarrelloRPT response
