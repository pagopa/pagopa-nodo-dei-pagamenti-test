Feature: process tests for nodoInviaCarrelloMB 874

    #[nodoInviaCarrelloMB_02]
    Background:
        Given systems up
...
@runnable
    Scenario: Execute nodoInviaCarrelloRPT request
        ...
        Then check description is La seconda RPT non contiene solo 1 versamento of nodoInviaCarrelloRPT response
