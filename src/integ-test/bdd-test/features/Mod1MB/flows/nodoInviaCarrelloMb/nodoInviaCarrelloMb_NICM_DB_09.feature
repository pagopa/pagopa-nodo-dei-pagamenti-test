Feature: NICM_DB_09
    ...
    Scenario: Execute nodoInviaCarrelloRPT
        ...
        And RPT2 generation
            ...
            <identificativoPSP>#canale_AGID#</identificativoPSP>
        ...
        And verify 1 record for the table POSITION_PAYMENT_PLAN retrived by the query _ on db nodo_online under macro Mod1Mb
