Feature: gestioneReceiptMb_04_PULL 840
    ...
    Scenario: Execute nodoInviaCarrelloRPT (Phase 1)
        ...
        And execution query obj_id_dom1 to get value on the table PA, with the columns OBJ_ID under macro Mod1Mb with db name nodo_cfg
        And through the query obj_id_dom1 retrieve param objId at position 0 and save it under the key objId
