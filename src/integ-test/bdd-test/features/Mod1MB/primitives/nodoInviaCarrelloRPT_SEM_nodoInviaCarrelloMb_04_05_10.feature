Feature: Semantic checks for nodoInviaCarrelloRPT
   ...
   Scenario: Define RPT
      Given RPT generation
         ...
         <pay_i:identificativoStazioneRichiedente>66666666666_02</pay_i:identificativoStazioneRichiedente>
         </pay_i:dominio>
   ...
   Scenario: Check error for nodoInviaCarrelloRPT primitive
      ...
      And initial XML nodoInviaCarrelloRPT
         ...
         <identificativoStazioneIntermediarioPA>66666666666_02</identificativoStazioneIntermediarioPA>
   ...
   #       <pay_i:versioneOggetto>1.0</pay_i:versioneOggetto>
   #       <pay_i:dominio>
   #       <pay_i:identificativoDominio>77777777778</pay_i:identificativoDominio>
