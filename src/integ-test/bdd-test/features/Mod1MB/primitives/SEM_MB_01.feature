Feature: Semantic checks for nodoInviaCarrelloRPT
   ...
   Scenario Outline: Check PPT_MULTI_BENEFICIARIO error for nodoInviaCarrelloRPT_idDominioRPT2 primitive
   ...
   Scenario Outline: Check PPT_MULTI_BENEFICIARIO error for nodoInviaCarrelloRPT_idDominioNessunaRPT primitive
   ...
   Scenario: RPT4 generation
         ...
         """
   Scenario Outline: Check PPT_MULTI_BENEFICIARIO error for nodoInviaCarrelloRPT_lunghezzaInferiore primitive
         Given the RPT4 generation scenario executed successfully
         And initial XML nodoInviaCarrelloRPT
         """
         <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ppt="http://ws.pagamenti.telematici.gov/ppthead" xmlns:ws="http://ws.pagamenti.telematici.gov/">
            <soapenv:Header>
