Feature: Semantic checks for nodoInviaCarrelloRPT
   ...
   Scenario Outline: Check PPT_MULTIBENEFICIARIO error on non-existent psp
      ...
      Examples:
         | tag                    | value                               | soapUI test | test description    |
         | identificativoCarrello | 4444444444431101233155019590029004  | SEM_MB_01   | nessun trattino     |
         | identificativoCarrello | 90000000001311012331550195900-15623 | SEM_MB_01   | idDominioRPT2       |
         | identificativoCarrello | 44444444444311012331550195900-43788 | SEM_MB_01   | idDominioNessunaRPT |
         | identificativoCarrello | 7777777777311012331550195900-76431  | SEM_MB_01   | lunghezza inferiore |
         | identificativoCarrello | 31101233155019590044444444444-59412 | SEM_MB_01   | ordine invertito    |
