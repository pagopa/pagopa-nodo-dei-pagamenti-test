...
k6 run --console-output='./scenarios/'$scenario'/test/setup_output/idpay-log-file.csv' -e scenario=$scenario -e test=$test -e steps=$steps -e env=$env './scenarios/'$scenario'/test/'$test'.js'
#k6 run --vus 1 --duration 30s --console-output='./scenarios/'$scenario'/test/setup_output/idpay-log-file.csv' -e scenario=$scenario -e test=$test -e steps=$steps -e env=$env './scenarios/'$scenario'/test/'$test'.js'
...
# k6 run --console-output='./scenarios/'$scenario'/test/output/idpay-log-file.log'
