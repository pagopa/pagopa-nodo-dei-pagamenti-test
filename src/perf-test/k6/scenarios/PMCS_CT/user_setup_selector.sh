...
k6 run --vus 1 --duration 10m --console-output='./scenarios/'$scenario'/test/setup_output/user-log-file.csv' -e scenario=$scenario -e test=$test -e steps=$steps -e env=$env './scenarios/'$scenario'/test/'$test'.js'
