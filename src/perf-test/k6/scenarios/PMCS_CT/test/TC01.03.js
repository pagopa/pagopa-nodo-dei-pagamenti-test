...
export const options = {
  ...
  thresholds: {
	...
	'checks{pay_Check:ko_rate}': ['rate<0.01'],
	...
	'checks{getWallet_v2:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_CC_PayINternal:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_CC_Pay:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_CC_CheckOut:ko_rate}': ['rate<0.01'],
