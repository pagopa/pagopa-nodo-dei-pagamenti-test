...
export const options = {
  ...
  thresholds: {
	...
	'checks{ob_CC_Onboard:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Verify:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_VerifyInternal:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_continueToStep1:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_CheckOut:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Check_1:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Check_2:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Check_3:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Logout:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_bye:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_update:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Challenge:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_Response:ko_rate}': ['rate<0.01'],
	...
	'checks{ob_CC_resume3ds2:ko_rate}': ['rate<0.01'],
	...
	'checks{ALL:ok_rate}': [],
	'checks{ALL:ko_rate}': ['rate<0.01'], //'rate<0.01' http errors should be less than 0.01%
	},
