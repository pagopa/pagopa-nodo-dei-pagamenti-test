...
export const ob_CC_CheckOut_Trend = new Trend('ob_CC_CheckOut');
...
export function ob_CC_CheckOut(baseUrl, RED_Path) {
 ...
 const res = http.get(
   ...
   check(
    ...
    { ob_CC_CheckOut: 'ok_rate' , ALL: 'ok_rate'}
	);
  ...
  check(
    ...
    { ob_CC_CheckOut: 'ko_rate', ALL: 'ko_rate' }
  );
