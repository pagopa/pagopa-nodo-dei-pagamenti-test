 ...
 const res = http.post(
  ...
  check(res, {
   ...
   check(
    ...
    { ob_CC_resume3ds2: 'ok_rate' , ALL:'ok_rate'}
	);
  ...
  check(
    ...
    { ob_CC_resume3ds2: 'ko_rate', ALL:'ko_rate' }
  );
