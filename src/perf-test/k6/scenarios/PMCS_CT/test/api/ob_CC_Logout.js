 ...
 const res = http.get(
  ...
  check(res, {
   ...
   check(
    ...
    { ob_CC_Logout: 'ok_rate' ,ALL:'ok_rate'}
	);
  ...
  check(
    ...
    { ob_CC_Logout: 'ko_rate' ,ALL:'ko_rate'}
  );
