...
*/
  ...
  thresholds: {
	...
	'checks{getWallet_v3:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_PP_Check:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_PP_Pay:ko_rate}': ['rate<0.01'],
	...
	'checks{B_Check:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_PP_Logout:ko_rate}': ['rate<0.01'],
	...
	'checks{pay_PP_bye:ko_rate}': ['rate<0.01'],
