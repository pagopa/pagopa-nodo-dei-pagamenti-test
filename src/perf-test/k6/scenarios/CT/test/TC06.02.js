...
import { closePaymentV2_2 } from './api/closePaymentV2.js';
...
export const options = {
  ...
  thresholds: {
    ...
    'checks{closePaymentV2_2:ko_rate}': ['rate<0.01'],
    'checks{closePaymentV2_2:ok_rate}': [],
    'checks{closePaymentV2_2:over_sla300}': [],
    'checks{closePaymentV2_2:over_sla400}': [],
    'checks{closePaymentV2_2:over_sla500}': [],
    'checks{closePaymentV2_2:over_sla600}': [],
    'checks{closePaymentV2_2:over_sla800}': [],
    'checks{closePaymentV2_2:over_sla1000}': []
  },
};
...
function total() {
  ...
  closePaymentV2_2(restBaseUrl, rndAnagPsp, paymentToken_1, paymentToken_2, "09910087308786", "09910087308786", 1.0, 0.01)
}