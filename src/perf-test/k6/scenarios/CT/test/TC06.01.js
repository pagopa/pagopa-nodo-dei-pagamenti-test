...
import { closePaymentV2_5 } from './api/closePaymentV2.js';
import * as common from '../../CommonScript.js';
import * as inputDataUtil from './util/input_data_util.js';

//k6 run --out csv=scenarios/CT/test/output/TC06.01.csv -e scenario=CT -e test=TC06.01 -e steps=rampa_1_1_10 -e env=pagoPA_PERF_apim scenarios/CT/test/TC06.01.js -e outdir=scenarios/CT/test/output -v --iterations=1
//k6 run -e scenario=CT -e test=TC06.01 -e steps=rampa_1_1_10 -e env=pagoPA_PERF_apim scenarios/CT/test/TC06.01.js --iterations=1
...
export const options = {
  ...
  thresholds: {
    ...
    'checks{closePaymentV2_5:ko_rate}': ['rate<0.01'],
    'checks{closePaymentV2_5:ok_rate}': [],
    'checks{closePaymentV2_5:over_sla300}': [],
    'checks{closePaymentV2_5:over_sla400}': [],
    'checks{closePaymentV2_5:over_sla500}': [],
    'checks{closePaymentV2_5:over_sla600}': [],
    'checks{closePaymentV2_5:over_sla800}': [],
    'checks{closePaymentV2_5:over_sla1000}': []
  },
};
...
function total() {
  ...
  //oggetto proprietà psp, intpsp e chpsp_c
  ...
  for (let key in urls) {
    if (urls[key].ENV == `${__ENV.env}`) {
      ...
      //https://nodo-dei-pagamenti-prf-npa-nodopagamenti.tst-npc.sia.eu/azurept
      soapBaseUrl = urls[key].SOAP_BASEURL;
      //https://nodo-dei-pagamenti-prf-npa-nodopagamenti.tst-npc.sia.eu/webservices/input
    }
  }
  ...
  closePaymentV2_5(restBaseUrl, rndAnagPsp, paymentToken_1, paymentToken_2, paymentToken_3, paymentToken_4, paymentToken_5, "09910087308786", "09910087308786", 1.0, 0.01)
}
