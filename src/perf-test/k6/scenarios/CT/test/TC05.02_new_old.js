...
export function handleSummary(data) {
  ...
  var csv = outputUtil.extractData(data);
   ...
   return {
    ...
    './scenarios/CT/test/output/TC05.02_new_old.summary.json': JSON.stringify(data), // and a JSON with all the details...
	//'./scenarios/CT/test/output/summary.html': htmlReport(data),
	'./scenarios/CT/test/output/TC05.02_new_old.summary.csv': csv[0],
	'./scenarios/CT/test/output/TC05.02_new_old.trOverSla.csv': csv[1],
	'./scenarios/CT/test/output/TC05.02_new_old.resultCodeSummary.csv': csv[2],
