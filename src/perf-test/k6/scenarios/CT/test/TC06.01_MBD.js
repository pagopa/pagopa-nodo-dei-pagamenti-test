...
import { sendPaymentOutcomeV2MBD } from './api/sendPaymentOutcomeV2_MBD.js';
import * as common from '../../CommonScript.js';
import * as inputDataUtil from './util/input_data_util.js';
import { sleep } from 'k6';
import * as mbdUtil from './util/MBD.js';
...
export const options = {
    ...
    scenarios: {
        total: {
            ...
            tags: { test_type: 'ALL', scenarioName: 'TC06.01_MBD' },
            exec: 'total',
        }
...
export function total() {
    ...
    let iubd = common.iubd();

    let res = checkPosition(baseRestUrl, rndAnagPaNew, noticeNmbr);

    res = activatePaymentNoticeV2Ecomm(baseSoapUrl, rndAnagPaNew, noticeNmbr, idempotencyKey, "1_mdb");
