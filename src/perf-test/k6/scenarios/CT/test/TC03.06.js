...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{sendPaymentOutput_NN:http_req_duration}': [],
    ...
    'checks{sendPaymentOutput_NN:over_sla300}': [],//['rate<0.50'],
    'checks{sendPaymentOutput_NN:over_sla400}': [],//['rate<0.45'],
    'checks{sendPaymentOutput_NN:over_sla500}': [],//['rate<0.40'],
    'checks{sendPaymentOutput_NN:over_sla600}': [],//['rate<0.30'],
    'checks{sendPaymentOutput_NN:over_sla800}': [],//['rate<0.10'],
    'checks{sendPaymentOutput_NN:over_sla1000}': [],//['rate<0.05'],
    'checks{sendPaymentOutput_NN:ok_rate}': [],
    'checks{sendPaymentOutput_NN:ko_rate}': [],
