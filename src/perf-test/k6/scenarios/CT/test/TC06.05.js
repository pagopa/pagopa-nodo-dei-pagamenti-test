...
import { closePaymentV2KO_errResp } from './api/closePaymentV2KO.js';
...
export const options = {
  ...
  thresholds: {
    ...
    'checks{closePaymentV2KO_errResp:ko_rate}': ['rate<0.01'],
    'checks{closePaymentV2KO_errResp:ok_rate}': [],
    'checks{closePaymentV2KO_errResp:over_sla300}': [],
    'checks{closePaymentV2KO_errResp:over_sla400}': [],
    'checks{closePaymentV2KO_errResp:over_sla500}': [],
    'checks{closePaymentV2KO_errResp:over_sla600}': [],
    'checks{closePaymentV2KO_errResp:over_sla800}': [],
    'checks{closePaymentV2KO_errResp:over_sla1000}': [],
  },
};
...
function total() {
  ...
  closePaymentV2KO_errResp(restBaseUrl, rndAnagPsp, paymentToken_1, paymentToken_2, paymentToken_3, paymentToken_4, paymentToken_5, "OK", "09910087308786", "09910087308786", 1.0, 0.01)
}