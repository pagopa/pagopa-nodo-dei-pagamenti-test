...
export function sendPaymentOutcomePosteReqBody(psp, intpsp, chpsp, paymentToken){
...
export function sendPaymentOutcome(baseUrl,rndAnagPsp,paymentToken) {
 ...
 const res = http.post(
  ...
  /*if(outcome=='KO'){
  console.debug("sendPaymentOutcome REq----------------"+sendPaymentOutcomePosteReqBody(rndAnagPsp.PSP, rndAnagPsp.INTPSP, rndAnagPsp.CHPSP, paymentToken));
