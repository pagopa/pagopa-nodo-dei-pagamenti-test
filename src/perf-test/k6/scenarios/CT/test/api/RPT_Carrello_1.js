...
export function RPT_Carrello_1(baseUrl,rndAnagPsp,rndAnagPa,iuvs) {
 ...
 const res = http.post(
		 getBasePath(baseUrl, "nodoInviaCarrelloRPT")+'?primitiva=nodoInviaCarrelloRPT1',
	...
	tags: { RPT_Carrello_1: 'http_req_duration', ALL: 'http_req_duration', primitiva: "nodoInviaCarrelloRPT"}
	}
  );
