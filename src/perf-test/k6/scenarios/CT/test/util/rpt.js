...
export function getRptEncoded(pa, stazpa, creditorRefId, paymentToken){
	...
	let rptXml = getRpt(pa,stazpa,nowMilliseconds,nowDate,creditorRefId,paymentToken);
	//console.log(rptXml);
