...
function total() {
  ...
  let rndAnagNmu = inputDataUtil.getAnagNmu();
  for (let key in urls) {
  ...
  closePaymentV2_5(restBaseUrl, rndAnagNmu, paymentToken_1, paymentToken_2, paymentToken_3, paymentToken_4, paymentToken_5, "09910087308786", "09910087308786", 1.0, 0.01)
