...
export const options = {
    ...
    scenarios: {
        total: {
            ...
            tags: { test_type: 'ALL', scenarioName: 'TC06.01_new_new' },
            exec: 'total',
        }
    ...
    thresholds: {
        ...
        'http_req_duration{paymentStatus:http_req_duration}': [],
        ...
        'checks{paymentStatus:over_sla300}': [],
                'checks{paymentStatus:over_sla400}': [],
                'checks{paymentStatus:over_sla500}': [],
                'checks{paymentStatus:over_sla600}': [],
                'checks{paymentStatus:over_sla800}': [],
                'checks{paymentStatus:over_sla1000}': [],
                'checks{paymentStatus:ok_rate}': [],
                'checks{paymentStatus:ko_rate}': [],
