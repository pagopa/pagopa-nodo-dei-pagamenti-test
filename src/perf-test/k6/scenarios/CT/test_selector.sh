...
#local run:
#k6 run --out csv=scenarios/CT/test/output/TC01.03.csv -e scenario=CT -e test=TC01.03 -e steps=rampa_1_1_10 -e env=pagoPA_PERF_apim scenarios/CT/test/TC01.03.js -e outdir=scenarios/CT/test/output -v --iterations=1
