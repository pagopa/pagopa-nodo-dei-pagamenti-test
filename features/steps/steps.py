...
def step_impl(context):
    with open(
            os.path.abspath(os.path.join(__file__, os.pardir, os.pardir, os.pardir, 'data/configurations.json'))) as f:
        json_file = json.load(f)

    host, database, user, password, port = json_file.get('db').get('host'), json_file.get('db').get(
        'database'), json_file.get('db').get('user'), json_file.get('db').get('password'), json_file.get('db').get(
        'port')
...
def step_impl(context):
    context.driver.wait_until(By.XPATH,
                              "/html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div[2]/a[3]").click()
...
def step_impl(context):
    name = context.driver.wait_until(By.XPATH,
                                     '/html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div[3]/div[2]/div/div/div/p').text
    surname = context.driver.wait_until(By.XPATH,
...
def step_impl(context):
    assert context.driver.wait_until(By.XPATH,
...
def step_impl(context):
    assert context.driver.wait_until(By.XPATH,
                                     '/html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div/div[2]/div[5]/div/div/p')


@step('user\'s stato is displayed')
def step_impl(context):
    assert context.driver.find_element(By.XPATH,
                                       'html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div[3]/div[2]/div[5]/div/div/p').text
...
def step_impl(context):
    a = context.driver.wait_until(By.XPATH,
                                  '/html/body/app-root/main/app-customer/page-with-sidebar/div/app-header/header/button')
    assert a
...
def step_impl(context):
    context.driver.wait_until(By.XPATH,
                              '/html/body/app-root/main/page-search/page-with-sidebar/div/div/div/div/div/section/div/app-search/div/div/div/div[3]/input').send_keys(
        'fabio.pizzini@gft.com')
    context.driver.wait_until(By.XPATH,
...
def step_impl(context):
    username = context.driver.wait_until(By.XPATH,
                                         '/html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div[3]/div[2]/div[3]/div/div/p').text
...
def step_impl(context):
    current_date = context.driver.wait_until(By.XPATH,
                                             'html/body/app-root/main/app-transaction-list/page-with-sidebar/div/div/div/div/div/div/div/div/table/tbody/tr/td').text
...
def step_impl(context):
    a = context.driver.wait_until(By.XPATH,
                                  '/html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div[2]/table/tbody/tr[1]/td[8]/button/span')
    a.click()
    context.driver.wait_until(By.XPATH,
                              '/html/body/app-root/main/app-customer/page-with-sidebar/div/div/div/div/div/div[3]/div[2]/div[2]/div[1]/div/p')
...
def step_impl(context):
    context.driver.wait_until(By.XPATH,
        ...
        settings['users']['registered']['username_equal_email']['CF'])
    context.driver.wait_until(By.XPATH,
                              '/html/body/app-root/main/page-search/page-with-sidebar/div/div/div/div/div/section/div/app-search/div/div/div/button').click()
...
def step_impl(context, value):
    fiscal_code = context.driver.wait_until(By.XPATH,
                                            '/html/body/app-root/main/page-search/page-with-sidebar/div/div/div/div/div/section/div/app-search/div/div/div/div/input').send_keys(
        settings['users']['registered'][value]['CF'])
    context.driver.wait_until(By.XPATH,
                              '/html/body/app-root/main/page-search/page-with-sidebar/div/div/div/div/div/section/div/app-search/div/div/div/button').click()
...
def step_impl(context):
    ...
    requests.put(f'{mock_url}/pmmockserviceapi/cd/user/save',
                 headers={'Content-Type': 'application/json', 'Accept': '*/*'}, data=json.dumps(mock_response_json))
